...
class Relaset(ApiBase):
    ...
    def add_relaset_cluster(self, cluster_output_dir, main_id=None, project_sn='labelfree', task_id='labelfree',
                            params=None):
...
'protein_list', 'gene_num', 'gene_percent', 'gene_list']
    ...
    def add_enrich_cluster(self, cluster_output_dir, main_id=None, project_sn='labelfree', task_id='labelfree',
