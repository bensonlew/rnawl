...
class AnnotationSwissprot(Base):
    def __init__(self, bind_object):
        super(AnnotationSwissprot, self).__init__(bind_object)
    ...
    def add_annotation_swissprot(self, name=None, params=None, stat_id=None):
        ...
        print "add sg_annotation_swissprot!"
        return swissprot_id
    ...
    def add_annotation_swissprot_pie(self, swissprot_id, evalue_path, similar_path, seq_type, anno_type):
        ...
        try:
            ...
            self.bind_object.set_error("导入swissprot库注释作图信息evalue,similar：%s、%s出错!" % (evalue_path, similar_path))
        else:
