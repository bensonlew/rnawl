...
class RefRnaQc(ApiBase):
    ...
    def run3(self):
        self.add_samples_info("/mnt/ilustre/users/sanger-dev/workspace/20190603/Single_HiseqReadsStat_676/HiseqReadsStat/output",
            fq_type="PE", about_qc="before")
        self.add_gragh_info(
            "/mnt/ilustre/users/sanger-dev/workspace/20190603/Single_HiseqReadsStat_676/HiseqReadsStat/output/qualityStat",
            about_qc="before")
        self.add_samples_info(
            "/mnt/ilustre/users/sanger-dev/workspace/20190603/Single_HiseqReadsStat_9380/HiseqReadsStat/output",
            fq_type="PE", about_qc="after")
        self.add_gragh_info(
            "/mnt/ilustre/users/sanger-dev/workspace/20190603/Single_HiseqReadsStat_9380/HiseqReadsStat/output/qualityStat",
            about_qc="after")
        self.group_id, self.group_detail, self.group_category = self.add_specimen_group(
            "/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/lncRNA/rawdata/Human_10smaples/group.txt")
        self.bind_object.logger.info(self.group_id)
        self.add_control_group(
            "/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/lncRNA/rawdata/Human_10smaples/control.txt", self.group_id)

    def run2(self):
        self.bind_object.logger.info("开始质控导表")
        self.add_samples_info(
            "/mnt/ilustre/users/sanger-dev/workspace/20190709/Single_hiseq_reads_stat_3561_8531/HiseqReadsStat/output",
            fq_type="PE", about_qc="before")
        self.add_gragh_info(
            "/mnt/ilustre/users/sanger-dev/workspace/20190709/Single_hiseq_reads_stat_3561_8531/HiseqReadsStat/output/qualityStat",
            "before")
        self.add_samples_info(
            "/mnt/ilustre/users/sanger-dev/workspace/20190709/Single_hiseq_reads_stat_4840_3630/HiseqReadsStat/output",
            fq_type="PE", about_qc="after")
        self.add_gragh_info(
            "/mnt/ilustre/users/sanger-dev/workspace/20190709/Single_hiseq_reads_stat_4840_3630/HiseqReadsStat/output/qualityStat",
            "after")
        self.group_id, self.group_detail, self.group_category = self.add_specimen_group(
            "/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/lncRNA/test_data_new/new_test_rawdata1/Human_10smaples/group.txt")
        self.bind_object.logger.info(self.group_id)
        self.add_control_group(
            "/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/lncRNA/test_data_new/new_test_rawdata1/Human_10smaples/control.txt",
            self.group_id)
...
class TestFunction(unittest.TestCase):
    ...
    def test_mongo(test):
      ...
      data = {
        ...
        "id": "ref_rna_v2_07111",
        "project_sn": "ref_rna_v2_upgrade1",
        "type": "workflow",
      ...
      wf.test_api = wf.api.api("ref_rna_v2.ref_rna_qc")
      wf.test_api.run2()
