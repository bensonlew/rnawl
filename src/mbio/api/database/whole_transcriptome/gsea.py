...
class Gsea(ApiBase):
    ...
    def run_webroot(self, main_id, gsea_dir, term=None):
        ...
        main_collection = self.db['geneset_gsea']
    ...
    def add_gsea_stat(self, gsea_id, gsea_stat):
        ...
        main_collection = self.db['geneset_gsea_stat']

        try:
            self.create_db_table('geneset_gsea_stat', row_dict_list)
    ...
    def add_gsea_geneset(self, gsea_id, gsea_geneset):
        ...
        main_collection = self.db['geneset_gsea_geneset']

        try:
            self.create_db_table('geneset_gsea_geneset', row_dict_list)
        except Exception as e:
    ...
    def add_gsea_exp(self, gsea_id, gsea_exp):
        ...
        main_collection = self.db['geneset_gsea_exp']

        try:
            self.create_db_table('geneset_gsea_exp', row_dict_list)
        except Exception as e:
