...
class GenesetPpi(ApiBase):
    ...
    def add_network_attributes(self, file2_path, table_id=None, major=False):
        ...
        try:
            collection = self.db["geneset_ppi_stat"]
                ...
                for line1 in data1:
                    ...
                    for line3 in data3:
                        ...
                        if temp1[1] == temp2[1] and temp1[1] == temp3[0]:
                            ...
                            data_list.append(data_son)
        try:
            collection = self.db["geneset_ppi_nodes_cluster"]
            collection.insert_many(data_list)
        except Exception as e:
            self.bind_object.set_error("导入%s信息出错:%s" % (file1_path, e))
        else:
                    ...
                    with open(file1_path, 'rb') as m:
                        ...
                        for line1 in data1:
                            ...
                            if temp[1] == line_data[1]:
                                ...
                                data_list.append(data_son)
        try:
            collection = self.db["geneset_ppi_nodes_centrality"]
            collection.insert_many(data_list)
        except Exception as e:
    ...
    def add_node_table(self, file_path, table_id=None, major=False):
        ...
        self.create_db_table('geneset_ppi_node', nodes_table_list)
        self.update_db_record('geneset_ppi', ObjectId(table_id), main_id=ObjectId(table_id))
    ...
    def add_edge_table(self, file_path, table_id=None, major=False):
        ...
        self.create_db_table('geneset_ppi_edge', edge_table_list)
    ...
    def add_degree_distribution(self, file_path, table_id=None, major=False):
        ...
        with open(file_path, 'rb') as r:
            ...
            for line in data_line:
                ...
                data_list.append(data_son)
        try:
            collection = self.db["geneset_ppi_nodes_degreestat"]
            collection.insert_many(data_list)
        except Exception as e:
            self.bind_object.set_error("导入%s信息出错:%s" % (file_path, e))
        else:
