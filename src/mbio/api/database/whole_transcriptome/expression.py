...
class Expression(ApiBase):
    def __init__(self, bind_object):
        super(Expression, self).__init__(bind_object)
    ...
    def add_exp_corr(self, map_dict, library, level, kind, group_id, group_dict, way, take_mean, corr_method, take_log,
    ...
    def add_exp_pca(self, map_dict, library, level, kind, group_id, group_dict, way, take_mean, task_id, project_sn,
                    pca_id=None):
        if pca_id:
    ...
    def add_diff(self, map_dict, category, level, kind, background, filter, threshold, group_id, group_dict, control_id,
                 stat_type, stat_cutoff, fc, diff_method, correct_method, way, task_id, project_sn, diff_id=None):
        if diff_id:
        ...
        match_dict = {'exp_id': exp_id, 'category': category}
        if kind != 'all':
