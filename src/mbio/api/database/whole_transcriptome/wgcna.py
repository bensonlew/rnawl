...
class Wgcna(ApiBase):
    ...
    def add_prepare_detail(self, prepare_result_dir, main_id):
        ...
        self.create_db_table('wgcna_prepare_detail', [detail])
        self.update_db_record('wgcna_prepare', main_id, status="end", main_id=ObjectId(main_id))
    ...
    def add_module_detail(self, result_dir, gene_id2gene_name, exp_matrix, main_id):
        ...
        # block dendrogram -> wgcna_module_tree_detail
        ...
        self.create_db_table('wgcna_module_tree_detail', blocks_data)
        ...
        self.create_db_table('wgcna_module_stat_detail', size_stat_dict)
        ...
        self.create_db_table('wgcna_module_membership_detail', membership_dict_list)

        # wgcna_module_unmerged_detail
        ...
        self.create_db_table('wgcna_module_unmerged_detail',[unmerged_module_cluster_data])

        # wgcna_module_cluster_detail
        ...
        self.create_db_table('wgcna_module_cluster_detail', [module_cluster_data])

        # wgcna_module_corr_detail
        ...
        self.create_db_table('wgcna_module_corr_detail', module_corr_dict_list, tag_dict=dict(module_id=ObjectId(main_id)))

        # wgcna_module_eigengenes_detail
        ...
        self.create_db_table('wgcna_module_eigengenes_detail', eigengenes_dict_list, tag_dict=dict(module_id=ObjectId(main_id)))

        # update main table
        self.update_db_record('wgcna_module', main_id, status="end", main_id=ObjectId(main_id),
    ...
    def add_relate_detail(self, result_dir, seq_annot, main_id):
        ...
        self.create_db_table('wgcna_relate_gene_detail',corr_all_dict_list)
        ...
        self.create_db_table('wgcna_relate_module_detail', corr_all_dict_list)
        # update main table
        self.update_db_record('wgcna_relate', main_id, status="end", modules=module_list,
    ...
    def add_network_detail(self, result_dir, main_id):
        ...
        self.create_db_table("wgcna_network_edge_detail", edge_dict_list)
        # update main table
        self.update_db_record('wgcna_network', main_id, status="end", main_id=ObjectId(main_id),)

    def remove_all_test_result(self):
        target_coll = list()
        for each in self.db.collection_names():
            if each.startswith("wgcna_"):
