    ...
    def add_promote(self, promote_path, main=False, task_id=None, project_sn=None, main_id=None,
        ...
        if main:
            ...
            if main_id is None:
                ...
                self.bind_object.set_error("main为False时需提供main_id!", code="51403301")
            ...
            if len(lines) >1:
                for line in lines[1:]:
                    ...
                    if len(line) < 11:
                        ...
                        continue
                    data.extend(
                        [("gene_id", line[0]), ("location", line[1]), ("specimen_id", specimen_id),
                         ("upstream", int(line[3])),
                ...
                try:
                    ...
                    self.bind_object.set_error("导入promote%s信息出错:%s", variables=(promote_path, e), code="51403302")
                else:
