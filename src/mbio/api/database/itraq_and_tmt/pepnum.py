...
class Pepnum(ApiBase):
    ...
    #@report_check
    def add_pepnum(self, params=None, project_sn='itraq_tmt',
                    task_id='itraq_tmt', main_id=None, pepnum_exp=None):
...
if __name__ == '__main__':
    anno = Pepnum(None)
    pepnum_exp = '/mnt/ilustre/users/sanger/workspace/20180827/Itraqtmt_sanger_110743/remote_input/protein/proteins_1535336073.xls'
