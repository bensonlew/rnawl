...
class Searchdb(ApiBase):
    ...
    #@report_check
    def add_searchdb(self, params=None, project_sn='itraq_tmt',
                task_id='itraq_tmt', name=None, protein_selected = None):
        if params is None:
    ...
    def add_searchdb_detail(self, protein_selected, searchdb_id):
        ...
        df = df.round(6)
        df.columns = ["accession_id", "fdr", "description","coverage",
                      "peptide", "psm", "uni_peptide", "aas", "mw", "calc_pi"]
