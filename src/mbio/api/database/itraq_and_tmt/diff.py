...
class Diff(ApiBase):
    ...
    def add_diff(self, work_dir, compare_dict_xls, num_summary_xls,
        allsummary_xls, group_dict=None, group_id=None,project_sn=None, task_id=None, main_id=None,params=None, method_type=None):
...
if __name__ == '__main__':
    anno = Diff(None)
    work_dir = '/mnt/ilustre/users/sanger-dev/workspace/20180314/Single_test_diff11235/Diff'
    compare_dict_xls = '/mnt/ilustre/users/sanger-dev/workspace/20180314/Single_test_diff11235/Diff/compare_dict.xls'
    num_summary_xls = '/mnt/ilustre/users/sanger-dev/workspace/20180314/Single_test_diff11235/Diff/num_summary.xls'
    allsummary_xls = '/mnt/ilustre/users/sanger-dev/workspace/20180314/Single_test_diff11235/Diff/allsummary.xls'
