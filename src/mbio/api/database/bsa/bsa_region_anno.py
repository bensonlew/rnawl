...
class BsaRegionAnno(ApiBase):
    """
    BSA关联区域注释导表
    """
    def __init__(self, bind_object):
        super(BsaRegionAnno, self).__init__(bind_object)
        self._project_type = "bsa"

    def add_sg_region_anno(self, region_id, name=None, params=None):
        """
        关联区域注释主表
        """
        ...
        insert_data = {
            ...
            "params": params if params else "origin_no_params",
            "desc": "关联区域基因注释主表",
...
if __name__ == "__main__":
    a = BsaRegionAnno(None)
    project_sn = 'bsa_test'
    task_id = 'hongdong_111'
    # slidingwin_id = "5a8fd9d5a4e1af0e64fca5a2"
    # member_id = 'm_test'
    # anno_id = a.add_sg_region_anno(task_id, project_sn, slidingwin_id, member_id, name=None, params=None)
    # gene_total_path = "/mnt/ilustre/users/sanger-dev/sg-users/xuanhongdong/BSA/Demo/region_gene/region.threshold.gene.total"
    # a.sg_region_anno_detail(anno_id, gene_total_path)
    anno_id = '5a94f06ca4e1af772afb4176'
    go_path = '/mnt/ilustre/users/sanger-dev/workspace/20180227/Single_tool_anno_analysis_wzy_go10/AnnoAnalysis/output/region.threshold.gene.go.final.stat.detail'
    kegg_path = '/mnt/ilustre/users/sanger-dev/workspace/20180227/Single_tool_anno_analysis_wzy_kegg10/AnnoAnalysis/output/region.threshold.gene.kegg.final.stat.detail'
    eggnog_path = '/mnt/ilustre/users/sanger-dev/workspace/20180227/Single_tool_anno_analysis_wzy_eggnog10/AnnoAnalysis/output/region.threshold.gene.eggnog.final.stat.detail'
    pathway_dir = '/mnt/ilustre/users/sanger-dev/workspace/20180227/Single_tool_anno_analysis_wzy_kegg10/AnnoAnalysis/output/pathway_dir'
