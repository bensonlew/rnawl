...
class Batch(ApiBase):
    ...
    def add_exp_batch(self, count_batch, exp_other, exp_id,task_id):
        ...
        self.update_db_record('sg_exp_batch', main_id, insert_dict={'main_id': main_id})
        return main_id
    ...
    def add_exp_batch_corr(self, corr_output_dir, main_id=None, record_id=None):
        ...
        tag_dict = dict(corr_id=record_id)
    ...
    def add_exp_batch_pca(self, exp_output_dir, main_id, record_id):
        ...
        # insert detail
        tag_dict = dict(pca_id=record_id)
