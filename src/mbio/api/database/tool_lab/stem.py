...
class Stem(ApiBase):
    ...
    @report_check
    def add_stem(self, detail_table, cluster_table, main_id,s3_out_put):
        ...
        self.update_db_record('sg_stem', main_id, main_id=main_id, time=time, cluster=cluster, status='end',s3_out_put = s3_out_put)
