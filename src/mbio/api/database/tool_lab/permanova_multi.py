...
class PermanovaMulti(ApiBase):
    def __init__(self, bind_object):
        super(PermanovaMulti, self).__init__(bind_object)
    ...
    def add_detail(self, main_id, input_file):
        ...
        with open(input_file,"r") as infile:
            ...
            self.update_db_record(
                "permanova_multi",{"_id":self.check_objectid(main_id)}, update_dict)
            ...
            while 1:
                ...
                self.col_insert_data("permanova_multi_detail",insert_table)

if __name__ == "__main__":
    a = PermanovaMulti(None)
    a.add_detail("202104071029108545217538","/mnt/ilustre/users/sanger-dev/sg-users/xueqinwen/tool_lab_tools/multi_permanova/Univariate_PERMANOVA.xls")