...
class AnnoTmhmm(Base):
    ...
    def add_anno_tmhmm(self, anno_tmhmm_path, main=False, task_id=None, project_sn=None, main_id=None,
        ...
        if main:
            ...
            if main_id is None:
                ...
                self.bind_object.set_error("main为False时需提供main_id!", code="52101501")
        ...
        elif specimen_id + '_whole_genome_tmhmm_anno.xls' in os.listdir(anno_tmhmm_path):
            anno_file = anno_tmhmm_path + '/' + specimen_id + '_whole_genome_tmhmm_anno.xls'
        else:
            #raise Exception("找不到TMHMM注释文件")
            self.bind_object.set_error("找不到TMHMM注释文件", code="52101502")
    ...
    def add_anno_tmhmm_detail(self, detail_file, main_id=None, update_id=None):
        ...
        try:
            ...
            main_collection = self.db['anno_tmhmm']
            ...
            self.bind_object.set_error("导入anno_tmhmm_detail%s信息出错:%s" , variables=(detail_file, e), code="52101503")
        else:
        ...
        try:
            ...
            self.bind_object.set_error("导入anno_tmhmm_stat%s信息出错:%s" , variables=(detail_file, e), code="52101504")
        else:
