...
class Srna(ApiBase):
    ...
    def add_novel_mirna(self, novel_mirna_detail, project_sn="small_rna", task_id="small_rna", params=None, method=None, pdfs=None):
