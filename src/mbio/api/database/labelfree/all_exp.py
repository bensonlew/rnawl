...
from mbio.api.database.labelfree.proteinset import Proteinset

class AllExp(Proteinset):
    def __init__(self, bind_object):
        super(AllExp, self).__init__(bind_object)

    def add_t2g_info(self, t2g_file, project_sn='labelfree', task_id='labelfree'):
        """
    ...
    def add_exp(self, exp_matrix, quant_method='RSEM', exp_level='T', group_dict=None, main_id=None, group_id=None,
                add_distribution=True, exp_type='tpm', project_sn='labelfree', task_id='labelfree',
    ...
    def add_distribution(self, exp_matrix, group_dict, params=None, exp_level='T',
                         quant_method='RSEM', project_sn='labelfree', main_id=None,
                         task_id='labelfree', ):
        """
    ...
    def add_rsem_mapping(self, align_rate_file, project_sn='labelfree', task_id='labelfree'):
        "该函数暂时无用"
    ...
    def add_exp_pca(self, exp_matrix, quant_method='RSEM', exp_id=None, exp_level='T', params=None,
                    project_sn='labelfree', task_id='labelfree', ):
        """
        dump exp data into database
        :param exp_matrix: expression matrix path or an express matrix in pandas DataFrame format.
        :param exp_level: str, transcript or gene
    ...
    def add_exp_corr(self, exp_matrix, exp_level='T', quant_method='RSEM', sample_order=None,
                     ...
                     project_sn='labelfree', task_id='labelfree', params=None):
        """
        dump exp data into database
        :param exp_matrix: expression matrix path or an express matrix in pandas DataFrame format.
        :param exp_level: str, transcript or gene
    ...
    def add_geneset_cluster(self, cluster_output_dir, main_id=None, project_sn='labelfree', task_id='labelfree',
                            params=None):
        update_status = False
        if not main_id:
            update_status = True
