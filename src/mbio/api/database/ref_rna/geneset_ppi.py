...
import unittest
import os
from mbio.api.database.ref_rna.api_base import ApiBase
...
class TestFunction(unittest.TestCase):
    ...
    """
    def test_mongo(test):
        from mbio.workflows.ref_rna.itraq_test_api import ItraqApiWorkflow
        ...
        wf.test_api = wf.api.api("ref_rna.geneset_ppi")

        test_dir = '/mnt/ilustre/users/sanger-dev/workspace/20180409/GenesetPpi_ref_rna_4321_9222/PpinetworkAnalysis/output'
