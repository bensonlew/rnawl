...
class DiffGenesetWorkPipline(ApiBase):
    ...
    def add_geneset_analysis_table(self, geneset_info):
        ...
        if "go" in self.total_analysis:
            ...
            go_enrich_s3_dir = os.path.join(self.s3_output, '12GeneSet', '05_GO_Enrich',geneset_info["geneset_name"], "go_enrich_stat.xls")
    ...
    def add_cog_class_main_table(self,geneset_info):
        print "add cog {}".format(geneset_info)
        params_json = {
            "type": "origin",
    ...
    def add_go_enrich(self, result, main_id, s3_output):
        ...
        # denovo产品 gene_list, gene_str
        df.rename(columns={'seq_list': 'gene_list', 'seq_str': 'gene_str'}, inplace=True)
...
class TestFunction(unittest.TestCase):
    ...
    '''
    def test(self):
        test_path = "/mnt/lustre/users/sanger-dev/wpm2/workspace/20210831/geneset_prepare_2745/DiffGenesetAllPipline/"
        import random
        import sys
        ...
        diff_id = "6107c6d260ff8a344817e206"
        exp_id = "6107c6a460ff8a344813b8d9"
        task_id = "8hdg_b7jpuuo4soclc8v34be5kr"
        analysis_names =["go","kegg","cog"]
        # analysis_names =[]
        inter_path = test_path + "/tmp"
        kegg_level_path = test_path + "/DiffGenesetAll/AnnotPrepare/output/gene_kegg_level_table.xls"
