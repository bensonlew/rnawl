...
class AllExp(ApiBase):
    ...
    def add_diffexp(self, diff_output, exp_id=None, group_dict=None, group_id=None,
        ...
        :return: main table id
        """
        summarys = glob.glob(os.path.join(diff_output, '*_diff_summary.xls'))
    ...
    def add_diffexp_new(self, diff_output, exp_id=None, group_dict=None, group_id=None,
                    exp_level='T', quant_method='RSEM', diff_method='DESeq2', main_id=None,
                    project_sn='denovo_rna_v2', task_id='denovo_rna_v2', params=None,
    ...
    def add_diffexp_new_noiseq(self, diff_output, exp_id=None, group_dict=None, group_id=None,
                    exp_level='T', quant_method='RSEM', diff_method='DESeq2', main_id=None,
                    project_sn='denovo_rna_v2', task_id='denovo_rna_v2', params=None,
    ...
    def add_geneset_cluster(self, cluster_output_dir, main_id=None, project_sn='denovo_rna_v2_upgrade', task_id='denovo_rna_v2_upgrade',
                            params=None):
    ...
    def run1(self):
        self.add_diffexp("/mnt/ilustre/users/sanger-dev/workspace/20190712/Single_Diffexp4469/Diffexp/output",task_id='denovo_rna_v2_0814',diff_method='edger',create_geneset=True)
        self.add_diffexp("/mnt/ilustre/users/sanger-dev/workspace/20190712/Single_Diffexp4469/Diffexp/output",task_id='denovo_rna_v2_0814', diff_method='edger',create_geneset=True)

    def run2(self):
        self.add_exp(
            "/mnt/ilustre/users/sanger-dev/workspace/20190416/Denovorna_tsg_33857/Quant/output/transcript.tpm.matrix",
            quant_method="RSEM", exp_level='T', group_dict=None, main_id=None, group_id=None, add_distribution=False,
            exp_type='tpm', project_sn='denovo_rna_v2_upgrade', task_id='denovo_rna_v2_upgrade', lib_type=None, params=None)
        self.add_exp(
            "/mnt/ilustre/users/sanger-dev/workspace/20190416/Denovorna_tsg_33857/Quant/output/gene.tpm.matrix",
            quant_method="RSEM", exp_level='G', group_dict=None, main_id=None, group_id=None, add_distribution=False,
            exp_type='tpm', project_sn='denovo_rna_v2_upgrade', task_id='denovo_rna_v2_upgrade', lib_type=None, params=None)
        self.add_t2g_info("/mnt/ilustre/users/sanger-dev/workspace/20190416/Denovorna_tsg_33857/DenovoAssemble2/output/Trinity.filter_t2g",project_sn='denovo_rna_v2_upgrade', task_id='denovo_rna_v2_upgrade')

    def run3(self):
        self.add_geneset_cluster("/mnt/ilustre/users/sanger-dev/workspace/20190722/GenesetCluster_tsg_33857_2119_747/ExpCluster/output")
...
class TestFunction(unittest.TestCase):
    ...
    def test_mongo(test):
      ...
      wf.test_api = wf.api.api("denovo_rna_v2.all_exp")
      wf.test_api.run2()
