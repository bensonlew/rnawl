...
class TestFunction(unittest.TestCase):
    ...
    def test_mongo(test):
        ...
        wf.test_api = wf.api.api("lnc_rna.software_database")
        info_xls = "/mnt/ilustre/users/sanger-dev/sg-users/liubinxu/test_lnc_rna/soft.xls"
