...
class LncRnaQc(ApiBase):
    def __init__(self, bind_object):
        super(LncRnaQc, self).__init__(bind_object)
    ...
    def add_productive_name(self, samples=None, productive_table=None):
        ...
        with open(productive_table, "r") as f:
            for line in f:
                ...
                elif len(items) == 3 and items[0] in samples:
                    collection.update({"task_id": self.bind_object.sheet.id, "old_name": items[0]},
    ...
    def add_bam_path(self, dir_path):
        ...
        for spname in spname_spid:
            ...
            bam_path = os.path.join(dir_path, "02 Basic_Analysis/02 Align/AlignBam", spname + ".bam")
    ...
    def run2(self):
        self.add_rpkm_table("/mnt/ilustre/users/sanger-dev/workspace/20190319/Single_MapAssessment_lnc_fromtophat9410/MapAssessment/output/saturation",name=None, params='RSeQC-2.6.3', detail=True)
        self.add_coverage_table("/mnt/ilustre/users/sanger-dev/workspace/20190319/Single_MapAssessment_lnc_fromtophat9410/MapAssessment/output/coverage",name=None, params='RSeQC-2.6.3', detail=True)
        self.add_distribution_table("/mnt/ilustre/users/sanger-dev/workspace/20190319/Single_MapAssessment_lnc_fromtophat9410/MapAssessment/output/distribution",name=None, params='RSeQC-2.6.3')
        self.add_chrom_distribution_table("/mnt/ilustre/users/sanger-dev/workspace/20190319/Single_MapAssessment_lnc_fromtophat9410/MapAssessment/output/chr_stat",name=None, params='RSeQC-2.6.3')
        self.add_hisat_mapping_stat("/mnt/ilustre/users/sanger-dev/workspace/20190318/Single_RnaseqMapping_star_test6499/RnaseqMapping/output/stat")

    def run3(self):
        self.add_samples_info("/mnt/ilustre/users/isanger/workspace/20190222/Single_HiseqReadsStat_1064/HiseqReadsStat/output",fq_type="PE", about_qc="before")
        self.add_gragh_info("/mnt/ilustre/users/isanger/workspace/20190222/Single_HiseqReadsStat_1064/HiseqReadsStat/output/qualityStat",about_qc="before")
        self.add_samples_info("/mnt/ilustre/users/isanger/workspace/20190222/Single_HiseqReadsStat_2043/HiseqReadsStat/output", fq_type="PE", about_qc="after")
        self.add_gragh_info("/mnt/ilustre/users/isanger/workspace/20190222/Single_HiseqReadsStat_2043/HiseqReadsStat/output/qualityStat",about_qc="after")
...
class TestFunction(unittest.TestCase):
    ...
    def test_mongo(test):
      ...
      data = {
        ...
        "id": "lnc_rna"+ str(random.randint(1,10000)),
        "project_sn": "lnc_rna",
        "type": "workflow",
      ...
      wf.test_api = wf.api.api("lnc_rna.lnc_rna_qc")
      wf.test_api.run3()
