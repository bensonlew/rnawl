...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        wf.test_api = wf.api.api('medical_transcriptome.annotation')
        ...
        wf.test_api.run(annot_merge_output_dir, params_dict, taxonomy, exp_level,gene_exp=gene_exp,trans_exp=tran_exp)
