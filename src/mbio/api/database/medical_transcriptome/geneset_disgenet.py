...
class GenesetDisgenet(ApiBase):
    def __init__(self, bind_object):
        super(GenesetDisgenet, self).__init__(bind_object)
    ...
    def add_annotation_detail(self, enrich_path, g2e_path, disgenet_id):
        ...
        data_list = list()
        # g2e_dict = dict()
        # with open(g2e_path, 'r') as g2e:
        #     g2e.readline()
        #     for line in g2e:
        #         each = line.strip().split("\t")
        #         if each[1] not in g2e_dict.keys():
        #             g2e_dict[each[1]] = each[0]
        #         else:
        #             continue
        ...
        # with open(enrich_path, "r") as a:
        #     a.readline()
        #     for l in a:
        #         items = l.strip().split("\t")
        #         entrez = items[7].split("/")
        #         gene_list = []
        #         for i in entrez:
        #             gene_list.append(g2e_dict.get(i))
        #         pval = items[4]
        #         padj = items[5]
        #         num1 = items[2].split("/")[0]
        #         num2 = items[3].split("/")[0]
        #         data = {
        #             "disease_name": items[1],
        #             "disease_id": items[0],
        #             "seq_list": gene_list,
        #             "seq_str": '|'.join(gene_list),
        #             "count": items[8],
        #             "pvalue": float(pval),
        #             "padjust": float(padj),
        #             "ratio_in_pop": items[3],
        #             "ratio_in_study": items[2],
        #             "enrich_factor": float(num1)/float(num2),
        #             "disgenet_enrich_id": disgenet_id,
        #         }
        #         data_list.append(data)
        try:
            collection = self.db['sg_geneset_disgenet_enrich_detail']
            ...
            self.update_db_record('sg_geneset_disgenet_enrich',
...
class TestFunction(unittest.TestCase):
    ...
    def test_mongo(test):
        ...
        wf.test_api = wf.api.api("medical_transcriptome.geneset_disgenet")
