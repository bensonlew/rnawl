...
class MedicalTranscriptomeQc(ApiBase):
    def __init__(self, bind_object):
        super(MedicalTranscriptomeQc, self).__init__(bind_object)
    ...
    def run3(self):
        ...
        self.group_id, self.group_detail, self.group_category = self.add_specimen_group(
            "/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/medical_transcriptome/rmats/test_data/small/example_group_1528169151.txt")
        self.bind_object.logger.info(self.group_id)
        self.add_control_group(
            "/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/medical_transcriptome/rmats/test_data/small/example_control_1528169151.txt", self.group_id)
...
class TestFunction(unittest.TestCase):
    ...
    def test_mongo(test):
      ...
      wf.test_api = wf.api.api("medical_transcriptome.medical_transcriptome_qc")
      wf.test_api.run3()
