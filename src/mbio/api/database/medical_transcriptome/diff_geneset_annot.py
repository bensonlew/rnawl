...
class DiffGenesetAnnot(ApiBase):
    def __init__(self, bind_object):
        super(DiffGenesetAnnot, self).__init__(bind_object)
    ...
    def add_geneset_do_detail(self, geneset_do_table, geneset_do_id, geneset_names=None):
        ...
        try:
            ...
            self.update_db_record('sg_diff_geneset_do_class', query_dict={"_id": ObjectId(geneset_do_id)}, main_id=geneset_do_id, status="end", table_columns=geneset_names, categories=categories )
    ...
    def add_geneset_do_enrich(self, geneset_do_table, geneset_do_id):
        ...
        try:
            ...
            self.update_db_record('sg_diff_geneset_do_enrich', query_dict={"_id": geneset_do_id}, main_id=geneset_do_id, status="end", categories=categories)
    ...
    def add_geneset_reactome_svg(self, main_id, geneset_name, geneset_reactome_pathway, svg_path):
        ...
        try:
            ...
            self.bind_object.set_error("导入main: %s出错!" , variables=("sg_diff_geneset_reactome_class_pic"))
        else:
            self.bind_object.logger.info("导入：%s成功!" % ("sg_diff_geneset_reactome_class_pic"))
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        main_id = wf.test_api.add_main_table('sg_diff_geneset_do_class', params_dict, "sg_diff_geneset_do_class_test")
        ...
        main_id = wf.test_api.add_main_table('sg_diff_geneset_do_enrich', params_dict, "sg_diff_geneset_do_enrich_test")
