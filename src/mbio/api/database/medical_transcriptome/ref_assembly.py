...
class RefAssembly(ApiBase):
    def __init__(self, bind_object):
        ...
        _ = Config().get_mongo_client(mtype="medical_transcriptome")[Config().get_mongo_dbname("medical_transcriptome")]
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        # task_id = 'i-sanger_220824'
        # project_sn = '35910_5dc8f4043b329'
        ...
        refrna_assemble_output_dir = '/mnt/ilustre/users/sanger-dev/workspace/20200810/Refrna_tsg_38314/RefrnaAssemble/output'
        ...
        wf.test_api = wf.api.api('medical_transcriptome.ref_assembly')
