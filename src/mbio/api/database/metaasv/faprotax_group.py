...
class FaprotaxGroup(Base):
    ...
    @report_check
    def add_species_difference_check_detail(self, statfile, cifiles, check_type=None, params=None, category_name=None, table_id=None, group_id=None, from_otu_table=None, major=False, posthoc=None, correlation_key=None, coll_name='multiple_group_detail', main_coll='multiple_group',bar_name="faportax_group_bar",task_type=None):
        if major:
