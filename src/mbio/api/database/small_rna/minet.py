...
class Minet(ApiBase):
    ...
    def import_net(self, result_dir=None, params=None, tf=None, target=None, nodes=None, edges=None):
        ...
        self.remove_table_by_main_record(main_table='sg_minet', task_id=task_id, detail_table=['sg_minet_tf', 'sg_minet_target', 'sg_minet_nodes', 'sg_minet_edges'], detail_table_key='minet_id')
        ...
        self.db['sg_minet'].update({"_id": minet_id},
    ...
    def add_minet_tf(self, minet_id, tf):
        ...
        try:
            self.create_db_table('sg_minet_tf', data_list)
    ...
    def add_minet_target(self, minet_id, target):
        ...
        try:
            self.create_db_table('sg_minet_target', data_list)
        except Exception as e:
    ...
    def add_minet_nodes(self, minet_id, nodes):
        ...
        try:
            self.create_db_table('sg_minet_nodes', data_list)
        except Exception as e:
    ...
    def add_minet_edges(self, minet_id, edges):
        ...
        try:
            self.create_db_table('sg_minet_edges', data_list)
        except Exception as e:
