...
class SmallrnaFamilyAnalyse(ApiBase):
    ...
    def export_family(self, result_dir, main_id):
        ...
        #     print(i['mir-96'])
        self.create_db_table("sg_family_stat",result_dict_list)
    ...
    def export_known(self, result_dir, main_id):
        ...
        self.create_db_table("sg_family_detail",result_dict_list)
    ...
    def run(self, family_path, params = None):
        main_id = self.creat_family_main('sg_family', params = params)
        ...
        self.db['sg_family'].update({"_id": main_id}, {"$set": {"main_id": main_id, "family_names": family_names}})
...
class TestFunction(unittest.TestCase):
    def test_mongo(test):
        ...
        family_path = '/mnt/ilustre/users/sanger-dev/workspace/20181220/Smallrna_tsg_33076/SmallrnaFamilyAnalyse/output'
