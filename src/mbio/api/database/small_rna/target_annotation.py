...
class TargetAnnotation(ApiBase):
    def __init__(self, bind_object):
        super(TargetAnnotation, self).__init__(bind_object)
        self.result_dir = ''
        self.result_file = {}
        self.trans_gene = {}
        self.trans_isgene = {}
    ...
    def run(self, target_file, target_file2, annotation_mudule_dir, trans2gene, params_dict, taxon='Animals', exp_level='transcript', version="v1.0"):
        ...
        elif self.annot_type == "annot2":
            self.add_annotation_cog_detail3(cog_id=cog_id, cog_path=self.result_file['n_gene_sum_path' + 'ref'], seq_type="ref", anno_type="G")
        else:
        ...
        go_id = self.add_annotation_go(name=None, params=None, result_dir=self.result_dir)
        seq_type = "ref"
...
class TestFunction(unittest.TestCase):
    ...
    def test_mongo(test):
        ...
        result_dir = "/mnt/ilustre/users/sanger-dev/workspace/20200817/Smallrna_tsg_158369/TransferAnnot/Annotation/allannot_class"
        g2t2p = "/mnt/ilustre/users/sanger-dev/workspace/20200817/Smallrna_tsg_158369/TransferAnnot/Annotation/allannot_class/all_tran2gene.txt"
        target = "/mnt/ilustre/users/sanger-dev/workspace/20200817/Smallrna_tsg_158369/TargetPredict/output/"

        wf.IMPORT_REPORT_DATA = True
        wf.IMPORT_REPORT_AFTER_END = False
        wf.test_api = wf.api.api("small_rna.target_annotation")
        params = {
            "nr_evalue": 1e-3,
            "nr_similarity": 0,
            "nr_identity": 0,
        ...
        novol_target_file = target + 'novol_target.xls'
        ...
        # wf.test_api.run(known_target_file, novol_target_file, result_dir, g2t2p, params)
