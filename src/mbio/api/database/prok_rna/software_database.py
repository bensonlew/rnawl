    ...
    def add_swdb_info(self, info_xls):
        ...
        for i in df.index:
            ...
            main_info = {
                ...
                "strand_specific": int(line_dict["strand_specific"]),
            }
...
class TestFunction(unittest.TestCase):
    ...
    def test_mongo(test):
        ...
        import datetime
        data = {
            "id": "prok_rna_software_database_{}".format(datetime.datetime.now().strftime("%Y%m%d_%H%M%S")),
        ...
        wf.test_api = wf.api.api("prok_rna.software_database")
        info_xls = "/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/prok_rna/software_prok_new.txt"
