...
def venn_table(otu_table, group_table,r_file):
    ...
    with open(r_file, 'w') as f:
        ...
        for(i in 1:lst_len){
            ...
            venn_matrix[i,3] <- paste(sets[[i]],collapse =";")  # modify by zhujuan 20171107 有些分类的名字",故用";"代替 
        }
        # write sets to file
        ...
        for(i in 1:length(lst)){
            ...
            new_matrix[i,2] = paste(lst[[i]],collapse=";") # modify by zhujuan 20171107 有些分类的名字中含有",",故用";"代替
        }
