...
class KeggAnnotation(object):
    def __init__(self, kegg_version=""):
        """
        ...
        if kegg_version == "202003":
            ...
            self.gene_ko = Config().SOFTWARE_DIR + "/database/Annotation/other{}/kegg{}/ko_genes.total.list".format(kegg_version[0:4], kegg_version)

        if kegg_version == "201909":
        ...
        self.gloabl = ["map01100", "map01110", "map01120", "map01130", "map01200", "map01210", "map01212", "map01230", "map01220", "map01240"]
        ...
        with open(kegg_table, 'w') as w_annot:
            ...
            for tran_id in list(set(known_ko.keys() + annot_ko.keys())):
                if tran_id in known_ko.keys():
                    ...
                    ko = ko_annot[3] if len(ko_annot) >= 4 else str()
                    for i in ko.split(";"):
                        if self.ko2gene.has_key(i):
