...
class AnnoOverview(Base):
    def __init__(self, work_type, organism=False, db_v=None):
    ...
    def get_compound_info(self, compound_id):
        ...
        if self.db_v == "v94.2":
            compound_db = self.ref_db['kegg_v202007_br08001']
        else:
            compound_db = self.ref_db['kegg_{}_br08001'.format(self.db_v)]
        print("compound_db: {}".format(compound_db))
    ...
    def get_kegg_info(self, pathway_id):
        ...
        kegg_path_db = self.ref_db['kegg_{}_pathway_level'.format(self.db_v)]
        ...
        for metab_id in set_list:
            ...
            for c_id in pathway_info.keys():
                for one_path in pathway_info[c_id].split(";"):
                    ...
                    elif one_path in pathway_id_set:
                         pathway_id_set.remove(one_path)
