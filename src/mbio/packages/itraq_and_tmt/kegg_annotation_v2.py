...
class KeggAnnotation(object):
    def __init__(self, kegg_version="201909"):
        """
                                ...
                                if 0:
                                    if i in ko_list:
                                        ...
                                        if map_id not in self.gloabl and map_id in map2class:
                                            ...
                                            path_list.append(map_id)  # 对应pathway的definition
                                else:
                ...
                if 1:
                    ...
                    for index, i in enumerate(pids):
                        if ko_list:
                            ...
                            map_id = re.sub("ko", "map", i)
                            if map_id not in self.gloabl and map_id in self.map2class:
    ...
    def run(self, r_path, map_path, blast_xml, kegg_ids, kegg_table, pidpath, pathwaydir, pathway_table, layerfile, taxonomy=None, link_bgcolor="green", png_bgcolor= "#00CD00", image_magick=None, html_path="/mnt/ilustre/users/sanger-dev/app/database/KEGG/kegg_2017-05-01/kegg/pathway/map"):
