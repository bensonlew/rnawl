...
class taxon(object):
    ...
    def __init__(self, db=None, acc2tax=None):
        if db:
            self.dbfile = db
        else:
    ...
    def get_desired_ranks(self, taxid, desired_ranks):
...
if __name__ == '__main__':  # for test
    ...
    parser.add_argument('-db', type=str, required=False, help = 'db_path', default = "")
