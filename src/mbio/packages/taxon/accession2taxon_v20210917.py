...
nt_collection = db.NT_sequence_202110 ## fix by qingchen.zhang @20200909
taxon_collection = db.species_taxon_202110 ## fix by qingchen.zhang @20200909
    ...
    def get_taxid(self, accession):
        ...
        for one in result:
            ...
            if count == 1:
                ...
                print 'WARNNING:accession:{}在没有物种分类注释信息'.format(accession)
            else:
                raise Exception(
                    '数据库中存在相同accession的信息accession:{}'.format(accession))
