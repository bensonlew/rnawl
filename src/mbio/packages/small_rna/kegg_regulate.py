...
class KeggRegulate(object):
    def __init__(self):
        '''
        only project_type = "ref_rna" can work
        ref_rna_ref_uri = mongodb://rna:y6a3t5n1w0y7@10.100.1.10/sanger_ref_rna?authMechanism=SCRAM-SHA-1
        ref_rna_ref_db_name = sanger_biodb
        '''
