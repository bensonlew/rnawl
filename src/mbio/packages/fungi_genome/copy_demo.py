...
class CopyDemo(Base):
    ...
    def assemble(self):
        self.copy_collection_with_change("assemble")

    def predict_gene(self):
        self.copy_collection_with_change("gene_predict")

    def predict_rrna(self):
        self.copy_collection_with_change("rrna_predict")

    def predict_trna(self):
        self.copy_collection_with_change("trna_predict")
    ...
    def anno_dfvf(self):
        self.copy_collection_with_change("anno_dfvf")
    ...
    def anno_cyps(self):
        self.copy_collection_with_change("anno_cyps")

    def anno_signalp(self):
