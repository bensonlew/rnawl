...
class CorrClust(object):
    ...
    def corr_and_pvalue(self, profile, cor_method, outDir, trans=False,pvalue_threshold=None):
        """
        计算相关性和pvalue
...
if __name__ == '__main__':
    ...
    parser.add_argument('-pvalue', default=None, help="pvalue_threshold"),
    ...
    if args.corr:
        ...
        # if args.pvalue :
        #     pvalue_threshold = float(args.pvalue)
        # else:
        #     pvalue_threshold = None

        corr_table, pvalue_table = CorrClust.corr_and_pvalue(exp_pd, args.corr_method, outDir, trans=trans, pvalue_threshold=None)
