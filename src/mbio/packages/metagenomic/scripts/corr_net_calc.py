...
G = networkx.Graph()
name_list = ["0"]
p_value_list = {}     ## add by shaohua.yuan for metagenomic
...
for i in range(1,len(data)):
    ...
    elif abs(eval(s[2])) >= cut:    # modify by shaohua.yuan for metagenomic
