...
parser.add_option('-m', dest='method', type=str, choices=['rsem', 'salmon', 'kallisto'], help='quantitative method')
parser.add_option('-t', dest='type', type=str, choices=['T', 'G'], help='expression level')
