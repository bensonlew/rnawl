...
def clust(input_matrix, sub_num, method="both", lognorm=10, genes_distance_method="complete",
          samples_distance_method = "average", cltype="both",genes_distance_algorithm="euclidean",
          samples_distance_algorithm="pearson"):
    """
