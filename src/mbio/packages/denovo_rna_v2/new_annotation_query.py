...
class AllAnnoStat(object):
    ...
    def get_anno_stat(self, gene2trans, tran_outpath, gene_outpath, new_gtf_path, ref_gtf_path, length_path, gene_file, cog_list=None, kegg_table=None, gos_list=None, blast_nr_table=None, blast_swissprot_table=None, pfam_domain=None):
        ...
        with open(tran_outpath, 'wb') as w:
            if gene2trans:
                head = 'transcript\tgene_id\tlength\tcog\tnog\tcog_description\tnog_description\tKO_id\tKO_name\tpaths\tpfam\tgo\tnr\tswissprot\n'
            else:
            ...
            for name in self.stat_info:
                ...
                if gene2trans:
                    w.write('{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n'.format(
                        ...
                        self.stat_info[name].nog,
                        self.stat_info[name].cog_ids,
                        self.stat_info[name].nog_ids,
        ...
        with open(gene_outpath, 'wb') as w:
            if gene2trans:
                head = 'gene_id\tcog\tnog\tcog_description\tnog_description\tKO_id\tKO_name\tpaths\tpfam\tgo\tnr\tswissprot\n'
            else:
