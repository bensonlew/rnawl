...
def read_params(args):
	...
	parser.add_argument('--right_space_prop',dest="r_prop", type=float, default=0.4)
...
def draw_tree(out_file,tree,params):
	...
	fig = plt.figure(edgecolor=params['back_color'],facecolor=params['back_color'], figsize=(20,10))
