...
def main(args):
    ...
    export_transcript_result(t_exp_df, query_obj, relat_df, output_dir)
    logging.info('succeed in exporting transcript results in {}'.format(output_dir))
    export_gene_result(g_exp_df, query_obj, output_dir)
    logging.info('succeed in exporting gene results in {}'.format(output_dir))


def export_transcript_result(t_exp_df, query_obj, relat_df, output_dir):
...
def export_gene_result(g_exp_df, query_obj, output_dir):
