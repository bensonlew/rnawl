...
LIST_FILE="/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/wgbs/bismark1/rsrs/output/dss.list.txt"
RESULT_FILE="/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/wgbs/bismark1/rsrs/output/result.txt"
OUTPUT_DIR="/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/wgbs/bismark1/rsrs/figure"
