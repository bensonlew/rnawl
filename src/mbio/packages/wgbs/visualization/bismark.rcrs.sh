...
LIST_FILE="/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/wgbs/bismark1/rcrs/output/dss.list.txt"
RESULT_FILE="/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/wgbs/bismark1/rcrs/output/result.txt"
OUTPUT_DIR="/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/wgbs/bismark1/rcrs/figure"
