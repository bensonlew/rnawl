...
class CreatTableRelation(LabelfreeController):
    def __init__(self, project_type='labelfree', creat_targets=None):
    ...
    def get_main(self):
        ...
        main_table_id = self.labelfree.insert_main_table('sg_table_relation_v2', mongo_data)
