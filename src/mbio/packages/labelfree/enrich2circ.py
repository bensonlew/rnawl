...
class Enrich(object):
    def __init__(self):
        ...
        self.min_go_dep = 3
        self.max_go_dep = 7
        self.max_p_value = 1 # 因为to_file得到的enrich_table的p_uncorrected的p值可能等于1
    ...
    def filter_go_enrich(self, go_enrich_table):
        ...
        enrich_data = enrich_data[(enrich_data.depth >= self.min_go_dep) & (
                enrich_data.depth <= self.max_go_dep)]
