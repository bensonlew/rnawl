...
class EvolutionCopyDemo(Base):
    ...
    def __init__(self, old_task_id, new_task_id, new_project_sn, new_member_id):
        """
        """
        super(EvolutionCopyDemo, self).__init__()
    ...
    def run(self):
        ...
        self.copy_main_collection(collection="sg_history")		# indel功能注释
        self.copy_main_collection(collection="sg_sweep")           # circos圈图主表
        self.copy_main_collection(collection="sg_sweep_region")             # 基因注释主表
        self.copy_main_collection(collection="sg_ld")
        self.copy_main_collection(collection="sg_pop_structure")
        self.copy_main_collection(collection="sg_pop_pca")
        self.copy_main_collection(collection="sg_pop_tree")
        self.copy_main_collection(collection="sg_gene_seq")
        self.copy_main_collection(collection="sg_gwas_analysis")
        self.copy_main_collection(collection="sg_hapmap")
        self.copy_main_collection(collection="sg_region_anno")
        self.copy_main_collection(collection="sg_anno_params")
...
if __name__ == "__main__":
    a = EvolutionCopyDemo("tsg_32120", "evolution_copy_demo1", "evolution_copy_demo1-1", "evolution_copy_demo1-1new")
    a.run()
