...
# gene_list = []
# with open('/mnt/ilustre/users/sanger-dev/sg-users/zengjing/ref_rna/anno_test/human/unigene.list', 'rb') as f:
#     for line in f:
#         gene_list.append(line.strip('\n'))
# test = AllAnnoStat()
# outpath = '/mnt/ilustre/users/sanger-dev/sg-users/zengjing/ref_rna/anno_test/anno_result/all_anno_stat.xls'
# cog_list = '/mnt/ilustre/users/sanger-dev/sg-users/zengjing/ref_rna/anno_test/anno_result/output/cog/cog_list.xls'
# kegg_table = '/mnt/ilustre/users/sanger-dev/sg-users/zengjing/ref_rna/anno_test/anno_result/output/kegg/kegg_table.xls'
# gos_list = '/mnt/ilustre/users/sanger-dev/sg-users/zengjing/ref_rna/anno_test/anno_result/output/go/query_gos.list'
# blast_nr_table = '/mnt/ilustre/users/sanger-dev/sg-users/zengjing/ref_rna/anno_test/anno_result/blast_file/fasta_test_vs_nr.xls'
# nr_taxons = '/mnt/ilustre/users/sanger-dev/sg-users/zengjing/ref_rna/anno_test/anno_result/output/anno_stat/ncbi_taxonomy/query_taxons.xls'
# blast_swissprot_table = '/mnt/ilustre/users/sanger-dev/sg-users/zengjing/ref_rna/anno_test/anno_result/blast_file/fasta_test_vs_swissprot.xls'
# test.get_anno_stat(outpath=outpath, gene_list=gene_list, cog_list=cog_list, kegg_table=kegg_table, gos_list=gos_list, blast_nr_table=blast_nr_table, nr_taxons=nr_taxons, blast_swissprot_table=blast_swissprot_table)
