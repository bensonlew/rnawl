...
cazy_anno.to_csv(args['output_dir']+'cazy.parse.anno.xls', sep='\t', index=False, header=['Gene', 'Family', 'Evalue', 'Coverd_fraction', 'Class', 'Class_definition'])
enzy_anno.to_csv(args['output_dir']+'cazy.anno.xls', sep='\t', index=False, header=['Gene', 'Family', 'Enzyme', 'Enzyme_definition'])
...
with open(args['output_dir']+'cazy.family.stat.xls', 'w') as w:
...
with open(args['output_dir']+'cazy.class.stat.xls', 'w') as w:
