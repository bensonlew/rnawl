...
class CogAnnot(object):
    def __init__(self):
        ...
        self.cog_string = Config().get_mongo_client(mtype="meta", ref=True)[Config().get_mongo_dbname("meta", ref=True)].COG_String_V9
        self.cog = Config().get_mongo_client(mtype="meta", ref=True)[Config().get_mongo_dbname("meta", ref=True)].COG_V9   # add hongdong 15-16 20171101
        self.func_type = {
