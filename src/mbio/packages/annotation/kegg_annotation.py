...
class KeggAnnotation(object):
    def __init__(self):
        ...
        self.client = Config().get_mongo_client(mtype="meta", ref=True)   # modified by hongdong 20171101 23-24
        self.mongodb = self.client[Config().get_mongo_dbname("meta", ref=True)]
