...
class dna_card_anno(object):
    ...
    def __init__(self):
        ...
        self.card = self.mongodb["card_v3.0.9"]
    ...
    def card_by_mongo(self, align_table, anno_table, category):
        with open(align_table, 'r') as infile, open(anno_table, 'wb') as outfile:
            outfile.write(
                'Gene ID\tARO_name\tARO_Accession\tARO_description\tEvalue\tIdentity(%)\tDrug_class\tResistance_mechanism\tScore\tCoverage(%)\n')
            # query_list = []
            # done_list = []
            self.aro = {}
            for line in infile:
                ...
                if not "Score" in line[0]:
                    ...
                    try:
                        ...
                        if self.process_rerun < 5:
                            ...
                            time.sleep(5)
                            self.card_by_mongo(align_table, anno_table, category)
                        else:
                    ...
                    if detail:
                        ...
                        if category == "aro_category":
                            category_name = detail["aro_category"]
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', metavar='[category]', help='aro_category or drug_class', default="drug_class")
