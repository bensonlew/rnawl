...
all_nodes <- select(all_nodes3, node = node, degree = degree, accession_id = gene_id, STRING_id = protein_external_id, method=method)
#######################统计网络的特征值
...
acc2string=data.frame(diff_exp_example1$gene_id)
