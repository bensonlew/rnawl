...
class calculate_pangenome(object):
    ...
    def calculate(self, cluster, out):
        ...
        for i in range(10):#获取10组数据
            core_list, pan_list, newgen_list = self.get_all_sample_data(all_sample_num)
    ...
    def get_all_sample_data(self, total_sample_num):
        """
        ...
        for i in range(1,total_sample_num+1):
            choose_sample_list = self.get_random(i, total_sample_num)#获得需要进行计算的样本名称的list
