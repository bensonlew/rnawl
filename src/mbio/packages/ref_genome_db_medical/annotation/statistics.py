...
def main(l2d2t_tsv, map_tsv, stat_tsv):
    ...
    odf = odf.reindex(['go', 'kegg', 'cog', 'nr', 'swissprot', 'pfam', 'do', 'reactome', 'disgenet', 'annotation', 'total'])
    odf = odf.rename({'go': 'GO', 'kegg': 'KEGG', 'cog': 'COG', 'nr': 'NR', 'swissprot': 'Swiss-Prot', 'pfam': 'Pfam',
