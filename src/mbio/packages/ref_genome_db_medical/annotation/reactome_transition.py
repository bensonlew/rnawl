...
parser.add_option('--reactome_ids', dest='reactome_ids', help='input transcript reactome_ids annotation file')
parser.add_option('--output', dest='output', help='output gene reactome_ids annotation file')
...
if __name__ == '__main__':
    if all(map(hasattr, [opts] * 3, ['t2g', 'reactome_ids', 'output'])):
        main(opts.t2g, opts.reactome_ids, opts.output)
    else:
        parser.print_help()
