...
parser.add_option('--blast2do', dest='blast2do', help='input transcript blast2go annotation file')
...
if __name__ == '__main__':
    if all(map(hasattr, [opts] * 3, ['t2g', 'blast2do', 'output'])):
        main(opts.t2g, opts.blast2do, opts.output)
    else:
        parser.print_help()
