...
class MetagbinCopyDemo(Base):
    ...
    def genome(self):
        ...
        :return:
        """
        self.copy_collection_with_change('genome')
    ...
    def bin(self):
        ...
        :return:
        """
        self.copy_collection_with_change("bin")
    ...
    def assembly(self):
        ...
        :return:
        """
        self.copy_collection_with_change("assembly")
    ...
    def assess_gc(self):
        ...
        :return:
        """
        self.copy_collection_with_change('assembly_gc')

    def assembly_assess(self):
        """
        组装评估
        :return:
        """
        self.copy_collection_with_change('assembly_assess')
    ...
    def predict_cds(self):
        ...
        :return:
        """
        self.copy_collection_with_change("predict_cds")
    ...
    def predict_rrna(self):
        ...
        :return:
        """
        self.copy_collection_with_change("predict_rrna")
    ...
    def predict_trna(self):
        ...
        :return:
        """
        self.copy_collection_with_change("predict_trna")
    ...
    def predict_repeat(self):
        ...
        :return:
        """
        self.copy_collection_with_change("predict_repeat")

    def identif_16s(self):
        """
        16s物种分类
        :return:
        """
        self.copy_collection_with_change('identif_16s')

    def identif_genus(self):
        """
        属水平鉴定
        :return:
        """
        self.copy_collection_with_change('identif_genus')

    def identif_species(self):
        """
        种水平鉴定
        :return:
        """
        self.copy_collection_with_change('identif_species')
    ...
    def colline(self):
        ...
        :return:
        """
        self.copy_collection_with_change('colline')
    ...
    def anno_stat(self):
        ...
        :return:
        """
        self.copy_collection_with_change("anno_stat")
    ...
    def cor_gene(self):
        ...
        :return:
        """
        self.copy_collection_with_change("cor_gene")
    ...
    def tnf(self):
        ...
        :return:tnf
        """
        self.copy_collection_with_change("tnf")

    def run(self):
        print "STRART COPYMEMBERID"
        self.copy_member_id()
        greenlet = Greenlet(self.genome)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.bin)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.assembly)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.assess_gc)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.assembly_assess)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.predict_cds)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        ...
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.predict_repeat)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.anno_stat)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.anno_nr)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.anno_kegg)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.anno_cog)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.anno_cazy)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.anno_card)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.anno_summary)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.identif_16s)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.identif_genus)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.identif_species)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.colline)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.cor_gene)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.tree)
        greenlet.start()
        self.all_greenlets.append(greenlet)
        greenlet = Greenlet(self.tnf)
        greenlet.start()
        self.all_greenlets.append(greenlet)
...
if __name__ == '__main__':
    ...
    copy_task = MetagbinCopyDemo('tsg_33191', '188_5c26cc136502c ', '111112', '111113', '2')  # input params from task existed
    copy_task.run()
    end_time = time.time()
