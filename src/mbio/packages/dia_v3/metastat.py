...
def two_group_test(inputfile, groupfile, outputfile, log_trans="none", choose_test="student", ci=0.95,
    test_type="two.side", mul_test="none", cutoff_a='1.5', cutoff_b='1.5'):
    """
    ...
    two_test = f.render(inputfile=inputfile, groupfile=groupfile, outputfile=outputfile, log_trans=log_trans,
                        choose_test=choose_test, test_type=test_type, mul_test=mul_test, ci=ci,
...
def two_sample_test(inputfile, outputfile, choose_test, sample1, sample2,
                    log_trans="none", ci=0.95, test_type="two.side", mul_test="none"):
    """
    ...
    two_test = f.render(inputfile=inputfile, outputfile=outputfile, choose_test=choose_test,
                        sample1=sample1, sample2=sample2, log_trans=log_trans, ci=ci, test_type=test_type, mul_test=mul_test)
    with open("run_%s_test.r" % choose_test, 'w') as rfile:
        rfile.write('%s' % two_test)
