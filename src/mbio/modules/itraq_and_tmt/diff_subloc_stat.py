...
class DiffSublocStatModule(Module):
    def __init__(self, work_id):
        ...
        options = [
            ...
            {'name': 'subloc_file', 'type': 'infile', 'format': 'itraq_and_tmt.common'},
        ]
    ...
    def run_subloc_stat(self):
        ...
        for diff in diff_files:
            ...
            if len(uplist + downlist) > 10:
                de_tool = self.add_tool("itraq_and_tmt.export_subloc_stat")
                de_tool.set_options(options)
                self.tools.append(de_tool)
                up_down_tool = self.add_tool("itraq_and_tmt.export_subloc_stat")
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "itraq_and_tmt.diff_subloc_stat",
            "instant": False,
            "options": dict(
