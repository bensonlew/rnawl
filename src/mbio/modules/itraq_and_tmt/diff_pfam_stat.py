...
class DiffPfamStatModule(Module):
    def __init__(self, work_id):
        ...
        options = [
            ...
            {'name': 'pfam_file', 'type': 'infile', 'format': 'itraq_and_tmt.common'},
        ]
    ...
    def run_pfam_stat(self):
        ...
        for diff in diff_files:
            ...
            if len(uplist + downlist) > 100:
                de_tool = self.add_tool("itraq_and_tmt.export_pfam_stat")
                de_tool.set_options(options)
                self.tools.append(de_tool)
                up_down_tool = self.add_tool("itraq_and_tmt.export_pfam_stat")
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "itraq_and_tmt.diff_pfam_stat",
            "instant": False,
            "options": dict(
