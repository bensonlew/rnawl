...
class NiptAnalysisModule(Module):
    ...
    def bed_run(self):
        ...
        self.logger.info("bed_dir:{}".format(bed_dir))
        n = 0
    ...
    def identification_run(self):
        ...
        self.identification.on('start', self.set_step, {'start': self.step.identification})
        self.identification.on('end', self.set_step, {'end': self.step.identification})
