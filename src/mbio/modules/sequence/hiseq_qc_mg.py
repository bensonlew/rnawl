...
class HiseqQcMgModule(Module):
    ...
    def __init__(self, work_id):
        super(HiseqQcMgModule, self).__init__(work_id)
        options = [
    ...
    def sickle_se_run(self, event):
        ...
        sickle = self.add_tool('sequence.sickle_mg')
    ...
    def run(self):
        super(HiseqQcMgModule, self).run()
    ...
    def end(self):
        ...
        super(HiseqQcMgModule, self).end()
