...
class CardDnaAnnoModule(Module):
    def __init__(self, work_id):
        ...
        self.card_anno_tool = self.add_tool("metagbin.card_anno")
        self.add_info_tools = []
    ...
    def card_align(self):
        ...
        for f in os.listdir(self.split_fasta.output_dir):
            ...
            align_diamond.set_options({
                "query": file_path,
                "database": self.option("database"),## fix_by qingchen.zhang @20200811 更新数据库
    ...
    def change_table(self):
        if os.path.exists(self.card_anno_tool.output_dir + '/gene_card_anno.xls'):
