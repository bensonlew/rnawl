...
class HiseqQcModule(Module):
    ...
    def seqprep_run(self):
        ...
        for f in self.samples:
            ...
            seqprep = self.add_tool('ref_rna_v2.seq_prep')
    ...
    def test(self):
        ...
        data = {
            ...
            "options": dict(
                ...
                fastq_dir="/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/lncRNA/test_data_new/new_test_rawdata1/Human_10smaples/PE_rawdata",
                fq_type="SE",
                adapter_a="AGTTCCCGGAAGAGCACACGTC",
                # adapter_b="AAGTTCCCGGAAGAGCACACTGT",
