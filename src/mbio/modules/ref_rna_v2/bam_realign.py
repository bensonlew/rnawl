...
class BamRealignModule(Module):
    ...
    def check_options(self):
        if not self.option("in_bam"):
            raise OptionError("请输入bam文件夹", code="23701602")
        return True
    ...
    def run_bam_realign(self):
        ...
        with open(self.bam_list) as f:
            ...
            if self.bam_realign_tools:
                ...
                self.set_error("bam_realign_tools列表为空！", code="23701602")
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            "id": "bam_realign" + str(random.randint(1, 10000)),
            "type": "module",
            "name": "ref_rna_v2.bam_realign",
            "instant": False,
            "options": dict(
                #ref_dict=test_dir + "/" + "Mus_musculus.GRCm38.dna_rm.toplevel.clean.dict",
                in_bam="/mnt/ilustre/users/sanger-dev/workspace/20190322/Snp_tsg_33538_3123_8568/bam_folder/",
                #bam_list="/mnt/ilustre/users/sanger-dev/workspace/20190618/Single_snp4914/PicardRna/output/bam_list",
                fa_file=test_dir+"/"+"Mus_musculus.GRCm38.dna_rm.toplevel.clean.fa",
                #call_type="sentieon",
