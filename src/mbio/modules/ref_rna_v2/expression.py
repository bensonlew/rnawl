...
class ExpressionModule(Module):
    ...
    def run_prepare(self):
        ...
        self.prepare = self.add_tool('ref_rna_v2.expression.prepare')
        options = {
    ...
    def set_rsem(self):
        for n, sample in enumerate(self.option('fq_list').samples):
            ...
            rsem = self.add_tool('ref_rna_v2.expression.rsem')
            options = {
    ...
    def set_salmon(self):
        for n, sample in enumerate(self.option('fq_list').samples):
            ...
            salmon = self.add_tool('ref_rna_v2.expression.salmon')
            options = {
                'fq_type': self.option('fq_type'),
    ...
    def set_kallisto(self):
        for n, sample in enumerate(self.option('fq_list').samples):
            ...
            kallisto = self.add_tool('ref_rna_v2.expression.kallisto')
            options = {
                'fq_type': self.option('fq_type'),
    ...
    def run_statistics(self):
        ...
        for exp_type in ['T', 'G']:
            ...
            statistics = self.add_tool('ref_rna_v2.expression.statistics')
            options = {
                'exp_type': exp_type,
