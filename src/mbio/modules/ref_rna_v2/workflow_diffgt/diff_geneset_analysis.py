...
class DiffGenesetAnalysisModule(Module):
    def __init__(self, work_id):
        ...
        options = [
            ...
            {'name': 'kegg_table', 'type': 'infile', 'format': 'ref_rna_v2.common'},
            {'name': 'kegg_table2', 'type': 'infile', 'format': 'ref_rna_v2.common'},
            {'name': 'all_list', 'type': 'infile', 'format': 'ref_rna_v2.common'},
            {'name': 'add_info', 'type': 'infile', 'format': 'ref_rna_v2.common'},
            # {'name': 'reactome_annot', 'type': 'infile', 'format': 'ref_rna_v2.common'},
            ...
            {'name': 'gene_multi', 'type': 'infile', 'format': 'ref_rna_v2.common'},
            {'name': 'go_class', 'type': 'infile', 'format': 'ref_rna_v2.common'},
            {'name': 'cog_class', 'type': 'infile', 'format': 'ref_rna_v2.common'},
            {'name': 'method', 'type': 'string', 'default': ''},
            # {'name': 'do_class', 'type': 'infile', 'format': 'ref_rna_v2.common'},
        ]
        self.add_option(options)
        self.go_class_tool = None
        self.kegg_class_tool = self.add_tool("ref_rna_v2.diffgt4work.diff_kegg_class")
        self.go_enrich_tool = self.add_tool("ref_rna_v2.diff_geneset.diff_go_enrich")
        self.kegg_enrich_tool = self.add_module("ref_rna_v2.workflow_diffgt.diff_kegg_enrich")
    ...
    def check_options(self):
        ...
        # if self.option("genes_num") > 0:
            ...
            #     self.reactome_class_tool = self.add_tool("ref_rna_v2.diff_geneset.diff_reactome_class")
            ...
            #     self.reactome_enrich_tool = self.add_module("ref_rna_v2.diff_geneset.diff_reactome_enrich")
            ...
            #         self.do_class_tool = self.add_tool("ref_rna_v2.diff_geneset.diff_do_class")
            ...
            #         self.do_enrich_tool = self.add_tool("ref_rna_v2.diff_geneset.diff_do_enrich")
    ...
    class TestFunction(unittest.TestCase):
        ...
        def test(self):
            ...
            data = {
                ...
                "type": "module",
                "name": "ref_rna_v2.diff_geneset.diff_geneset_analysis",
                "instant": False,
                "options": dict(
                    task_id='ref_rna_v2',
                    level='G',
