...
class DiffKeggEnrichNewModule(Module):
    ...
    def __init__(self, work_id):
        ...
        # self.common = self.add_tool("ref_rna_v2.diff_geneset.annot_prepare")
    ...
    def run_kegg_rich(self):
        self.enrich_tool = self.add_tool('ref_rna_v2.diff_geneset.diff_kegg_rich')
    ...
    def run_kegg_class(self):
        self.kegg_class = self.add_tool('ref_rna_v2.diffgt4work.diff_kegg_class')
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "ref_rna_v2.diff_geneset.diff_kegg_enrich",
            "instant": False,
            "options": dict(
