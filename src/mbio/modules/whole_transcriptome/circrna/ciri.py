...
class CiriModule(Module):
    def __init__(self, work_id):
        super(CiriModule, self).__init__(work_id)
        options = [
    ...
    def run_ciri2(self):
        ...
        self.ciri2.on('end', self.run_signal)
        self.ciri2.run()
    ...
    def run_signal(self):
        ...
        opts = {
            'sample': self.option('sample'),
            'genome': self.option('genome'),
            'circRNA_merge': self.ciri2.option('ciri_circ_filter'),
            # 'bed': self.option('bed'),
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            'id': 'ciri_{}_{}'.format(random.randint(1000, 9999), random.randint(1000, 9999)),
            'type': 'module',
            'name': 'whole_transcriptome.circrna.ciri',
            'instant': False,
            'options': {
