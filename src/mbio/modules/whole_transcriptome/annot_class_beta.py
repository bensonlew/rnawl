...
class AnnotClassBetaModule(Module):
    ...
    def run_nr_annot(self):
        ...
        self.nr_annot = self.add_tool('ref_rna_v2.annotation.nr_annot')
        options = {
    ...
    def run_swissprot_annot(self):
        ...
        self.swissprot_annot = self.add_tool('ref_rna_v2.annotation.swissprot_annot')
        options = {
    ...
    def run_eggnog_annot(self):
        ...
        self.eggnog_annot = self.add_tool('whole_transcriptome.annotation.eggnog_annot')
        options = {
    ...
    def run_annot_final(self):
        ...
        self.annot_final = self.add_tool('whole_transcriptome.annotation.annot_final')
        options = {
