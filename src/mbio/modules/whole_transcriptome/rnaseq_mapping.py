...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "whole_transcriptome.rnaseq_mapping",
            "instant": False,
            "options": dict(
                ...
                seq_method="PE",
                mapping_method="hisat",   # 比对软件，如star, hisat2
                fastq_dir="/mnt/ilustre/users/sanger-dev/workspace/20191008/LncRna_tsg_35703/LncrnaQc/output/sickle_dir",
