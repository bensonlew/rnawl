...
class LncrnaFamilyModule(Module):
    ...
    def run_family_prep(self):
        ...
        self.family_prep = self.add_tool('whole_transcriptome.longrna.family_prep')
        options = {
    ...
    def run_cmscan(self):
        for n, seqfile in enumerate(glob.glob(os.path.join(self.family_prep.output_dir, '*'))):
            ...
            cmscan = self.add_tool('whole_transcriptome.longrna.cmscan')
    ...
    def run_family_stat(self):
        ...
        self.family_stat = self.add_tool('whole_transcriptome.longrna.family_stat')
        options = {
            'tsv_list': tsv_list,
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            'id': 'whole_transcriptome_longrna_lncrna_family_{}_{}'.format(random.randint(1000, 10000), random.randint(1000, 10000)),
            'type': 'module',
            'name': 'whole_transcriptome.longrna.lncrna_family',
            'instant': False,
            'options': {
