...
class FastpRnaModule(Module):
    ...
    def fastp_run(self):
        ...
        for sample in self.sample_info:
            self.fastp = self.add_tool('whole_transcriptome.longrna.fastp_rna')
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            "id": "whole_transcriptome_Qc_fastp_" + str(random.randint(1, 10000)),
            "type": "module",
            "name": "whole_transcriptome.longrna.fastp_rna",
            "instant": False,
            "options": dict(
                sample_path="/mnt/ilustre/users/sanger-dev/sg-users/shicaiping/whole_transcriptome/demo_human/longrna/rawdata/list.txt",
            )
        }
