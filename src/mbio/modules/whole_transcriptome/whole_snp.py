...
class WholeSnpModule(Module):
    ...
    def run_sentieon(self):
        self.snp=self.add_module('whole_transcriptome.call_snp_indel_sentieon')
    ...
    def run_samtools(self):
        self.snp = self.add_module('whole_transcriptome.call_snp_indel_samtools')
        opts = {
    ...
    def run_gatk(self):
        self.snp = self.add_module('whole_transcriptome.call_snp_indel_gatk')
        opts = {
            'ref_genome_custom': self.option("ref_genome_custom"),
            'in_bam': self.option("in_bam"),
            'ref_gtf': self.option("ref_gtf"),
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "whole_transcriptome.whole_snp",
            "instant": False,
            "options": dict(
