...
class CallSnpIndelSamtoolsModule(Module):
    ...
    def __init__(self, work_id):
        ...
        self.split = self.add_tool('whole_transcriptome.snp.split_ref_fasta')
    ...
    def samtool_run(self):
        ...
        for m in files_list:
            self.samtool = self.add_tool('whole_transcriptome.snp.snp')
    ...
    def bcftools_vcf_run(self):
        self.bcftools_vcf = self.add_tool("whole_transcriptome.snp.bcftool_vcf")
        self.get_vcf_list()
    ...
    def vcf_filter_run(self):
        self.vcf_filter=self.add_tool('whole_transcriptome.snp.vcf_filter_samtools')
