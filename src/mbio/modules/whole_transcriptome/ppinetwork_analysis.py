...
class PpinetworkAnalysisModule(Module):
    def __init__(self, work_id):
        ...
        self.map = self.add_tool("ref_rna_v2.geneset.ppinetwork_map")
        self.map_blast = self.add_tool("ref_rna_v2.geneset.ppinetwork_mapblast")
        self.ppinetwork_predict = self.add_tool("ref_rna_v2.geneset.ppinetwork_predict")
        self.ppinetwork_topology = self.add_tool("ref_rna_v2.geneset.ppinetwork_topology")
        self._end_info = 0
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "ref_rna_v2.ppinetwork_analysis",
            "instant": False,
            "options": dict(
