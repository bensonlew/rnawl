...
class AnnotationModule(Module):
    ...
    def run(self):
        ...
        self.annot_class_beta_ref = self.add_module('whole_transcriptome.annot_class_beta')
        ...
        self.annot_class_beta_new = self.add_module('whole_transcriptome.annot_class_beta')
    ...
    def set_output(self):
        ...
        shutil.copytree(self.annot_orfpfam.output_dir, os.path.join(self.output_dir, 'newannot_orfpfam'))
        self.end()
