...
class TestFunction(unittest.TestCase):
    ...
    def test_hsa(self):
        ...
        data = {
            ...
            'type': 'module',
            'name': 'whole_transcriptome.smallrna.mirna_edit',
            'instant': False,
            'options': {
                'list_file': '/mnt/ilustre/users/sanger-dev/workspace/20190926/Single_whole_transcriptome.smallrna.mirna_qc15-22-40/MirnaQc/output/clean_data/list.txt',
                'species': 'hsa',
