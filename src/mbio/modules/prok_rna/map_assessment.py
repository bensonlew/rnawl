...
class MapAssessmentModule(Module):
    ...
    def distribution_run(self):
        n = 0
        for f in self.files:
            distribution = self.add_tool("prok_rna.bam_readsdistribution")
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "prok_rna.map_assessment",
            "instant": False,
            "options": dict(
                bam="/mnt/ilustre/users/sanger-dev/workspace/20180809/Single_RnaseqMapping_6997/RnaseqMapping/output/bam",
                analysis="saturation,coverage,distribution,chr_stat",
                bed="/mnt/ilustre/users/sanger-dev/sg-users/fengyitong/prok_rna/pipline/ref/index_test/Rockhopper_Results/genome.gene.bed",
            )
        }
