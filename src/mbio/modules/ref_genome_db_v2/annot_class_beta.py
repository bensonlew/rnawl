...
class AnnotClassBetaModule(Module):
    ...
    def run_annot_begin(self):
        ...
        self.annot_begin = self.add_tool('ref_genome_db_v2.annotation.annot_begin')
    ...
    def run_nr_annot(self):
        ...
        self.nr_annot = self.add_tool('ref_genome_db_v2.annotation.nr_annot')
        options = {
    ...
    def run_swissprot_annot(self):
        ...
        self.swissprot_annot = self.add_tool('ref_genome_db_v2.annotation.swissprot_annot')
        options = {
    ...
    def run_eggnog_annot(self):
        ...
        self.eggnog_annot = self.add_tool('ref_genome_db_v2.annotation.eggnog_annot')
        options = {
    ...
    def run_kegg_annot(self):
        ...
        self.kegg_annot = self.add_tool('ref_genome_db_v2.annotation.kegg_annot')
        options = {
    ...
    def run_go_annot(self):
        ...
        self.go_annot = self.add_tool('ref_genome_db_v2.annotation.go_annot')
        options = {
    ...
    def run_pfam_annot(self):
        ...
        self.pfam_annot = self.add_tool('ref_genome_db_v2.annotation.pfam_annot')
        options = {
    ...
    def run_annot_final(self):
        ...
        self.annot_final = self.add_tool('ref_genome_db_v2.annotation.annot_final')
        options = {
    ...
    def set_output(self, event):
        ...
        if event['data'] == 'swissprot_annot':
            ...
            os.rename(os.path.join(swissprot_dir, 'swissprot.G.tsv'),
                      os.path.join(swissprot_dir, 'swissprot_blast_gene.xls'))
            os.rename(os.path.join(swissprot_dir, 'swissprot.T.tsv'),
                      os.path.join(swissprot_dir, 'swissprot_blast_tran.xls'))
            os.rename(os.path.join(swissprot_dir, 'swissprot.G.list'),
                      os.path.join(swissprot_dir, 'swissprot_venn_gene.txt'))
            os.rename(os.path.join(swissprot_dir, 'swissprot.T.list'),
                      os.path.join(swissprot_dir, 'swissprot_venn_tran.txt'))
...
class TestFunction(unittest.TestCase):
    ...
    def test_ref(self):
        ...
        data = {
            ...
            'type': 'module',
            'name': 'ref_genome_db_v2.annot_class_beta',
            'instant': False,
            'options': {
