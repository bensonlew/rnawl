...
class DiffGenesetAnalysisModule(Module):
    def __init__(self, work_id):
        ...
        self.kegg_class_tool = self.add_tool("whole_transcriptome.geneset.kegg_class")
        self.go_enrich_tool = self.add_tool("whole_transcriptome.geneset.go_enrich")
        self.kegg_enrich_tool = self.add_module("whole_transcriptome_v1_2.workflow_diffgt.diff_kegg_enrich")
