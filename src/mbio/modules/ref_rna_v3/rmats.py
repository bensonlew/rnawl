...
class RmatsModule(Module):
    ...
    def set_rmats(self, n, ctrl, test):
        ...
        rmats = self.add_tool('ref_rna_v3.structure.rmats')
    ...
    def run_rmats_count(self):
        ...
        self.rmats_count = self.add_tool('ref_rna_v3.structure.rmats_count')
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            'type': 'module',
            'name': 'ref_rna_v3.rmats',
            'instant': False,
            'options': {
                'control_table': '/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/ref_rna_v2/rmats/test_control.txt',
                'group_table': '/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/ref_rna_v2/rmats/test_group.txt',
                'bam_input': '/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/ref_rna_v2/rmats/test',
