...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            "id": "snp" + str(random.randint(1, 10000))+"picardbam",
            "type": "module",
            "name": "ref_rna_v3.call_snp_indel",
            "instant": False,
            "options": dict(
                ...
                bam_list="/mnt/ilustre/users/sanger-dev/workspace/20191212/Single_snp97/BamSort/output/bam1.list",
                call_type="sentieon",
                ref_fasta="/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/vertebrates/Mus_musculus/GRCm38_Ensembl_96/dna/Mus_musculus.GRCm38.dna.toplevel.fa",
