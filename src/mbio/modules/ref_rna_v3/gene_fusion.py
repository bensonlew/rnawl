...
class GeneFusionModule(Module):
    ...
    def star_fusion_run(self):
        ...
        for key in sample_info.keys():
            star_fusion = self.add_module("ref_rna_v3.star_fusion")
            opts={
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "ref_rna_v3.gene_fusion",
            "instant": False,
            "options": dict(
                bam_list="/mnt/ilustre/users/sanger-dev/workspace/20200617/Snp_tsg_37581_3329_6539/bamlist_new",
                ref_genome_custom="/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/vertebrates/Homo_sapiens/GRCh38.p13_ensembl_98/dna/Homo_sapiens.GRCh38.dna_sm.primary_assembly.fa",
                ref_gtf ="/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/vertebrates/Homo_sapiens/GRCh38.p13_ensembl_98/gtf/Homo_sapiens.GRCh38.98.gtf",
            )
           }
