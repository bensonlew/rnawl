...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "ref_rna_v3.call_snp_indel_gatk",
            "instant": False,
            "options": dict(
                ref_fasta="/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/vertebrates/Mus_musculus/GRCm38_Ensembl_96/dna/Mus_musculus.GRCm38.dna.toplevel.old.fa",
                ...
                in_bam="/mnt/ilustre/users/sanger-dev/workspace/20190712/Snp_tsg_34825_8321_5445/bam_folder",
