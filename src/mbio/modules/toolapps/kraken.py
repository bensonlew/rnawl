...
class KrakenModule(Module):
    ...
    def __init__(self, work_id):
        super(KrakenModule, self).__init__(work_id)
        options = [
        ...
        self.step.add_steps('data', 'kraken', 'sequence', 'qc_', 'rm_host', 'clean_data')
        ...
        self.kraken = self.add_module('metagenome.kraken')
    ...
    def run_kraken(self):
        ...
        self.kraken.on('end', self.set_output, 'kraken')
