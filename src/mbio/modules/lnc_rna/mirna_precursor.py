...
class MirnaPrecursorModule(Module):
    ...
    def run_precursor_candidate(self):
        ...
        self.precursor_candidate = self.add_tool('lnc_rna.structure.precursor_candidate')
        options = {
    ...
    def run_precursor_stat(self):
        ...
        self.precursor_stat = self.add_tool('lnc_rna.structure.precursor_stat')
        options = {
