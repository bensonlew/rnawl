...
class TargetPredictModule(Module):
    ...
    def __init__(self, work_id):
        ...
        options = [
            ...
            {"name": "ref", "type": "infile", "format": "lnc_rna.fasta"},  # 输入文件
        ...
        self.known_merge_tool = self.add_tool('lnc_rna.merge_target_result')
        self.novol_merge_tool = self.add_tool('lnc_rna.merge_target_result')
