...
class TestFunction(unittest.TestCase):
    ...
    def test_stringtie(self):
        ...
        data = {
            'id': 'annot_mapdb_{}_{}'.format(random.randint(1000, 10000), random.randint(1000, 10000)),
            'type': 'module',
            'name': 'lnc_rna.annot_mapdb',
            'instant': False,
            'options': {
                'query': '/mnt/ilustre/users/isanger/sg-users/qinjincheng/lnc_rna/assemble/method-stringtie/output/NewTranscripts/new_transcripts.fa',
                'nr_db': 'metazoa',
            }
        }
