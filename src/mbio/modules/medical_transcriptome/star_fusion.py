...
class StarFusionModule(Module):
    ...
    def __init__(self, work_id):
        ...
        options = [
            ...
            {"name": "min_FFPM", "type": "float", "default": 0.1},
            {"name": "circos", "type": "string", "default": "circos"},
        ...
        self.make_lib = None
        self.star_fusion = self.add_tool("medical_transcriptome.gene_fusion.star_fusion")
        self.bam2fastq = self.add_tool("medical_transcriptome.gene_fusion.bam2fastq")
        self.result_filter = self.add_tool("medical_transcriptome.gene_fusion.fusion_result_filter")
        self.id_modify = self.add_tool("medical_transcriptome.gene_fusion.id_modify")
        self.fusioninspector = self.add_tool("medical_transcriptome.gene_fusion.fusioninspector")
        self.fusion_result = ""
