...
from mbio.packages.medical_transcriptome.functions import modlfuncdeco
import os
import glob
import shutil
import unittest
...
class RmatsModule(Module):
    ...
    def __init__(self, work_id):
        ...
        options = [
            ...
            {'name': 'input_gtf', 'type': 'infile', 'format': 'ref_rna_v2.gtf'},
            # ['paired', 'single']
        ...
        # self.logger.info("lalalal{}".format(self._sheet.output))
    ...
    def run_rmats(self):
        ...
        self.sample2path = {os.path.basename(p)[:-4]: p
    ...
    def set_rmats(self, n, ctrl, test):
        ...
        rmats = self.add_tool('medical_transcriptome.structure.rmats')
    ...
    def run_rmats_count(self):
        ...
        self.rmats_count = self.add_tool('medical_transcriptome.structure.rmats_count')
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            'type': 'module',
            'name': 'medical_transcriptome.rmats.rmats',
            'instant': False,
            'options': {
                'control_table': '/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/medical_transcriptome/rmats/test_data/small/example_control_1528169151.txt',
                'group_table': '/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/medical_transcriptome/rmats/test_data/small/example_group_1528169151.txt',
                'bam_input': '/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/medical_transcriptome/rmats/test_data/small/bam',
                'input_gtf': '/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/medical_transcriptome/rmats/test_data/small/ref_and_new.gtf',
                'seq_type': 'paired',
