...
class DiffGenesetAnalysisModule(Module):
    def __init__(self, work_id):
        ...
        self.kegg_class_tool = self.add_tool("medical_transcriptome.diff_geneset.diff_kegg_class")
        self.go_enrich_tool = self.add_tool("medical_transcriptome.diff_geneset.diff_go_enrich")
        self.kegg_enrich_tool = self.add_module("medical_transcriptome.diff_geneset.diff_kegg_enrich")
    ...
    def prepare_file_json(self):
        option_names = ["task_id","level","species","go_list","kegg_table",
