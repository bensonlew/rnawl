...
class CallSnpIndelSentieonModule(Module):
    ...
    def haplotype_v2_run(self):
        ...
        n = 0
        for keys in sample_info.keys():
            haplotype = self.add_module("medical_transcriptome.snp.pre4sentieon")
            haplotype.set_options({
                "ref_fasta": self.option("ref_fasta").prop["path"],
    ...
    def gvcf_typing_v2_run(self):
        ...
        """
        self.make_gvcf_list()
        self.gvcf_typing_v2 = self.add_tool("medical_transcriptome.snp.gvcf_typing_v2")
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "instant": False,
            "options": dict(
                bam_list="/mnt/ilustre/users/sanger-dev/workspace/20191219/Refrna_tsg_36592/RnaseqMapping/output/bamlist",
                call_type="sentieon",
