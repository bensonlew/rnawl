...
class AsprofileModule(Module):
    ...
    def run_count_ref(self):
        self.count_ref = self.add_tool('medical_transcriptome.ASprofile.count_ref')
    ...
    def run_gtf_compare(self):
        ...
        for sample, gtf_list in sp2fqs_dict.items():
            self.gffcompare = self.add_tool('medical_transcriptome.ASprofile.gffcompare')
    ...
    def run_asprofile(self):
        ...
        for sample, gtf_list in sp2fqs_dict.items():
            self.asprofile = self.add_tool('medical_transcriptome.ASprofile.asprofile')
    ...
    def run_merge(self):
        ...
        self.merge = self.add_tool('medical_transcriptome.ASprofile.merge')
