...
class IslandModule(Module):
    ...
    def __init__(self, work_id):
        ...
        self.gihunter = self.add_module('mobile_genetic_elements.gihunter_predict')
        self.dimob = self.add_module('mobile_genetic_elements.island_dimob')
        self.islander = self.add_module('mobile_genetic_elements.island_islander')
    ...
    def set_output(self):
        ...
        if os.path.exists(self.islander_stat.output_dir + "/" + self.option("sample") + ".GI_summary.xls"):
