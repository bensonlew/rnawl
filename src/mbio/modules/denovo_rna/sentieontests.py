...
class SentieontestsModule(Module):
    """
    ...
    def __init__(self, work_id):
        super(SentieontestsModule, self).__init__(work_id)
        options = [
    ...
    def picard_run1(self):
        ...
        for j in range(len(self.picards)):
            self.picards[j].on("end", self.set_output, 'presnp')
    ...
    def run(self):
        super(SentieontestsModule, self).run()
    ...
    def end(self):
        super(SentieontestsModule, self).end()
