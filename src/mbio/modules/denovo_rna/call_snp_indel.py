...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            "id": "snp_snetieon" + str(random.randint(1, 10000)),
            "type": "module",
            "name": "denovo_rna.call_snp_indel",
            "instant": False,
            "options": dict(
                ...
                bam_list="/mnt/ilustre/users/sanger-dev/workspace/20190801/Single_bam_realign2287/BamRealign/output/bam.list",
                call_type="sentieon",
