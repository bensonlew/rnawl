...
class PpinetworkAnalysisModule(Module):
    def __init__(self, work_id):
        ...
        options = [
            {"name": "diff_exp_gene", "type": "infile", "format": "denovo_rna_v2.common"},
        ...
        self.map = self.add_tool("denovo_rna_v2.geneset.ppinetwork_map")
        self.map_blast = self.add_tool("denovo_rna_v2.geneset.ppinetwork_mapblast")
        self.ppinetwork_predict = self.add_tool("denovo_rna_v2.geneset.ppinetwork_predict")
        self.ppinetwork_topology = self.add_tool("denovo_rna_v2.geneset.ppinetwork_topology")
        self._end_info = 0
    ...
    def ppinetwork_predict_run(self):
        ...
        if not line:
            self.set_error("基因集中的基因不能匹配到string数据库中id，请您确认基因id为Ensemble或者Entrez GeneID！", code = "22001004")
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "denovo_rna_v2.ppinetwork_analysis",
            "instant": False,
            "options": dict(
