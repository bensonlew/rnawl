...
class DiffKeggEnrichNewModule(Module):
    """
    该Module用于基因融合分析，默认使用方法
    """
    def __init__(self, work_id):
        super(DiffKeggEnrichNewModule, self).__init__(work_id)
        options = [
        ...
        # self.common = self.add_tool("denovo_rna_v2.diff_geneset.annot_prepare")
    ...
    def run_kegg_rich(self):
        self.enrich_tool = self.add_tool('denovo_rna_v2.diff_geneset.diff_kegg_rich')
    ...
    def run_kegg_class(self):
        self.kegg_class = self.add_tool('denovo_rna_v2.diffgt4work.diff_kegg_class')
    ...
    def run(self):
        super(DiffKeggEnrichNewModule, self).run()
    ...
    def end(self):
        super(DiffKeggEnrichNewModule, self).end()
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "denovo_rna_v2.diff_geneset.diff_kegg_enrich",
            "instant": False,
            "options": dict(
                ...
                kegg_table2 = "/mnt/ilustre/users/sanger-dev/workspace/20200914/Single_geneset_prepare6287/DiffGenesetPrepare/AnnotPrepare/output/gene_kegg_level_table.xls",
