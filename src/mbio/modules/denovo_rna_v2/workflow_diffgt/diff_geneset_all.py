...
class DiffGenesetAllModule(Module):
    ...
    def __init__(self, work_id):
        ...
        options = [
            # {"name": "geneset_names", "type": "infile", "format": "denovo_rna_v2.common"},
        ...
        self.common = self.add_tool("denovo_rna_v2.diffgt4work.annot_prepare")
    ...
    def get_genesets_info(self):
        ...
        for diff in diff_files:
            ...
            geneset_name = "{}_vs_{}_{}".format(ctrl,test,self.option("level"))
            regulate = "all"
            compare = ctrl+"|"+test
    ...
    def prepare_geneset_infos(self):
        for key in self.genest_infos:
            diff_geneset = self.add_tool("denovo_rna_v2.diffgt4work.diff_geneset_prepare")
            opts = {
                "annot_result": self.option("annot_result"),
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "denovo_rna_v2.workflow_diffgt.diff_geneset_all",
            "instant": False,
            "options": dict(
                diff_path= "/mnt/ilustre/users/sanger-dev/workspace/20200923/MedicalTranscriptome_denovo_rna_v2_workflow_20200923_153802009/DiffexpBatch/output",
                annot_result ="/mnt/ilustre/users/sanger-dev/workspace/20200923/MedicalTranscriptome_denovo_rna_v2_workflow_20200923_153802009/AnnotMerge__1/output",
                diff_method="DESeq2",
                kegg_version ="202007",
                # reactome_version="202007",
                level = "G",
                gene_count_file ="/mnt/ilustre/users/sanger-dev/workspace/20200923/MedicalTranscriptome_denovo_rna_v2_workflow_20200923_153802009/Quant/output/gene.count.matrix",
            )
           }
