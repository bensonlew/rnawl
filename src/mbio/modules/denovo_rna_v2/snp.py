...
class SnpModule(Module):
    ...
    def __init__(self, work_id):
        ...
        options = [
            {"name": "trinity_fa", "type": "infile", "format":"denovo_rna_v2.trinity_fasta"},
            # {"name": "bamlist", "type": "infile", "format": "denovo_rna_v2.bamlist"},
            {"name": "qual", "type": "int", "default": 20},
    ...
    def split_ref_run(self):
        ...
        for seq_record in SeqIO.parse(self.option("trinity_fa").prop['path'], "fasta"):
            if line <= line_limit:
        ...
        with open(fq_list) as f:
            for line in f:
                ...
                self.bwa.set_options({
                    "fq_list": line.strip(),
                    "trinity_fa": self.option('trinity_fa'),
                    "fq_type": fq_type,
                    "num": str(n)
                })
    ...
    def bcftools_vcf_run(self):
        ...
        self.bcftools_vcf.on("end", self.snpfinal_run)
    ...
    def snpfinal_run(self):
        ...
        self.snpfinal.set_options({
            "bamlist": sample_num,
            "call_vcf": self.bcftools_vcf.output_dir + "/pop.variant.vcf",
    ...
    def samtools_index(self):
        ...
        if os.path.exists(self.option("trinity_fa").prop['path'] + ".fai"):
            os.remove(self.option("trinity_fa").prop['path'] + ".fai")
        cmd_index = "samtools faidx {}".format(self.option("trinity_fa").prop['path'])
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "denovo_rna_v2.snp",
            "instant": False,
            "options": dict(
                trinity_fa="/mnt/ilustre/users/sanger-dev/workspace/20190416/Denovorna_tsg_33857/DenovoAssemble2/output/Trinity.filter.fasta",
                fq_list="/mnt/ilustre/users/sanger-dev/workspace/20190416/Denovorna_tsg_33857/HiseqQc/output/sickle_dir/fq_list1.txt",
                fq_type="PE",
                qual="20",
                dp="1"
