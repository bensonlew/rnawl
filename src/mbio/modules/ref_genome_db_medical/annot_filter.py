...
class AnnotFilterModule(Module):
    ...
    def __init__(self, work_id):
        ...
        self.nr_filter = self.add_tool("ref_genome_db_v2.annotation.filter_annot")
        self.swissprot_filter = self.add_tool("ref_genome_db_v2.annotation.filter_annot")
        self.eggnog_filter = self.add_tool("ref_genome_db_v2.annotation.filter_annot")
        self.kegg_filter = self.add_tool("ref_genome_db_v2.annotation.filter_annot")
        self.pfam_filter = self.add_tool("ref_genome_db_v2.annotation.filter_annot")
        self.go_filter = self.add_tool("ref_genome_db_v2.annotation.filter_annot")
        self.filter_tools = []
