...
class SentieonModule(Module):
    ...
    def __init__(self, work_id):
        super(SentieonModule, self).__init__(work_id)
        options = [
    ...
    def vcf_filter_run(self):
        ...
        self.vcffilter = self.add_tool('denovo_rna_v3.vcf_filter_gatk')
        options = {
            "ref_genome": "customer_mode",
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "denovo_rna_v3.sentieon",
            "instant": False,
            "options": dict(
                ref_fasta="/mnt/ilustre/users/sanger-dev/workspace/20191204/Denovorna_tsg_36374/DenovoAssemble2Filter/output/Trinity.filter.unigene.fasta",
                fq_list="/mnt/ilustre/users/sanger-dev/workspace/20191204/Denovorna_tsg_36374/FastpRna/output/fastq/fq_list.txt",
                fq_type="PE",
                cds_bed="/mnt/ilustre/users/sanger-dev/workspace/20191204/Denovorna_tsg_36374/AnnotOrfpfam/output/all_predicted.bed",
                allt2g="/mnt/ilustre/users/sanger-dev/workspace/20191204/Denovorna_tsg_36374/AnnotOrfpfam/output/all_tran2gen.txt",
                anno="/mnt/ilustre/users/sanger-dev/workspace/20191204/Denovorna_tsg_36374/AnnotClassBeta/output/all_annot.xls",
