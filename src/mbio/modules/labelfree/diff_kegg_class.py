...
class DiffKeggClassModule(Module):
    def __init__(self, work_id):
        ...
        options = [
            ...
            {'name': 'png_dir', 'type': 'infile', 'format': 'labelfree.common_dir'},
    ...
    def run_kegg_class(self, kegg_table, pathway_table, add_info):
        ...
        for diff in diff_files:
            ...
            if len(uplist + downlist) > 10:
                de_tool = self.add_tool("labelfree.proteinset.kegg_class")
                de_tool.set_options(options)
                self.tools.append(de_tool)
                up_down_tool = self.add_tool("labelfree.proteinset.kegg_class")
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "labelfree.diff_kegg_class",
            "instant": False,
            "options": dict(
