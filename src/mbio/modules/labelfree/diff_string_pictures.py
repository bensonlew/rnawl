...
class DiffStringPicturesModule(Module):
    ...
    def run_string_pictures(self):
        ...
        for diff in diff_files:
            ...
            de_tool = self.add_tool("labelfree.proteinset.fakefake")
        ...
        while 1:
            ...
            if p.status() == 'zombie':
                ...
                if (datetime.datetime.now() - begin).seconds > 60*10*len(files):
    ...
    def run(self):
        ...
        while 1:
            ...
            if not last_time:
                self.logger.info('now time is {}'.format(now_time))
            ...
            self.logger.info('last time is {}'.format(last_time))
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "module",
            "name": "labelfree.diff_string_pictures",
            "instant": False,
            "options": dict(
