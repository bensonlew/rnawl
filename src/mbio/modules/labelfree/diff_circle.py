...
class DiffCircleModule(Module):
    def __init__(self, work_id):
        ...
        options = [
            ...
            {'name': 'kegg_enrich_path', 'type': 'infile', 'format': 'labelfree.common_dir'},
            {'name': 'go_enrich_path', 'type': 'infile', 'format': 'labelfree.common_dir'},
        ]
    ...
    def run_circle(self):
        ...
        for diff in diff_files:
            ...
            if go_enrich_up_ and up_df.shape[0] > 10:
                ...
                go_up_tool = self.add_tool("labelfree.proteinset.enrich2circ")
            ...
            if go_enrich_down_ and down_df.shape[0] > 10:
                ...
                go_down_tool = self.add_tool("labelfree.proteinset.enrich2circ")
            ...
            if go_enrich_de_ and de_df.shape[0] > 10:
                ...
                go_de_tool = self.add_tool("labelfree.proteinset.enrich2circ")
            ...
            if kegg_enrich_up_ and up_df.shape[0] > 10:
                ...
                kegg_up_tool = self.add_tool("labelfree.proteinset.enrich2circ")
            ...
            if kegg_enrich_down_ and down_df.shape[0] > 10:
                ...
                kegg_down_tool = self.add_tool("labelfree.proteinset.enrich2circ")
            ...
            if kegg_enrich_de_ and de_df.shape[0] > 10:
                ...
                kegg_de_tool = self.add_tool("labelfree.proteinset.enrich2circ")
