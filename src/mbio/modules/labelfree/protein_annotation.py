...
class ProteinAnnotationModule(Module):
    ...
    def __init__(self, work_id):
        ...
        options = [
            ...
            {"name": "fa", "type": "infile", "format": "labelfree.common"},
            ...
            {"name": "des", "type": "infile", "format": "labelfree.common"},
        ...
        self.swissprot_annot = self.add_tool('labelfree.annotation.xml2table')
        self.eggnog_annot = self.add_tool('itraq_and_tmt.annotation.eggnog_annot')
        self.nr_annot = self.add_tool('labelfree.annotation.xml2table')
        self.ncbi_taxon = self.add_tool('labelfree.annotation.ncbi_taxon')
        self.go_annot = self.add_tool('labelfree.annotation.go_annotation')
        self.go_upload = self.add_tool('labelfree.annotation.go_upload')
        self.string_cog = self.add_tool('labelfree.annotation.string2cogv9')
        self.kegg_annot = self.add_tool('labelfree.annotation.kegg_annotation')
        self.swissprot_annot = self.add_tool("labelfree.annotation.swissprot")
        self.kegg_upload = self.add_tool('labelfree.annotation.kegg_upload')
        self.subloc = self.add_tool('labelfree.annotation.multiloc')
        self.anno_stat = self.add_tool('labelfree.annotation.ref_anno_stat')
        self.anno_query = self.add_tool('labelfree.annotation.ref_anno_query')
        self.step.add_steps('blast_statistics', 'nr_annot', 'ncbi_taxon', 'go_annot', 'go_upload', 'kegg_annot', 'kegg_upload', 'cog_annot', 'anno_stat', 'swissprot_annot', 'subloc', 'anno_query',  'eggnog_annot')
