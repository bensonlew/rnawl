...
class IsGeneDirTool(Tool):
    def __init__(self, config):
        ...
        self.python_script = self.config.PACKAGE_DIR + "/mobile_genetic_elements/is_gene_dir.py"
        self.genome = os.path.basename(self.option("genome_fa").prop['path'])
    ...
    def run_isfile(self):
        cmd = "{} {} --s {} --f {} --n {} --g {} --o {}".format(self.python, self.python_script, self.genome, self.gene_faa, self.gene_fna, self.gene_gff, self.output_dir)
