...
import json
import unittest
from mbio.packages.smallrna.enrich2circ import Enrich
...
class Enrich2circAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "fc_table", "type": "infile", "format": "smallrna.common"},
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        test_dir = '/mnt/ilustre/users/sanger-dev/sg-users/liubinxu/test_smallrna/data4'
        data = {
            "id": "enrich2circ" + str(random.randint(1, 10000)),
            "type": "tool",
            "name": "smallrna.proteinset.enrich2circ",
            "instant": True,
            "options": dict(
                enrich_type = "GO",
