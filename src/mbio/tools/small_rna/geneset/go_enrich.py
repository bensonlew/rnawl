...
class GoEnrichAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            dict(name="diff_list", type="infile", format="small_rna.gene_list"),
            dict(name="go_list", type="infile", format="small_rna.go_list"),
...
class GoEnrichTool(Tool):
    ...
    def run_draw_go_graph(self):
        try:
            ...
            self.logger.info('run_draw_go_graphhhhhhhhhhhhhhhh')
            if go_pvalue:
