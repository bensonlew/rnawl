...
class NovelMirnaTestAgent(Agent):
    """
    新miRNA预测
    """
    def __init__(self, parent):
        super(NovelMirnaTestAgent, self).__init__(parent)
        options = [
    ...
    def end(self):
        super(NovelMirnaTestAgent, self).end()


class NovelMirnaTestTool(Tool):
    def __init__(self, config):
        super(NovelMirnaTestTool, self).__init__(config)
    ...
    def run(self):
        ...
        :return:
        """
        super(NovelMirnaTestTool, self).run()
        self.get_mirna()
    ...
    def parse_mireap_results(self):
        ...
        cmd = "{}perl {}parse_mireap_result.pl -exp {} -aln {} -gff {} -config {} -o {}".format(
    ...
    def run_mireap(self):
        ...
        input_genome = self.option("input_genome").prop["path"]
        cmd = "perl {}mireap_test.pl -i {} -m {} -r {} -t Nov".format(self.mireap, os.path.join(self.work_dir, "filtered.fa"), map, input_genome)
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "tool",
            "name": "small_rna.srna.novel_mirna_test",
            "instant": False,
            "options": dict(
                species="ath",
                category="Plant",
                input_genome="/mnt/lustre/users/sanger/app/database/Genome_DB_finish/plants/Ipomoea_triloba/NSP323_V3/dna/NSP323_triloba_chr_v3.fa",
                input_fa="/mnt/lustre/users/sanger/workspace/20190517/Smallrna_sanger_179348/Srna/IntronStat/output/filtered.fa",
                config="/mnt/lustre/users/sanger/workspace/20190517/Smallrna_sanger_179348/MirnaQc/output/clean_data/qc_file.config",
                mapping_arf="/mnt/lustre/users/sanger/workspace/20190517/Smallrna_sanger_179348/MapperAndStat__1/output/reads_vs_genome.arf",
                mrd="/mnt/lustre/users/sanger/workspace/20190517/Smallrna_sanger_179348/Srna/KnownMirna/output/miRBase.mrd",
                known_miRNA_express="/mnt/lustre/users/sanger/workspace/20190517/Smallrna_sanger_179348/Srna/KnownMirna/miRNAs_expressed_all_samples_total.csv",
                clean_fa="/mnt/lustre/users/sanger/workspace/20190517/Smallrna_sanger_179348/FastaUniq__1/output/uniq.fasta",
