...
class AtcgBiasAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {'name': 'known', 'type': 'string', 'default': '/mnt/ilustre/users/sanger-dev/workspace/20181105/Single_srna13-27-16/Srna/KnownMirna/output/known_mirna.fa'},
            {'name': 'novel', 'type': 'string', 'default': '/mnt/ilustre/users/sanger-dev/workspace/20181105/Single_srna13-27-16/Srna/NovelMirna/output/novel_mirna.fa'},
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            "id": "AtcgBias" + datetime.datetime.now().strftime('%H-%M-%S'),
            "type": "tool",
            "name": "small_rna.atcg_bias",
            "instant": False,
            "options": dict(
                known="/mnt/ilustre/users/sanger-dev/workspace/20181105/Single_srna13-27-16/Srna/KnownMirna/output/known_mirna.fa",
                novel="/mnt/ilustre/users/sanger-dev/workspace/20181105/Single_srna13-27-16/Srna/NovelMirna/output/novel_mirna.fa",
                # min="18",
                # max="32",
            )
           }
