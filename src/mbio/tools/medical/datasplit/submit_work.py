...
class SubmitWorkAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "failed_to_stop", "type": "string", "default": "false"}
        ]
...
class SubmitWorkTool(Tool):
    ...
    def submit_task(self):
        ...
        task = Submit(self, self.option('api_name'), json.loads(self.option('params')), 'sanger')
...
class Submit(object):
    ...
    def check_status(self, id_, collection):
        ...
        stat = ""
        while True:
            status = self.bind_object.api.api("medical.paternity_test_v2").check_end(id_, collection)
