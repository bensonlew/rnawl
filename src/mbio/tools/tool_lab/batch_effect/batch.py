...
class BatchTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'combat': os.path.join(self.config.PACKAGE_DIR, 'tool_lab/batch/combat.r'),
            'removebtacheffect': os.path.join(self.config.PACKAGE_DIR, 'tool_lab/batch/removebatcheffect.r')
        }
        self.file = {
