...
class GsvaAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {'name': 'gmx', 'type': 'infile', 'format': 'ref_rna_v2.common'},
...
class GsvaTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'gsva': os.path.join(self.config.PACKAGE_DIR, 'tool_lab/gsva.r')
        }
        self.file = {
            ...
            'biomart_mus': os.path.join(self.config.SOFTWARE_DIR,
                                        'database/Genome_DB_finish/vertebrates/Mus_musculus/GRCm38_Ensembl_96/biomart/biomart.txt'),
            'biomart_hsa': os.path.join(self.config.SOFTWARE_DIR,
                                        'database/Genome_DB_finish/vertebrates/Homo_sapiens/GRCh38_Ensembl_96/biomart/biomart.txt'),
            'biomart_rno': os.path.join(self.config.SOFTWARE_DIR,
                                        'database/Genome_DB_finish/vertebrates/Rattus_norvegicus/Rnor_6.0_Ensembl_96/biomart/biomart.txt'),
