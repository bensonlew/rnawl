...
class DiffexpBatchAgent(Agent):
    ...
    def check_options(self):
        if self.option("method").lower() not in ["degseq", "edger", "deseq2", 'limma', 'svaseqlimma']:
...
class DiffexpBatchTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.diff_toolbox = self.config.PACKAGE_DIR + "/tool_lab/Additive_model/diff_toolbox_batch.py"
