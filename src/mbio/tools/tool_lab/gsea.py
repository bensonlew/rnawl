...
class GseaTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.file = {
            ...
            'biomart_rno': os.path.join(self.config.SOFTWARE_DIR,'database/Genome_DB_finish/vertebrates/Rattus_norvegicus/Rnor_6.0_Ensembl_96/biomart/biomart.txt'),

            # 'output': os.path.join(self)
    ...
    def id2id(self):
        cmd = '{} {} -i {}'.format(self.program['Rscript'], self.script['id2id'], self.file['json'])
        cmd_name = 'id2id'
    ...
    def gsea_analysis(self, exp_path, cls_path, gmt, chip=None):
        ...
        cmd_list = [
            ...
            '-cp {cp} -Xmx10240m xtools.gsea.Gsea '.format(cp=os.path.join(self.gsea_dir, 'gsea-3.0.jar')),
    ...
    def get_gene_expmatrix(self):
        exp_df = pd.read_table(self.option('matrix').path, header=0, index_col=0)
    ...
    def run(self):
        ...
        self.biomart_dict()
        self.matrix2gsea()
        exp_path = self.file['matrix2gsea']
        gene_detail = self.gene_detail()
        # exp_path = os.path.join(self.work_dir, 'GSEA.txt')
        ...
        def test(self):
            ...
            data = {
                ...
                "options": dict(
                    ...
                    group=json.dumps({'NC_4h': ["NC_4h_a", "NC_4h_b"], 'shRNA1': ["shRNA1_a", "shRNA1_b"]}),
                    g1='NC_4h',
                    g2='shRNA1',
