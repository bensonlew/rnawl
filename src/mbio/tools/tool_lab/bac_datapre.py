...
class BacDatapreAgent(Agent):
    def __init__(self, parent):
        super(BacDatapreAgent, self).__init__(parent)
        options = [
    ...
    def end(self):
        super(BacDatapreAgent, self).end()

class BacDatapreTool(Tool):
    def __init__(self, config):
        super(BacDatapreTool, self).__init__(config)
        self.all_fasta_dir = "/mnt/ilustre/users/sanger-dev/junjian/fasta"

    def run(self):
        super(BacDatapreTool,self).run()
        self.download_file()
        self.get_fasta_dir()
        self.set_output()
        self.end()
