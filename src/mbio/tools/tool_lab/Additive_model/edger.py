...
class EdgerTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'edger': os.path.join(self.config.PACKAGE_DIR, 'tool_lab/Additive_model/edger.r')
        }
        self.file = {
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            'type': 'tool',
            'name': 'tool_lab.Additive_model.edger',
            'instant': False,
            'options': {
                'count_matrix': '/mnt/ilustre/users/sanger-dev/workspace/20200323/Single_combatseq_5633_4631/Combatseq/output/count_combat_seq.txt',
