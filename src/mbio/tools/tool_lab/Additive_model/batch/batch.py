...
class BatchTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'combat': os.path.join(self.config.PACKAGE_DIR, 'tool_lab/Additive_model/batch/combat.r'),
            'removebtacheffect': os.path.join(self.config.PACKAGE_DIR, 'tool_lab/Additive_model/batch/removebatcheffect.r')
        }
        self.file = {
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            'type': 'tool',
            'name': 'tool_lab.Additive_model.batch.batch',
            'instant': False,
            'options': {
                'count_matrix': '/mnt/ilustre/users/sanger-dev/sg-users/zoujiaxun/cpm_count_raw.txt',
