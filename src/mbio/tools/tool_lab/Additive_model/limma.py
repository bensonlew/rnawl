...
class LimmaAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        NORM_METHOD = ('quantile', 'calcNormFactors', 'cal_voom', 'cal_voomqualityweight', 'voom_vst')
        options = [
            ...
            {'name': 'norm_method', 'type': 'string', 'default': NORM_METHOD[2]},
            {'name': 'trend', 'type': 'bool', 'default': False},
            {'name': 'robust', 'type': 'bool', 'default': False},
        ]
...
class LimmaTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'limma': os.path.join(self.config.PACKAGE_DIR, 'tool_lab/Additive_model/limma.r')
        }
        self.file = {
    ...
    def pre_limma(self):
        ...
        json.dump({
            ...
            'trend': self.option('trend'),
            'robust': self.option('robust'),
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            'type': 'tool',
            'name': 'tool_lab.Additive_model.limma',
            'instant': False,
            'options': {
                'count_matrix': '/mnt/ilustre/users/sanger-dev/workspace/20200109/Longrna_tsg_36788/DiffExp/Deseq2/count.txt',
                'group_table': '/mnt/ilustre/users/sanger-dev/workspace/20200109/Longrna_tsg_36788/DiffExp/Deseq2/group.txt',
                'control_table': '/mnt/ilustre/users/sanger-dev/workspace/20200109/Longrna_tsg_36788/DiffExp/Deseq2/contrast.txt',
                #'norm_method': 'quantile',
                'batch': True,
                'batch_matrix':'/mnt/ilustre/users/sanger-dev/workspace/20200109/Longrna_tsg_36788/DiffExp/Deseq2/batch.txt',
