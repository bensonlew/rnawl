...
class SsrMisaAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {"name": "scafseq_file", "type": "infile", "format": "sequence.fasta"},  # scafSeq文件
    ...
    def check_options(self):
        if not self.option("scafseq_file").is_set:
...
class SsrMisaTool(Tool):
    ...
    def run_misa(self):
        ...
        scafseq_path = self.work_dir + "/" + os.path.basename(self.option("scafseq_file").prop["path"])
        self.checklink(scafseq_path)
        os.link(self.option("scafseq_file").prop["path"], scafseq_path)
        ...
        self.checklink(os.path.join(self.output_dir, os.path.basename(self.option("scafseq_file").prop["path"])))
        os.link(self.option("scafseq_file").prop["path"], os.path.join(self.output_dir, os.path.basename(self.option("scafseq_file").prop["path"])))
