...
class MetabVipAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "metab_set_table", "type": "infile", "format": "sequence.profile_table"}, # 为可选参数
            ...
            {'name': 'group_method', 'type': 'string', 'default': 'none'},  # 分组计算方法 none/median/average/sum
            ...
            {'name': 'mcd', 'type': 'string', 'default': ''},  # 代谢物距离计算方式 ['braycurtis','canberra','chebyshev','cityblock','cosine','dice','euclidean','hamming','jaccard','kulsinski','mahalanobis','matching','minkowski','rogerstanimoto','russellrao','seuclidean','sokalmichener','sokalsneath','sqeuclidean','yule',]
...
class MetabVipTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.script = self.config.PACKAGE_DIR + "/tool_lab/clustervip.py"
