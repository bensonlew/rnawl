...
class Metastat2Agent(Agent):
    ...
    def __init__(self, parent):
        super(Metastat2Agent, self).__init__(parent)
        options = [
            ...
            {"name": "student_method", "type": "string", "default": "T"},  # 数据是否归一化
            ...
            {"name": "welch_method", "type": "string", "default": "T"},  # 数据是否归一化
            ...
            {"name": "anova_method", "type": "string", "default": "T"},  # 数据是否归一化
    ...
    def end(self):
        ...
        super(Metastat2Agent, self).end()


class Metastat2Tool(Tool):
    def __init__(self, config):
        super(Metastat2Tool, self).__init__(config)
    ...
    def run_est(self):    # modify by qindanhua 20170105 add option test method
        ...
        for group in gfilelist:
            ...
            two_group_test(self.option('est_input').prop['path'], os.path.join(self.option("est_group").prop['path'], group),
                           ...
                           self.option("est_test_method"), mul_test="fdr", norm="FF")
    ...
    def run_chi(self):
        ...
        two_sample_test(self.work_dir + "/tmp_mask_otu.xls", self.work_dir + '/chi_result.xls', "chi",
                        self.option('chi_sample1'), self.option('chi_sample2'), self.option('chi_correction'), self.option("cpu")-1)
    ...
    def run_fisher(self):
        ...
        two_sample_test(self.work_dir + '/tmp_mask_otu.xls', self.work_dir + '/fisher_result.xls', "fisher",
                        ...
                        self.option('fisher_correction'),self.option("cpu")-1)
    ...
    def run_student(self):
        ...
        if self.option('student_method') == "T":
            method = "T"
        else:
            method = "FF"
        two_group_test(self.work_dir + "/tmp_mask_otu.xls", './student_group',
                       ...
                       self.option('student_correction'),method)
        ...
        def success():
            ...
            group_bar_toollab(self.work_dir + '/tmp_mask_otu.xls', './student_group', self.work_dir + '/tmp_group_bar.xls', 'student', method)
    ...
    def run_welch(self):
        ...
        two_group_test(self.work_dir + "/tmp_mask_otu.xls", "./welch_group",
                       ...
                       self.option('welch_correction'),method)
        ...
        def success():
            ...
            self.logger.info("生成单物种柱状图的数据")
            group_bar_toollab(self.work_dir + '/tmp_mask_otu.xls', './welch_group', self.work_dir + '/tmp_group_bar.xls', 'welch', method)
    ...
    def run_anova(self):
        ...
        mul_group_test(self.work_dir + "/tmp_mask_otu.xls", self.work_dir + '/anova_result.xls',
                       ...
                       self.option('anova_correction'),self.option('anova_method'),self.option('anova_method'))
