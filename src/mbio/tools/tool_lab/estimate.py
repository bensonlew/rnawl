...
class EstimateAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {'name': 'estimate_score_gct', 'type': 'outfile', 'format': 'ref_rna_v2.common'},
            {'name': 'cluster_matrix', 'type': 'outfile', 'format': 'ref_rna_v2.common'}
...
class EstimateTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'estimate': os.path.join(self.config.PACKAGE_DIR, 'tool_lab/estimate.py'),
        }
        self.file = {
