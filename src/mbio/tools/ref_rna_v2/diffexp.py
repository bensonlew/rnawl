...
class DiffexpTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.diff_toolbox = self.config.PACKAGE_DIR + "/ref_rna_v2/diff_toolbox.py"
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "tool",
            "name": "ref_rna_v2.diffexp",
            "instant": False,
            "options": dict(
                count='/mnt/ilustre/users/sanger-dev/workspace/20200810/Refrna_tsg_38314/Quant/ref.gene.count.matrix',
                exp='/mnt/ilustre/users/sanger-dev/workspace/20200810/Refrna_tsg_38314/Quant/ref.gene.tpm.matrix',
                method="edgeR",
