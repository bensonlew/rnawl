...
class SplitFastaAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {'name': 'f', 'type': 'infile', 'default': '/mnt/ilustre/users/sanger-dev/sg-users/deqing/TestFiles/TF/all_pep.fa', 'format': 'sequence.fasta'},
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "instant": False,
            "options": dict(
                f="/mnt/ilustre/users/sanger-dev/sg-users/deqing/TestFiles/TF/all_pep.fa",
                size="1000",
                prefix="split",
            )
           }
