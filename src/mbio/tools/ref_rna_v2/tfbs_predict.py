...
class TfbsPredictAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {'name': 'gtfParser', 'type': 'string', 'default': '/mnt/ilustre/users/sanger-dev/sg-users/deqing/mbio/packages/transcription_factor/parseGTF.pl', 'format': 'None'},
            {'name': 'bedtools', 'type': 'string', 'default': '/mnt/ilustre/users/sanger-dev/app/bioinfo/seq/bedtools-2.25.0/bin/bedtools', 'format': 'None'},
            {'name': 'genes', 'type': 'string', 'default': 'None', 'format': 'None'},
            {'name': 'fimo', 'type': 'string', 'default': '/mnt/ilustre/users/sanger-dev/app/bioinfo/rna/meme_4.12.0/bin/fimo', 'format': 'None'},
            {'name': 'seqdb', 'type': 'string', 'default': 'None', 'format': 'string'},
            ...
            # {'name': 'db_type', 'type': 'string', 'default': 'jaspar', 'format': 'None'},
...
class TfbsPredictTool(Tool):
    ...
    def run_tfbs_predict(self):
        ...
        if self.option("tf_selected").lower() != "none" and self.option("tf_selected").lower() != "" :
            ...
            for g, tf in geneid_tfid:
                ...
                motif_db_jaspar = self.config.SOFTWARE_DIR + "/database/JASPAR2020/meme/"
                if self.option("motif_species_type") == "jaspar":
                    motif_path = motif_db_jaspar + '{}.meme'.format(tf)
        ...
        self.logger.info("seqdb is {}".format(self.option("seqdb")))
        if self.option("seqdb").lower() != "none":
