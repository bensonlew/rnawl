...
class SingleQuantTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.kallisto_path = software_dir + '/bioinfo/ref_rna_v3/kallisto/miniconda3/bin/'
        ...
        self.salmon_path = software_dir + '/bioinfo/ref_rna_v3/Salmon/miniconda3/bin/'
    ...
    def quant(self):
        ...
        out_dir = glob.glob(self.work_dir + "/*_quant")
        if out_dir and os.path.exists(out_dir[0]):
            shutil.rmtree(out_dir[0])
...
class TestFunction(unittest.TestCase):
    ...
    fastq = ';'.join(['WT_18M_1',
                      '/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/ref_rna_v2/software_update/quant/data/WT_18M_1.clean.1.fastq',
                      '/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/ref_rna_v2/software_update/quant/data/WT_18M_1.clean.2.fastq'])
    global data
    data = {
        'id': 'single_quant_new_{}_{}'.format(random.randint(1000, 9999), random.randint(1000, 9999)),
        'type': 'tool',
        ...
        'options': dict(
            ...
            transcriptome="/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/ref_rna_v2/software_update/quant/data/all_transcripts.fa",
            fastq=fastq,
            method='rsem',
            # t2g='/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/ref_rna_v2/rsem/t2g.pairs',
            t2g="/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/ref_rna_v2/software_update/quant/data/trans2gene",
            pool=1,
            thread=6,
            read_len=149,
            read_len_sd=30
