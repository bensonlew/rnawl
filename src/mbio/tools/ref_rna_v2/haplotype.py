...
class HaplotypeAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "sample_bam", "type": "infile", "format": "ref_rna_v2.common"},
    ...
    def test(self):
        ...
        data = {
            ...
            "options": dict(
                ...
                sample_bam="/mnt/ilustre/users/sanger-dev/workspace/20190722/Single_bam_realign7835/BamRealign/PicardRna/output/B2_1.bam",
                sample_id="B2_1",
                #call_type="gatk"
            )
        }
