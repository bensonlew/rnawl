...
class VcfFilterGatkAgent(Agent):
    """
    ...
    def __init__(self, parent):
        super(VcfFilterGatkAgent, self).__init__(parent)
        options = [
    ...
    def end(self):
        super(VcfFilterGatkAgent, self).end()


class VcfFilterGatkTool(Tool):
    """
    version 1.0
    """

    def __init__(self, config):
        super(VcfFilterGatkTool, self).__init__(config)
    ...
    def combine_vcf(self):
        ...
        cmd = '{}java -jar {}GenomeAnalysisTK.jar -R {} -T CombineVariants {} -o Combine_Variants.vcf -genotypeMergeOptions UNIQUIFY' \
    ...
    def combine_snp_indel(self):
        self.snp_vcf=os.path.join(self.output_dir,"pop.snp.filter.recode.vcf")
        self.indel_vcf = os.path.join(self.output_dir, "pop.indel.filter.recode.vcf")
        self.findel_vcf = os.path.join(self.output_dir, "final.pop.indel.filter.recode.vcf")
    ...
    def run(self):
        super(VcfFilterGatkTool, self).run()
        self.dict()
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            "id": "vcf_filter_gatk" + str(random.randint(1, 10000))+"-xxx",
            "type": "tool",
            "name": "ref_rna_v2.vcf_filter_gatk",
            "instant": False,
            "options": dict(
                ...
                # corr_method='pearson',
                #output=None,
                ref_fasta="/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/plants/Arabidopsis_thaliana/TAIR10_Ensembl_43/dna/Arabidopsis_thaliana.TAIR10.dna.toplevel.fa",
                ...
                input_file="/mnt/ilustre/users/sanger-dev/workspace/20190708/Snp_tsg_34767_2852_5522/CallSnpIndel/GvcfTypingV2/output/pop.variant.vcf"
