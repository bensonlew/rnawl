...
class Xml2tableAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "blast_table", "type": "outfile", "format": "align.blast.blast_table"},
        ]
...
class TestFunction(unittest.TestCase):
    def test(self):
        ...
        data = {
            'id': 'Xml2table_{}_{}'.format(random.randint(1000, 9999), random.randint(1000, 9999)),
            'type': 'tool',
            'name': 'small_rna_v2.srna.xml2table',
            'instant': False,
            'options': dict(
                blastout="/mnt/lustre/users/sanger/workspace/20210204/Single_BlastRfam6633/Blast/output/primer_vs_nt.xml",
            )
        }
