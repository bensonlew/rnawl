...
class MultilocAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {'type': 'outfile', 'name': 'output', 'format': 'labelfree.common'},
            {'type': 'string', 'name': 'species', 'default': 'Animals'},
            {'type': 'infile', 'name': 'fa', 'format': 'labelfree.common'},
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        test_dir='/mnt/ilustre/users/sanger-dev/workspace/20190624/Labelfree_tsg_34554'
        data = {
            "id": "Multiloc" + str(random.randint(1, 10000)),
            "type": "tool",
            "name": "labelfree.annotation.multiloc",
            "instant": True,
            "options": dict(
                fa=test_dir + "/" + "remote_input/protein_fasta/exp.fasta",
                species="Bacteria",
            )
        }
