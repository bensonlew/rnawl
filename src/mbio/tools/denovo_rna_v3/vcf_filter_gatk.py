...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "tool",
            "name": "ref_rna_v3.snp.vcf_filter_gatk",
            "instant": False,
            "options": dict(
                ...
                # corr_method='pearson',
                #output=None,
                ref_fasta="/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/test/test0804/data/Trinity.filter.unigene.fasta",
                ...
                input_file="/mnt/ilustre/users/sanger-dev/sg-users/fuwenyao/test/test0804/data/pop.variant.vcf"
