...
class ExpVennAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            dict(name="express_matrix", type="infile", format="medical_transcriptome.express_matrix"),
            # 没有重复实验时，可以用样本名作为组名。
    ...
    def check_options(self):
        try:
            ...
            if threshold <= 0:
                raise OptionError('threshold必须大于0', code="33704904")
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "tool",
            "name": "medical_transcriptome.exp_venn",
            "instant": True,
            "options": {
                'express_matrix':'/mnt/ilustre/users/sanger-dev/workspace/20200810/Refrna_tsg_38312/Quant/gene.count.matrix',
                'group_table':'/mnt/ilustre/users/sanger-dev/workspace/20200810/Refrna_tsg_38312/remote_input/group_table/group.txt',
