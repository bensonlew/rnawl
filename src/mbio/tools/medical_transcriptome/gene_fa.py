...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            'type': 'tool',
            'name': 'medical_transcriptome.gene_fa',
            'instant': False,
            'options': {
                'ref_new_gtf':'/mnt/ilustre/users/sanger-dev/workspace/20200810/Refrna_tsg_38314/RefrnaAssemble/output/NewTranscripts/ref_and_new.gtf',
