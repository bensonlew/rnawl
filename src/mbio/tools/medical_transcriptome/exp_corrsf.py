...
class ExpCorrsfAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {'name': 'exp', 'type': 'infile', 'format': 'medical_transcriptome.express_matrix'},
...
class ExpCorrsfTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.ExpCorrsf_toolbox = self.config.PACKAGE_DIR + '/medical_transcriptome/exp_corrsf.py'
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "tool",
            "name": "medical_transcriptome.exp_corrsf",
            "instant": False,
            "options": dict(
                exp="/mnt/ilustre/users/sanger-dev/sg-users/zhangyitong/corrsf_test.matrix",
