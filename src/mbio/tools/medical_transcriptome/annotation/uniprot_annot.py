...
class UniprotAnnotTool(Tool):
    def __init__(self, config):
        ...
        self.get_venn_list_py = os.path.join(self.config.PACKAGE_DIR, 'medical_transcriptome/annotation/get_venn_list.py')
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            'type': 'tool',
            'name': 'ref_rna_v2.annotation.uniprot_annot',
            'instant': False,
            'options': {
                'blast_xml': '/mnt/ilustre/users/sanger-dev/workspace/20190413/LncRna_tsg_33844/AnnotFilter/output/uniprot/blast.filter.xml',
