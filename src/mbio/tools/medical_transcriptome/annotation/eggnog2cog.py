...
class Eggnog2cogAgent(Agent):
    """
    convert Eggnog to cog
    """
    def __init__(self, parent):
        super(Eggnog2cogAgent, self).__init__(parent)
        options = [
    ...
    def check_options(self):
        if self.option('blasttable') == "":
            raise OptionError("必须提供BLAST结果文件", code = "33700901")
        pass
    ...
    def end(self):
        ...
        """
        super(Eggnog2cogAgent, self).end()


class Eggnog2cogTool(Tool):
    """
    convert Eggnog to cog
    """
    ...
    def run_mg_cog_mongo(self):
        ...
        if command.return_code == 0:
            ...
            if command.return_code is 0:
                ...
                self.set_error("%s Failed. >>>%s", variables = (cmd_name, cmd), code = "33700902")
        else:
            self.set_error("%s Failed. >>>%s", variables = (cmd_name, cmd), code = "33700903")
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "tool",
            "name": "ref_rna_v2.annotation.eggnog2cog",
            "instant": False,
            "options": dict(
