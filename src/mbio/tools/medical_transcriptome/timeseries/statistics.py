...
class StatisticsAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {'name': 'genetable', 'type': 'infile', 'format': 'medical_transcriptome.common'},
            {'name': 'profiletable', 'type': 'infile', 'format': 'medical_transcriptome.common'},
            {'name': 'kmeansclustertable', 'type': 'infile', 'format': 'medical_transcriptome.common'},
            {'name': 'matrix', 'type': 'infile', 'format': 'medical_transcriptome.common'},
            {'name': 'detailtable', 'type': 'outfile', 'format': 'medical_transcriptome.common'},
            {'name': 'clustertable', 'type': 'outfile', 'format': 'medical_transcriptome.common'},
        ]
...
class StatisticsTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'statistics': os.path.join(self.config.PACKAGE_DIR, 'medical_transcriptome/timeseries/statistics.py'),
        }
        self.file = {
