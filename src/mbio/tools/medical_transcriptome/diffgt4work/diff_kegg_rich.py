...
class DiffKeggRichAgent(Agent):
    ...
    def __init__(self, parent):
        super(DiffKeggRichAgent, self).__init__(parent)
        options = [
    ...
    def check_options(self):
        ...
        self.logger.info('{} = {}'.format("kegg_table2", self.option("kegg_table2")))
        return True
    ...
    def end(self):
        ...
        super(DiffKeggRichAgent, self).end()


class DiffKeggRichTool(Tool):
    def __init__(self, config):
        super(DiffKeggRichTool, self).__init__(config)
        ...
        self.brite = self.config.SOFTWARE_DIR +"/database/Annotation/all/KEGG/version_202007/br08901.keg"
    ...
    def run(self):
        ...
        :return:
        """
        super(DiffKeggRichTool, self).run()
    ...
    def run_kegg_rich(self):
        ...
        try:
            ...
            self.option("kegg_table").get_gene2path(self.work_dir, self.option("kegg_table2"))
