...
class DiffReactomeClassAgent(Agent):
    """
    ...
    def __init__(self, parent):
        super(DiffReactomeClassAgent, self).__init__(parent)
        options = [
    ...
    def end(self):
        super(DiffReactomeClassAgent, self).end()


class DiffReactomeClassTool(Tool):
    ...
    def run(self):
        ...
        :return:
        """
        super(DiffReactomeClassTool, self).run()
        ...
        # 删除通路有互相嵌套的问题
        # self.complex_child = self.get_path_content(self.complex_child)
    ...
    def get_pics(self):
        ...
        with open(self.work_dir + "/complex_child", 'w') as f:
            f.write(str(self.complex_child))
