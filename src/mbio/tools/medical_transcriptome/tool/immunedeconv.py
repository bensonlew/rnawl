...
class ImmunedeconvAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {'name': 'immu', 'type': 'outfile', 'format': 'medical_transcriptome.common'},
...
class ImmunedeconvTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'immu': os.path.join(self.config.PACKAGE_DIR, 'medical_transcriptome/Immunedeconv.r'),
            'cibersort': os.path.join(self.config.PACKAGE_DIR, 'medical_transcriptome/CIBERSORT.r')
        ...
        self.file = {
            ...
            'LM22': os.path.join(self.config.PACKAGE_DIR, 'medical_transcriptome/LM22.txt'),
            'genes': os.path.join(self.config.PACKAGE_DIR, 'medical_transcriptome/genes.txt'),
            'probesets': os.path.join(self.config.PACKAGE_DIR, 'medical_transcriptome/probesets.txt')
        }
