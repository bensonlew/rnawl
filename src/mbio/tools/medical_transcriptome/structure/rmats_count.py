...
class RmatsCountAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {'name': 'jcpklist', 'type': 'infile', 'format': 'ref_rna_v3.common'},
            {'name': 'jcecpklist', 'type': 'infile', 'format': 'ref_rna_v3.common'},
            {'name': 'ojc', 'type': 'outfile', 'format': 'ref_rna_v3.common'},
            {'name': 'ojcec', 'type': 'outfile', 'format': 'ref_rna_v3.common'}
        ]
