...
class DoEnrichAgent(Agent):
    '''
    last_modify: 2020.08.25
    '''
    def __init__(self, parent):
        super(DoEnrichAgent, self).__init__(parent)
        options = [
    ...
    @toolfuncdeco
    def end(self):
        super(DoEnrichAgent, self).end()

class DoEnrichTool(Tool):
    def __init__(self, config):
        super(DoEnrichTool, self).__init__(config)
        self.program = {
