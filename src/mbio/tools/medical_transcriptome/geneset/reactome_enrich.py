...
class ReactomeEnrichAgent(Agent):
    '''
    last_modify: 2020.08.25
    '''
    def __init__(self, parent):
        super(ReactomeEnrichAgent, self).__init__(parent)
        options = [
    ...
    @toolfuncdeco
    def end(self):
        super(ReactomeEnrichAgent, self).end()

class ReactomeEnrichTool(Tool):
    def __init__(self, config):
        super(ReactomeEnrichTool, self).__init__(config)
        self.program = {
    ...
    @toolfuncdeco
    def run(self):
        super(ReactomeEnrichTool, self).run()
