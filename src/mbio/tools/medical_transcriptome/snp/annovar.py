    ...
    def test(self):
        ...
        data = {
            ...
            "options": dict(
                ...
                ref_fasta = "/mnt/ilustre/users/sanger-dev/workspace/20200622/Refrna_tsg_37805/CallSnpIndelSentieon/total.fa",
                ref_gtf ="/mnt/ilustre/users/sanger-dev/workspace/20200622/Refrna_tsg_37805/RefrnaAssemble/output/NewTranscripts/ref_and_new.gtf",
                ref_genome="customer_mode",
                combine_vcf=False,
                des="/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/plants/Vitis_vinifera/12X_V2/biomart/biomart",
                des_type="type2",
                input_file="/mnt/ilustre/users/sanger-dev/workspace/20200622/Refrna_tsg_37805/CallSnpIndelSentieon/VcfFilterGatk/output/final.vcf"
            )
           }
