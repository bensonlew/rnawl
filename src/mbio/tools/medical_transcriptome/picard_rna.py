...
class PicardRnaAgent(Agent):
    ...
    def check_options(self):
        ...
        if not self.option("in_bam").is_set:
            raise OptionError("请输入用于分析的sam文件！", code = "32201401")
...
class PicardRnaTool(Tool):
    ...
    def addorreplacereadgroups(self):
        ...
        if command.return_code == 0:
            ...
            if command.return_code == 0:
                ...
                self.set_error("sam文件addorreplacereadgroups出错！",  code = "32201402")
    ...
    def markduplicates(self, add_sorted_bam):
        ...
        if command.return_code == 0:
            ...
            self.set_error("bam文件MarkDuplicates出错！", code = "32201403")
