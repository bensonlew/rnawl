...
import time
import json
from mbio.packages.labelfree.kegg_regulate import KeggRegulate
# from mbio.packages.rna.kegg_html import KeggHtml
from mbio.packages.protein_transcript_labelfree.kegg_html import KeggHtml
...
class KeggClassTool(Tool):
    def __init__(self, config):
        ...
        self.map_re = self.config.PACKAGE_DIR + "/protein_transcript_labelfree/map4.r"
        ...
        with open(self.option("gene_kegg_table")) as gr:
            ...
            for line in gr:
                if line.strip():
                    ...
                    if line[1] not in self.k2g:
                        self.k2g[line[1]] = set()
                    self.k2g[line[1]].add(line[0])
    ...
    def get_kegg_pics(self):
        ...
        self.mongo_db = Config().get_mongo_client(mtype="labelfree")[Config().get_mongo_dbname("labelfree")]
    ...
    def get_kegg_png(self):
        ...
        if kegg_created_ts < "2021-08-05 10:00:49":
