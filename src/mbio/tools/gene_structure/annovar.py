...
class AnnovarAgent(Agent):
    ...
    def check_options(self):
        ...
        if not self.option("input_file").is_set:
            raise OptionError("请输入VCF格式文件", code="32200102")
...
class AnnovarTool(Tool):
    ...
    def dict(self):
        ...
        if command.return_code == 0:
            ...
            self.set_error("构建dict过程error！", code="32200110")
            self.set_error("构建dict过程error！", code="32200111")
    ...
    def combine_vcf(self):
        ...
        if command.return_code == 0:
            ...
            self.set_error("运行combine_variants出错", code="32200112")
    ...
    def gtf_to_genepred(self):
        ...
        if command.return_code == 0:
            ...
            self.set_error("运行gtfToGenePred出错！", code="32200113")
            self.set_error("运行gtfToGenePred出错！", code="32200114")
    ...
    def retrieve_seq_from_fasta(self):
        ...
        if command.return_code == 0 or None:
            ...
            self.set_error("运行retrieve_seq_from_fasta出错！", code="32200115")
            self.set_error("运行retrieve_seq_from_fasta出错！", code="32200116")
    ...
    def annotate_variation(self):
        ...
        if command.return_code == 0:
            ...
            self.set_error("运行annotate_variation出错！", code="32200117")
            self.set_error("运行annotate_variation出错！", code="32200118")
