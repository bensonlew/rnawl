...
class RpkmSaturationAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {"name": "be", "type": "infile", "format": "gene_structure.bed"},  # bed格式文件
            ...
            {"name": "rpkm_cutof", "type": "float", "default": 0.01}  #  Transcripts with RPKM smaller than this number will be ignoredd
        ]
