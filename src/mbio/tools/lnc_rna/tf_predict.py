...
class TfPredictAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {'name': 'hmmscan', 'type': 'string', 'default': '/mnt/ilustre/users/isanger/sg-users/litangjian/hmm/hmmer-3.1b2-linux-intel-x86_64/binaries/hmmscan', 'format': 'None'},
            {'name': 'hmmdb', 'type': 'string', 'default': '/mnt/ilustre/users/isanger/app/database/pfam_31/Pfam-A.hmm', 'format': 'None'},
            {'name': 'seqfile', 'type': 'infile', 'default': '/mnt/ilustre/users/isanger/sg-users/deqing/TestFiles/TF/example.fa', 'format': 'sequence.fasta'},
            ...
            {'name': 'tfdb', 'type': 'string', 'default': '/mnt/ilustre/users/isanger/app/database/TFDB/', 'format': 'None'},
            {'name': 'diamond', 'type': 'string', 'default': '/mnt/ilustre/users/isanger/app/bioinfo/align/diamond-0.8.35/diamond', 'format': 'None'},
    ...
    def check_options(self):
        if float(self.option('E')) == 0:
            raise OptionError('The E value is too low', code = "33708201")
    ...
    def run_tf_predict(self):
        ...
        if command.return_code == 0:
            ...
            if command.return_code is 0:
                ...
                self.set_error("%s Failed. >>>%s", variables = (cmd_name, cmd), code = "33708202")
        else:
            self.set_error("%s Failed. >>>%s", variables = (cmd_name, cmd), code = "33708203")
    ...
    def test(self):
        ...
        data = {
            ...
            "options": dict(
                ...
                organism="unknown",
                blast_all="yes",
                hmmscan="/mnt/ilustre/users/isanger/sg-users/litangjian/hmm/hmmer-3.1b2-linux-intel-x86_64/binaries/hmmscan",
                hmmdb="/mnt/ilustre/users/isanger/app/database/pfam_31/Pfam-A.hmm",
                seqfile="/mnt/ilustre/users/isanger/sg-users/deqing/TestFiles/TF/example.fa",
                E="0.001",
                domE="0.0001",
                cpu="12",
                tfdb="/mnt/ilustre/users/isanger/app/database/TFDB/",
                diamond="/mnt/ilustre/users/isanger/app/bioinfo/align/diamond-0.8.35/diamond",
                evalue="0.0001",
            )
           }
