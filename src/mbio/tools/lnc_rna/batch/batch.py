...
class BatchAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {'name': 'count_matrix', 'type': 'infile', 'format': 'lnc_rna.common'},
...
class BatchTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'combat': os.path.join(self.config.PACKAGE_DIR, 'lnc_rna/batch/combat.r'),
            'removebtacheffect': os.path.join(self.config.PACKAGE_DIR, 'lnc_rna/batch/removebatcheffect.r')
        }
        self.file = {
