...
class PpinetworkMapblastAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {"name": "fa", "type": "infile", "format": "lnc_rna.fasta"},  # 输入文件
            ...
            {"name": "outtable", "type": "outfile", "format": "lnc_rna.common"},  # 输出格式为6时输出
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        test_dir = '/mnt/ilustre/users/sanger-dev/sg-users/liubinxu/test_lnc_rna/data4'
        data = {
            "id": "mapblast" + str(random.randint(1, 10000)),
            "type": "tool",
            "name": "lnc_rna.geneset.ppinetwork_mapblast",
            "instant": True,
            "options": dict(
