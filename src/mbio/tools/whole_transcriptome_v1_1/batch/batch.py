...
class BatchTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'combat': os.path.join(self.config.PACKAGE_DIR, 'whole_transcriptome_v1_1/batch/combat.r'),
            'removebtacheffect': os.path.join(self.config.PACKAGE_DIR, 'whole_transcriptome_v1_1/batch/removebatcheffect.r')
        }
        self.file = {
