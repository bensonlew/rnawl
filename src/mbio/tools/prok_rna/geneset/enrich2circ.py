...
import json
import unittest
from mbio.packages.prok_rna.enrich2circ import Enrich
...
class Enrich2circAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "enrich_table", "type": "infile", "format": "prok_rna.common"},
            ...
            {"name": "fc_table", "type": "infile", "format": "prok_rna.common"}
        ]
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        test_dir = '/mnt/ilustre/users/sanger-dev/sg-users/liubinxu/test_prok_rna/data4'
        data = {
            "id": "enrich2circ" + str(random.randint(1, 10000)),
            "type": "tool",
            "name": "prok_rna.geneset.enrich2circ",
            "instant": True,
            "options": dict(
                enrich_type = "GO",
