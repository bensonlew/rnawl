...
class AnnotPrepareTool(Tool):
    ...
    def go_list_prepare(self):
        ...
        self.file_path["go_version"] = go_version
    ...
    def export_go_list(self):
        ...
        raw_go_list_path = os.path.join(self.option("annot_result"),"go","GO.list")
    ...
    def export_kegg_table(self):
        ...
        raw_kegg_path = os.path.join(self.option("annot_result"), "kegg", "kegg_table.xls")
    ...
    def export_kegg_level_table(self):
        ...
        raw_kegg_level_path = os.path.join(self.option("annot_result"), "kegg", "pathway_table.xls")
