...
class BcftoolVcfAgent(Agent):
    ...
    def check_options(self):
        if not self.option("vcf_list"):
            raise OptionError("缺少vcf_list参数")
...
class BcftoolVcfTool(Tool):
    ...
    def bcftools_concat(self):
        ...
        if command1.return_code == 0:
            ...
            self.set_error("bcftools_concat出错", code = "35002302")
    ...
    def bcftools_annotate(self):
        ...
        if command2.return_code == 0:
            ...
            self.set_error("bcftools_annotate出错", code = "35002303")
            raise Exception("bcftools_annotate出错", code = "35002305")
    ...
    def bcftools_sort(self):
        ...
        if command3.return_code == 0:
            ...
            self.set_error("bcftools_sort出错", code = "35002304")
