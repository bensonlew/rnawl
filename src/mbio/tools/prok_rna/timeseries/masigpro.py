...
class MasigproTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'pretreat': os.path.join(self.config.PACKAGE_DIR, 'ref_rna_v3/timeseries/pretreat.py'),
            'masigpro': os.path.join(self.config.PACKAGE_DIR, 'ref_rna_v3/timeseries/masigpro.r'),
            'heatmap.py': os.path.join(self.config.PACKAGE_DIR, 'ref_rna_v3/timeseries/heatmap.py'),
            'heatmap.r': os.path.join(self.config.PACKAGE_DIR, 'ref_rna_v3/timeseries/heatmap.r')
        }
        self.file = {
