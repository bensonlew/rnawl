...
class ExpVennAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            dict(name="express_matrix", type="infile", format="prok_rna.express_matrix"),
            # 没有重复实验时，可以用样本名作为组名。
            dict(name="group_table", type="infile", format="sample.group_table"),
    ...
    def check_options(self):
        try:
            ...
            raise OptionError("无法将threshold的转换为数值，请检查输入", code = "35003001")
        else:
            if threshold < 0:
                raise OptionError("threshold必须大于等于0", code = "35003002")
