...
class BlastFilterAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {"name": "blast", "type": "infile", "format": "prok_rna.blast_xml"},
            {"name": "hmm", "type": "infile", "format": "prok_rna.common"},
            ...
            {"name": "outtable", "type": "outfile", "format": "prok_rna.common"},  # 输出格式为6时输出
        ]
