...
class Nr2goAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "blastout_go", "type": "outfile", "format": "prok_rna.blast_xml"},
            {"name": "blast2go_annot", "type": "outfile", "format": "prok_rna.blast2go_annot"},
    ...
    def check_options(self):
        if self.option("blastout").is_set:
            ...
            raise OptionError("必须提供BLAST结果文件", code = "35001401")
...
class Nr2goTool(Tool):
    ...
    def nr2go(self):
        ...
        if command.return_code == 0:
            ...
            self.set_error("运行nr2go出错", code = "35001402")
