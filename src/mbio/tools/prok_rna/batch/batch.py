...
class BatchAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {'name': 'count_matrix', 'type': 'infile', 'format': 'prok_rna.common'},
...
class BatchTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'combat': os.path.join(self.config.PACKAGE_DIR, 'prok_rna/batch/combat.r'),
            'removebtacheffect': os.path.join(self.config.PACKAGE_DIR, 'prok_rna/batch/removebatcheffect.r')
        }
        self.file = {
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            'instant': False,
            'options': {
                'count_matrix': '/mnt/ilustre/users/sanger-dev/sg-users/zoujiaxun/MJ20181022108-刘树林-内蒙古农业大学-有参转录组-72个样本/count.txt',
                'group_table': '/mnt/ilustre/users/sanger-dev/sg-users/zoujiaxun/MJ20181022108-刘树林-内蒙古农业大学-有参转录组-72个样本/group_table.txt',
                'batch_matrix': '/mnt/ilustre/users/sanger-dev/sg-users/zoujiaxun/MJ20181022108-刘树林-内蒙古农业大学-有参转录组-72个样本/batch_old.txt',
                'batch_method': 'combat'
            }
        }
