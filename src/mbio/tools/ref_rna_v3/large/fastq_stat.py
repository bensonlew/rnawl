...
class FastqStatAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {"name": "fastq_info", "type": "infile", "format": "ref_rna_v2.common"},  # fastq文件夹
...
class FastqStatTool(Tool):
    ...
    def fastq_stat(self):
        # self.get_list_file()
        cmd = "{}java -jar {} -i {} -t {} -Q {}".format(self.java_path, self.FastqStat_path, self.option("fastq_info").prop["path"], 10, self.option("quality"))
