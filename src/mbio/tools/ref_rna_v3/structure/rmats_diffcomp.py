...
class RmatsDiffcompAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {'name': 'rmats_detail_list', 'type': 'infile', 'format': 'ref_rna_v3.common'},
            ...
            {'name': 'diffcomp_txt', 'type': 'outfile', 'format': 'ref_rna_v3.common'},
        ]
...
class RmatsDiffcompTool(Tool):
    def __init__(self,config):
        ...
        self.script = {
            'rmats_diffcomp': os.path.join(self.config.PACKAGE_DIR, 'ref_rna_v3/structure/rmats_diffcomp.py')
        }
        self.file = {
