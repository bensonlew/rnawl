...
import json
import unittest
from mbio.packages.ref_rna.ipath import Ipath
...
class IpathAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "kegg_table", "type": "infile", "format": "ref_rna.kegg_table"},
        ]
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        test_dir = '/mnt/ilustre/users/sanger-dev/workspace/20180312/genesetKegg_ref_rna_7534_948'
        data = {
            "id": "ipath" + str(random.randint(1, 10000)),
            "type": "tool",
            "name": "ref_rna.geneset.ipath",
            "instant": True,
            "options": dict(
