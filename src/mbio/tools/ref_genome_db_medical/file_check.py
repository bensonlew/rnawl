...
class FileCheckTool(Tool):
    ...
    def check_input_file(self):
        ...
        if self.option("g2t2p").is_set:
            ...
            g2t2p_pd = g2t2p_pd[g2t2p_pd[0].isin(gene_ids)]
            g2t2p_pd.to_csv(os.path.join(self.output_dir, "g2t2p.txt"), sep="\t", header=False, index=False)
