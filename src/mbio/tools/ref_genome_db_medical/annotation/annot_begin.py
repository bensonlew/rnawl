...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            'type': 'tool',
            'name': 'ref_genome_db_medical.annotation.annot_begin',
            'instant': False,
            'options': {
                'gtf': '/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/vertebrates/Homo_sapiens/GRCh38.p13_ensembl_98/gtf/Homo_sapiens.GRCh38.98.gtf',
                'fasta': '/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/vertebrates/Homo_sapiens/GRCh38.p13_ensembl_98/dna/Homo_sapiens.GRCh38.dna_sm.primary_assembly.fa',
