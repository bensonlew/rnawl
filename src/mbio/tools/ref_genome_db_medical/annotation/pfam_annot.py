...
class PfamAnnotTool(Tool):
    def __init__(self, config):
        ...
        self.pfam_gene_py = os.path.join(self.config.PACKAGE_DIR, 'ref_genome_db_medical/annotation/pfam_gene.py')
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            'type': 'tool',
            'name': 'ref_genome_db_medical.annotation.pfam_annot',
            'instant': False,
            'options': {
                'pfam_domain': '/mnt/ilustre/users/sanger-dev/sg-users/liubinxu/genome_annotation/pfam_annot.tsv',
