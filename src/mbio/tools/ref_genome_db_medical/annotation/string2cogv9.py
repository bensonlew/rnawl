...
class String2cogv9Agent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "cog_summary", "type": "outfile", "format": "ref_rna_v2.cog_summary"}
        ]
    ...
    def check_options(self):
        if not self.option("blastout").is_set and not self.option("string_table").is_set:
            raise OptionError("必须提供比对到string库的xm文件或table文件", code = "33702901")
...
class String2cogv9Tool(Tool):
    ...
    def run_string2cog_old(self):
        ...
        try:
            ...
            self.set_error('运行string2cog.py出错', code = "33702902")
    ...
    def run_string2cog(self):
        ...
        if cmd_obj.return_code == 0:
            ...
            self.set_error("string2cog出错", code = "33702903")
