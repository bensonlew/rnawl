    ...
    class TestFunction(unittest.TestCase):
        ...
        def test(self):
            ...
            data = {
                ...
                "type": "tool",
                "name": "lnc_rna.lncrna_identification.pfam_scan_predictor",
                "instant": False,
                "options": dict(
                    fasta_file="/mnt/ilustre/users/sanger-dev/sg-users/zhaozhipeng/lncrna_tools/filter_new_transcripts.fa",
                    cpu=5
                )
            }
