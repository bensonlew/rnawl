...
class Mitarget2ceTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.ExpCorrsf_toolbox = self.config.PACKAGE_DIR + '/whole_transcriptome/target2ce.py'
    ...
    def run_target_ce(self):
        ...
        cmd += '-{} {} '.format("mi_min_num", self.option("mi_min_num"))
        cmd += '-{} {} '.format("retain_type", self.option("retain_type"))
