...
class ExpcorrMitargetAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {'name': 'exp', 'type': 'infile', 'format': 'lnc_rna.common'},
            {'name': 'exp_target', 'type': 'infile', 'format': 'lnc_rna.common'},
            {'name': 'rna_target', 'type': 'infile', 'format': 'lnc_rna.common'},
            {'name': 'known_target', 'type': 'infile', 'format': 'lnc_rna.common'},
            {'name': 'novol_target', 'type': 'infile', 'format': 'lnc_rna.common'},
...
class ExpcorrMitargetTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.ExpCorrsf_toolbox = self.config.PACKAGE_DIR + '/whole_transcriptome/exp_corr_mitarget.py'
