...
class RmatsStatAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {'name': 'event_stats', 'type': 'outfile', 'format': 'whole_transcriptome.common'},
            {'name': 'psi_stats', 'type': 'outfile', 'format': 'whole_transcriptome.common'},
        ]
...
class RmatsStatTool(Tool):
    def __init__(self, config):
        ...
        self.script = {
            'rmats_stats': os.path.join(self.config.PACKAGE_DIR, 'whole_transcriptome/structure/rmats_stat.py')
        }
        self.file = {
