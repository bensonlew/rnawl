    ...
    def test(self):
        ...
        data = {
            ...
            'options': dict(
                ...
                # readFilesIN1='/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/lnc_rna/test_data/23Y_1115_S6_L002_1P.fastq',
                # readFilesIN2='/mnt/ilustre/users/sanger-dev/sg-users/qinjincheng/lnc_rna/test_data/23Y_1115_S6_L002_2P.fastq',
