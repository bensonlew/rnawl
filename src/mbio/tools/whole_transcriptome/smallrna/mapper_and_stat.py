...
class MapperAndStatTool(Tool):
    ...
    def run(self):
        ...
        if not os.path.exists(self.option("index") + '.1.ebwt'):
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "tool",
            "name": "whole_transcriptome.smallrna.mapper_and_stat",
            "instant": False,
            "options": dict(
                config = "/mnt/ilustre/users/sanger-dev/workspace/20190926/Single_whole_transcriptome.smallrna.mirna_qc15-22-40/MirnaQc/qc_file.config",
                fasta = "/mnt/ilustre/users/sanger-dev//workspace/20190927/Single_whole_transcriptome_smallrna_FastaUniq08-47-49/FastaUniq/output/uniq.fasta",
                index = "/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/vertebrates/Homo_sapiens/GRCh38_Ensembl_96/dna/Homo_sapiens.GRCh38.dna.toplevel",
                ...
                ref = "/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/vertebrates/Homo_sapiens/GRCh38_Ensembl_96/dna/Homo_sapiens.GRCh38.dna.toplevel.fa"
            )
        }
