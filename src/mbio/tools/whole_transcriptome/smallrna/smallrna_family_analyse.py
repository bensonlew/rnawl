...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        test_dir ='/mnt/ilustre/users/sanger-dev/sg-users/zhuwengen/whole_transcriptome/smallrna/smallrna_family_analyse'
        data = {
            "id": "whole_transcriptome_smallrna_FamilyAnalyse" + datetime.datetime.now().strftime('%H-%M-%S'),
            "type": "tool",
            "name": "whole_transcriptome.smallrna.smallrna_family_analyse",
            "instant": False,
            "options": dict(
                mir = test_dir + "/" + "All_miRNA_tpm.xls",
                matfa = test_dir + "/" + "known_mature.fa",
                novofa = test_dir + "/" + "novel_mature.fa",
            )
           }
