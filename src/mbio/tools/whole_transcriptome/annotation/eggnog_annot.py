...
class EggnogAnnotAgent(Agent):
    ...
    def set_resource(self):
        ...
        self._memory = '{}G'.format(int(float(infile_size) / 1024 ** 3 * 4 + 4))
...
class EggnogAnnotTool(Tool):
    def __init__(self, config):
        ...
        self.cog_annotation_py = os.path.join(self.config.PACKAGE_DIR,
                                              'whole_transcriptome/annotation/cog_annotation.py')
