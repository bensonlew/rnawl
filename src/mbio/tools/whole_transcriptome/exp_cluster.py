...
class ExpClusterTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.cluster_toolbox = self.config.PACKAGE_DIR + '/whole_transcriptome/cluster_toolbox.py'
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        test_dir='/mnt/ilustre/users/sanger-dev/workspace/20191028/GenesetCluster_whole_transcriptome_1714_5386'
        data = {
            "id": "ExpCluster" + str(random.randint(1, 10000)),
            "type": "tool",
            "name": "whole_transcriptome.exp_cluster",
            "instant": False,
            "options": dict(
                exp=test_dir + "/" + "exp_matrix",
                group=test_dir + "/" + "group",
                n_clusters=10,
                sct="hierarchy",
                gct="kmeans",
                scm="complete",
