...
class PpinetworkMapAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "seq_mapped", "type": "outfile", "format": "itraq_and_tmt.common"},
            {"name": "unmapped_seq", "type": "outfile", "format": "itraq_and_tmt.common"},
            {"name": "unmapped_db", "type": "outfile", "format": "itraq_and_tmt.common"},
        ]
    ...
    def check_options(self):
        ...
        if not self.option("diff_exp_gene").is_set:
            raise OptionError("必须输入含有gene_id的差异基因列表！", code = "32503701")
