...
class GoEnrichAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            dict(name="method", type="string", default="BH"),
            ]
...
class GoEnrichTool(Tool):
    ...
    def run_enrich(self):
        ...
        if command.return_code == 0:
            ...
            self.set_error('goatools计算错误', code = "32503303")
    ...
    def run_draw_go_graph(self):
        try:
            ...
            self.set_error('绘图发生错误:\n%s', variables = (traceback.format_exc()), code = "32503304")
