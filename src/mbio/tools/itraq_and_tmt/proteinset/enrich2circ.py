...
import json
import unittest
from mbio.packages.itraq_and_tmt.enrich2circ import Enrich
...
class Enrich2circAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "fc_table", "type": "infile", "format": "itraq_and_tmt.common"}
        ]
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "tool",
            "name": "itraq_and_tmt.proteinset.enrich2circ",
            "instant": True,
            "options": dict(
                enrich_type = "GO",
