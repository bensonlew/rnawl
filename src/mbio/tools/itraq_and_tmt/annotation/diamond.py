...
class DiamondAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            ...
            {"name": "outxml", "type": "outfile", "format": "itraq_and_tmt.blast_xml"},
            ...
            {"name": "version", "type": "string", "default": None},
...
class DiamondTool(Tool):
    ...
    def change_version(self, outputfile):
        ...
        '''
        if db_name in ["nr", "animal", "fungi", "metazoa", "plant", "protist", "viridiplantae", "vertebrates",
                       "swissprot"]:
            self.get_nrxml_gi_description(path)
            self.option('outxml', path + "_new")
        '''
