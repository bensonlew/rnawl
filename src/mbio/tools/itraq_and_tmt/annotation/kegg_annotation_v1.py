...
class KeggAnnotationAgent(Agent):
    ...
    def check_options(self):
        if not self.option("blastout").is_set:
            raise OptionError("必须提供BLAST结果文件", code="32501201")
        else:
            pass
...
class KeggAnnotationTool(Tool):
    ...
    def run_path_search(self):
        ...
        try:
            ...
            self.set_error("运行pathSearch.py出错", code="32501201")
        self.run_kegg_layer()
    ...
    def run_kegg_layer(self):
        ...
        try:
            ...
            self.set_error("运行keggLayer.py出错", code="32501202")
        self.run_get_pic()
    ...
    def run_get_pic(self):
        ...
        try:
            ...
            self.set_error("运行getPic.py出错", code="32501203")
        self.end()
