...
class OrfAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {"name": "fasta", "type": "infile", "format": "itraq_and_tmt.common"},  # 输入文件
    ...
    def check_options(self):
        ...
        if not self.option("fasta").is_set:
            raise OptionError("请传入fasta序列文件", code="32501601")
...
class OrfTool(Tool):
    ...
    def td_longorfs(self):
        ...
        if command.return_code == 0:
            ...
            self.set_error("提取orf过程出错", code="32501601")
    ...
    def td_predict(self, hmm_out=None):
        ...
        if command.return_code == 0:
            ...
            self.set_error("预测过程过程出错", code="32501602")
    ...
    def hmmscan(self, pep):
        ...
        if command.return_code == 0:
            ...
            self.set_error("运行hmmscan出错", code="32501603")
