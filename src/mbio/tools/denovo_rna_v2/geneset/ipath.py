...
import json
import unittest
from mbio.packages.denovo_rna_v2.ipath import Ipath
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        test_dir = '/mnt/ilustre/users/sanger-dev/workspace/20180312/genesetKegg_denovo_rna_v2_7534_948'
        data = {
            "id": "ipath" + str(random.randint(1, 10000)),
            "type": "tool",
            "name": "denovo_rna_v2.geneset.ipath",
            "instant": True,
            "options": dict(
