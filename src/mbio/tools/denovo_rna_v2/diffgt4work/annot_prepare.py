...
class AnnotPrepareTool(Tool):
    ...
    def export_go_list(self):
        ...
        raw_go_list_path = os.path.join(self.option("annot_result"),"go","go_list_gene.xls")
    ...
    def export_kegg_table(self):
        ...
        raw_kegg_path = os.path.join(self.option("annot_result"), "kegg", "kegg_gene_gene.xls")
    ...
    def export_kegg_level_table(self):
        ...
        raw_kegg_level_path = os.path.join(self.option("annot_result"), "kegg", "kegg_pathway_gene.xls")
    ...
    def export_reactome_annot(self):
        ...
        raw_reac_path = os.path.join(self.option("annot_result"), "reactome", "reactome.G.detail.tsv")
