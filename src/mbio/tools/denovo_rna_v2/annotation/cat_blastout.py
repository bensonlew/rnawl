...
class CatBlastoutAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {"name": "blastout", "type": "infile", "format": "align.blast.blast_xml_dir,align.blast.blast_table_dir"},
            {"name": "blast_result", "type": "outfile", "format": "align.blast.blast_xml,align.blast.blast_table"},
        ]
    ...
    def check_options(self):
        ...
        if not self.option("blastout").is_set:
            raise OptionError("请传入blast输出结果文件", code = "32000401")
