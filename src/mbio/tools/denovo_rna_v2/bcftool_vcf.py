...
class BcftoolVcfAgent(Agent):
    ...
    def check_options(self):
        if not self.option("vcf_list"):
            raise OptionError("缺少vcf_list参数", code = "32002201")
...
class BcftoolVcfTool(Tool):
    ...
    def bcftools_concat(self):
        ...
        cmd1 = "{} concat {}-o {}/pop.nosort.vcf -O v"\
            .format(self.bcftools_path, vcf_list, self.work_dir)
        ...
        if command1.return_code == 0:
            ...
            self.set_error("bcftools_concat出错！", code = "32002202")
    ...
    def bcftools_annotate(self):
        ...
        :return:
        """
        cmd2 = "{} annotate --set-id +'%CHROM\_%POS' {} -o {}/pop.nosort.vcf"\
            .format(self.bcftools_path, self.work_dir + '/pop.noid.vcf', self.work_dir)
        ...
        if command2.return_code == 0:
            ...
            self.set_error("bcftools_annotate出错！", code = "32002203")
    ...
    def bcftools_sort(self):
        ...
        :return:
        """
        cmd3 = "{} sort -m 100G -T {}/temp/ -o {}/pop.variant.vcf {}"\
            .format(self.bcftools_path, self.work_dir, self.output_dir, self.work_dir + "/pop.nosort.vcf")
        ...
        if command3.return_code == 0:
            ...
            self.set_error("bcftools_sort出错！", code = "32002204")
