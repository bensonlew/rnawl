...
class TrinityMergeTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.trinitymerge = software_dir + '/bioinfo/rna/scripts/trinitymerge.py'
    ...
    def run_trinitymerge(self):
        cmd = '{} {} '.format(self.python_path, self.trinitymerge)
        ...
        if command.return_code == 0:
            ...
            if command.return_code is 0:
                ...
                self.set_error("%s Failed. >>>%s", variables=(cmd_name, cmd), code="32006701")
        else:
            self.set_error("%s Failed. >>>%s", variables=(cmd_name, cmd), code="32006702")
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "tool",
            "name": "denovo_rna_v2.trinitymerge",
            "instant": False,
            "options": dict(
