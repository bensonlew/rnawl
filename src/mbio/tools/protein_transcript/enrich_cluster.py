...
class EnrichClusterAgent(Agent):
    ...
    def __init__(self, parent):
        ...
        options = [
            {'name': 'cluster_file', 'type': 'infile', 'format': 'itraq_and_tmt.ratio_exp'},
...
class EnrichClusterTool(Tool):
    ...
    def __init__(self, config):
        ...
        self.cluster_toolbox = self.config.PACKAGE_DIR + '/protein_transcript/cluster_toolbox.py'
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        data = {
            ...
            "type": "tool",
            "name": "itraq_and_tmt.exp_cluster",
            "instant": False,
            "options": dict(
