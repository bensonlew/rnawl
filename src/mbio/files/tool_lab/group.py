...
class GroupFile(File):
    ...
    def get_info(self):
        ...
        group_name_list = self.get_group_name(info[1][0])
        self.set_property("group_name_list", group_name_list)
