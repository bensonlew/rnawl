...
if __name__ == '__main__':  # for test
    ...
    a.set_path("/mnt/ilustre/users/sanger-dev/sg-users/liubinxu/test_ref_rna_v2/test.xls")

    a.cog_class("class.xls")
    a.cog_class("gene_class.xls", trans_gene = "/mnt/ilustre/users/sanger-dev/sg-users/liubinxu/test_ref_rna_v2/tran2gene.txt")
