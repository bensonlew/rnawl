...
class RelateDiffWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            dict(name="seq", type="infile", format="labelfree.common"),
        ...
        self._sheet.output = self._sheet.output.replace('interaction_results',
                                                        'interaction_results/7_relate/02_relate_exp/01_relate_diff')
        self.inter_dirs = []
    ...
    def set_db(self):
        ...
        if len(self.diff_relation_list) >= 20:
            api_ppinetwork = self.api.api('protein_transcript_dia_v3.p2g_diff_ppi')
    ...
    #     导入九宫格等
        rel_diff = self.api.api("protein_transcript_dia_v3.p2g_diff")
