...
class PrGoEnrichClusterWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.rna_tools = list()
        self.cluster_tool = self.add_tool("protein_transcript_dia_v3.enrich_cluster")
        self._sheet.output = self._sheet.output.replace('interaction_results',
                                                        'interaction_results/7_relate/03_relate_anno/03_relate_goenrich_cluster')
        self.inter_dirs = []
    ...
    def set_db(self):
        ...
        保存结果指数表到mongo数据库中
        """
        api_goenrich = self.api.api('protein_transcript_dia_v3.relaset')
