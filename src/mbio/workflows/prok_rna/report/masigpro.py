...
class MasigproWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            {'name': 'cluster', 'type': 'int', 'default': 10},
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("prok_rna", table="sg_masigpro", main_id=self.option('main_id'),
    ...
    def run_masigpro(self):
        ...
        self.masigpro = self.add_tool('prok_rna.timeseries.masigpro')
        options = {
    ...
    @workfuncdeco
    def set_db(self):
        self.database = self.api.api('prok_rna.masigpro')
...
class TestFunction(unittest.TestCase):
    ...
    def test_kmeans(self):
        import random
        from mbio.workflows.prok_rna.report.masigpro import MasigproWorkflow
