...
class StemWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            {'name': 'unit', 'type': 'int', 'default': 1},
            {'name': 'significance', 'type': 'float', 'default': 0.05},
            {'name': 'correction', 'type': 'string', 'default': 'None'},  # ['Bonferroni', 'FDR', 'None']
        ...
        #                                                 'interaction_results/06 Advanced_Analysis/02 Time_series_Analysis')
        # self.inter_dirs = []
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("prok_rna", table="sg_stem", main_id=self.option('main_id'),
    ...
    def run_prepare(self):
        ...
        self.prepare = self.add_tool('prok_rna.timeseries.prepare')
        options = {
    ...
    def run_stem(self):
        ...
        hostname = {'sanger-dev': '10.2.3.173', 'sanger': '10.2.0.110', 'isanger': '10.2.0.115'}[
            self.config.wpm_user]
        self.logger.info('#' * 64)
    ...
    def run_statistics(self):
        ...
        self.statistics = self.add_tool('prok_rna.timeseries.statistics')
        options = {
            'method': self.option('method'),
    ...
    @workfuncdeco
    def set_db(self):
        self.database = self.api.api('prok_rna.stem')
    ...
    def end(self):
        ...
        result_dir.add_regexp_rules([
            ...
            [r'stem\.profile_.*\.pdf', 'pdf', 'profile趋势图', 0],
        ])
...
class TestFunction(unittest.TestCase):
    ...
    def test_scm(self):
        from mbio.workflows.prok_rna.report.stem import StemWorkflow
        ...
        wf.sheet.id = 'prok_rna_upgrade'
        wf.sheet.project_sn = 'prok_rna_upgrade'
