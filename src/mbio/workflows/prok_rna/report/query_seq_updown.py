...
class QuerySeqUpdownWorkflow(Workflow):
    """
    基因集venn图
    """
    def __init__(self, wsheet_object):
        self._sheet = wsheet_object
        super(QuerySeqUpdownWorkflow, self).__init__(wsheet_object)
        options = [
    ...
    def end(self):
        super(QuerySeqUpdownWorkflow, self).end()
    ...
    def set_db(self, seq):
        ...
        conn.update({'_id': ObjectId(self.option('main_id'))}, {'$set': {'gene_seq': seq}})
