...
class GenesetIpathWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self._sheet.output = self._sheet.output.replace('interaction_results',
                                                        'interaction_results/07 Advanced_Analysis/05 iPath_Analysis')
        self.inter_dirs = []
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("lnc_rna", table="sg_geneset_ipath", main_id=self.option('main_table_id'),
    ...
    def set_db(self):
        ...
        if isinstance(record_id, types.StringTypes):
            ...
            self.set_error("main_id参数必须为字符串或者ObjectId类型!")
    ...
    def end(self):
        ...
        self.inter_dirs = [
            ...
            ["07 Advanced_Analysis/05 iPath_Analysis", "", "iPath代谢通路分析结果目录", 0],
        ]
        result_dir.add_relpath_rules([
            [".", "", "iPath代谢通路分析文件", 0],
            ['./gene_ipath_input.xls', 'xls', '代谢通路数据', 0],
