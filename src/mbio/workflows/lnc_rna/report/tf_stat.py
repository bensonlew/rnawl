...
class TfStatWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.dump_tool = self.api.api("lnc_rna.tf_stat")
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("lnc_rna", table="sg_tf_stat", main_id=self.option('main_id'),
    ...
    def end(self):
        ...
        result_dir.add_relpath_rules([
            [".", "", "转录因子家族统计文件", 0],
            ['./all_bar_stat.txt', 'txt', '转录因子家族统计表', 0],
            ['./gene_circos_stat.txt', 'txt', '转录因子家族circos基因统计表', 0],
            ['./transcript_circos_stat.txt', 'txt', '转录因子家族circos转录本统计表', 0],
            ['./filtered_tf_predict.xls', 'xls', '转录因子家族详情表', 0],
