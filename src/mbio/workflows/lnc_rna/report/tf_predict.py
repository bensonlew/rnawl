...
class TfPredictWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.tf_predict = self.add_module("lnc_rna.tf_predict")
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("lnc_rna", table="sg_tf_predict", main_id=self.option('main_id'),
    ...
    def end(self):
        ...
        result_dir.add_relpath_rules([
            ...
            ['./final_tf_predict.xls', 'xls', '转录因子预测详情表', 0],
            ['./diamond.out.txt', 'txt', 'Blast比对详情表', 0],
            ['./domain_predict.txt', 'txt', '蛋白功能域预测详情表', 0],
