...
class BatchWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            {'name': 'exp_matrix', 'type': 'infile', 'format': 'lnc_rna.common'},
            {'name': 'count', 'type': 'infile', 'format': 'lnc_rna.common'},
            {'name': 'group_table', 'type': 'infile', 'format': 'lnc_rna.common'},
            {'name': 'batch_matrix', 'type': 'infile', 'format': 'lnc_rna.common'},
            ...
            {'name': 'count_batch', 'type': 'outfile', 'format': 'lnc_rna.common'},
            {'name': 'task_id', 'type': 'string'},
            {'name': 'exp_other', 'type': 'infile', 'format': 'lnc_rna.common'},
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("lnc_rna", table="sg_exp_batch", main_id=self.option('sg_exp_batch_id'),
                                dir_path=self.work_dir)
        self.run_log = get_run_log.run()

    def run_batch(self):
        self.batch = self.add_tool('lnc_rna.batch.batch')
    ...
    def run_SVA(self):
        self.SVA = self.add_tool('lnc_rna.batch.sva')
    ...
    def run_exp_pca(self):
        self.exp_batch_pca = self.add_tool("lnc_rna.exp_pca")
        if self.option('has_batch') == True:
    ...
    def run_exp_corr(self):
        self.exp_batch_corr = self.add_tool("lnc_rna.exp_corr")
        if self.option('has_batch') == True:
    ...
    def set_db(self):
         ...
         exp_batch = self.api.api('lnc_rna.batch')
