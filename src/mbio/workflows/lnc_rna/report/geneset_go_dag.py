...
class GenesetGoDagWorkflow(Workflow):
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            {"name": "go_enrich_detail", "type": "infile", "format": "lnc_rna.common"},
        ...
        self.go_dag = self.add_tool("lnc_rna.geneset.go_dag")
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("lnc_rna", table="sg_geneset_go_dag", main_id=self.option('go_enrich_id'),
    ...
    def set_db(self):
        ...
        self.dump_tool.update_db_record('sg_geneset_go_dag', self.option('go_enrich_id'),
