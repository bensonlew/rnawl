...
from mbio.packages.metabolome.copy_demo import CopyDemo


class MetabolomeCopyDemoWorkflow(Workflow):
    def __init__(self, wsheet_object):
        self._sheet = wsheet_object
        self._project_type = "metabolome"
        super(MetabolomeCopyDemoWorkflow, self).__init__(wsheet_object)
        options = [
    ...
    def end(self):
        super(MetabolomeCopyDemoWorkflow, self).end()
