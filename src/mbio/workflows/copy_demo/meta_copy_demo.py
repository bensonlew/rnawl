...
from mbio.packages.meta.scripts.copy_demo import CopyDemo


class MetaCopyDemoWorkflow(Workflow):
    def __init__(self, wsheet_object):
        self._sheet = wsheet_object
        self._project_type = "meta"
        super(MetaCopyDemoWorkflow, self).__init__(wsheet_object)
        options = [
    ...
    def end(self):
        super(MetaCopyDemoWorkflow, self).end()
