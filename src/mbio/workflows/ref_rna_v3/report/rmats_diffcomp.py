...
class RmatsDiffcompWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self._sheet.output = self._sheet.output.replace('interaction_results', 'interaction_results/04 AS/03 AS_diff_compare')
        self.inter_dirs = []
    ...
    def run_rmats_diffcomp(self):
        ...
        self.rmats_diffcomp = self.add_tool('ref_rna_v3.structure.rmats_diffcomp')
    ...
    @workfuncdeco
    def set_db(self):
        api = self.api.api('ref_rna_v3.rmats_diffcomp')
    ...
    def end(self):
        ...
        self.inter_dirs = [
            ["04 AS", "", "可变剪切分析结果目录",0],
            ["04 AS/03 AS_diff_compare", "", "差异可变剪切比较文件", 0]
        ]
        relpath = [
...
class TestFunction(unittest.TestCase):
    ...
    '''
    def test(self):
        from mbio.workflows.ref_rna_v3.report.rmats_diffcomp import RmatsDiffcompWorkflow
        ...
        data = {
            ...
            'options': {
                's3_file_list': '/mnt/ilustre/users/sanger-dev/workspace/20190614/RmatsDiffcomp_tsg_33555_8908_5404/table.list',
                'delta_psi': '0.0',
                'significant_diff': 'fdr',
                'significant_value': '0.05',
                'main_id': '5d03432617b2bf3131a7553c'
            }
        }
