...
class BatchWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self._sheet.output = self._sheet.output.replace('interaction_results', 'interaction_results/02 Express/04 Exp_Batch')
        self.inter_dirs = []
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("denovo_rna_v2", table="sg_exp_batch", main_id=self.option('sg_exp_batch_id'),
    ...
    def run_exp_corr(self):
        self.exp_batch_corr = self.add_tool("denovo_rna_v2.exp_corr")
        if self.option('has_batch') == True:
    ...
    def set_db(self):
         ...
         exp_batch = self.api.api('denovo_rna_v3.batch')
    ...
    def end(self):
        ...
        self.inter_dirs = [
            ...
            ["02 Express/04 Exp_Batch", "", "批次效应评估", 0]
        ]
