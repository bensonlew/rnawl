...
class BugbaseContributionWorkflow(Workflow):
    def __init__(self, wsheet_object):
        ...
        #self.contribute_tool = self.add_tool("meta.bugbase_contribution")
    ...
    def run_contribute(self):
        ...
        options = {
            ...
            "tax_level": self.option("species_level"),
            "fun_level": "category",
            "top_tax": 250,
            "top_fun": 10
        }
    ...
    def set_db(self):
        ...
        api_contribute = self.api.api("bugbase_contribution")
        tax_species_old = os.path.join(self.contribute_tool.output_dir , "Tax_{}_abu.xls".format(self.option("species_level")))
    ...
    def save_pdf(self):
        ...
        if self.pdf_status:
            name = get_name(self.option("main_id"), "sg_bugbase_contribution")
            ...
            self.figsave.set_options({
                ...
                "table_name": name,
                "project": "meta",
                "submit_loc": "bugbase_contribution",
                "interaction": 1,
                "main_table": "sg_bugbase_contribution",
            })
            self.figsave.run()
        else:
            self.end()
