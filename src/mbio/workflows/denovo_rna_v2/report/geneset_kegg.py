...
class GenesetKeggWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            {"name": "kegg_table_2", "type": "infile", "format": "denovo_rna_v2.common"},
        ...
        self.kegg_class = self.add_tool("denovo_rna_v2.kegg_class")
    ...
    def set_db(self):
        ...
        api_geneset.add_kegg_regulate_new(self.option("main_table_id"), self.option("geneset_id"), output_file, self.option("kegg_table_2").prop['path'], self.work_dir, self.option("geneset_type"))
        ...
        if isinstance(record_id, types.StringTypes):
            ...
            self.set_error("main_id参数必须为字符串或者ObjectId类型!", code = "12001501")
        ...
        if re.match(r'tsanger:', self.workflow_output_tmp):
            ...
            self.set_error("json output wrong", code="12001502")
    ...
    def end(self):
        ...
        result_dir.add_relpath_rules([
            [".", "", "基因集KEGG功能分类结果目录",0,"201402"],
            ["pathways", " ", "KEGG分析结果通路表",0,"201403"],
            ["kegg_analysis_of_anotate.xls", " ", "KEGG分类统计表",0,"201404"],
            ["kegg_statistics.xls", " ", "KEGG分类统计结果表",0,"201405"],
