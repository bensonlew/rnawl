...
# from mbio.packages.denovo_rna_v2.chart_advance import ChartAdvance
...
class WgcnaNetworkWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            dict(name="step3output", type="infile", format="denovo_rna_v2.common_dir"),
            dict(name="step2output", type="infile", format="denovo_rna_v2.common_dir"),
            # to update sg_status
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("denovo_rna_v2", table="sg_wgcna_network", main_id=self.option('main_id'),
