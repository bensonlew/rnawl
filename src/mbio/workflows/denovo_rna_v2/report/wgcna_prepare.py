...
class WgcnaPrepareWorkflow(Workflow):
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("denovo_rna_v2", table="sg_wgcna_prepare", main_id=self.option('main_id'),
    ...
    def chart(self):
        ...
        sample_tree = self.tool.work_dir + "/sample.cluster.dendrogram.txt"
    ...
    def end(self):
        ...
        pick_power = os.path.join(self.tool.work_dir, 'pick_power.pdf')
        ...
        result_dir.add_relpath_rules([
            ...
            ["./wgcna.sample_tree.heat_corr.pdf", "", "样本聚类", 0],
            ["./pick_power.pdf", "", "无尺度容适曲线与平均连通度曲线", 0],
