...
class WgcnaRelateWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            {"name": "block_Rdata", "type": "infile", "format": "denovo_rna_v2.common"}
        ]
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("denovo_rna_v2", table="sg_wgcna_relate", main_id=self.option('main_id'),
    ...
    def end(self):
        ...
        result_dir.add_relpath_rules([
            ...
            ["./wgcna.relation_heat.heat_corr.pdf", "", "模块与表型相关性热图 ", 0],
            ["./wgcnarelation_ms.*.scatter.pdf", "", "MM-GS散点图", 0],
            ["./*relation_ms.column*.pdf", "", "MS分析柱图 ", 0],
