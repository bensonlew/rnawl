...
class GenesetSelfWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            dict(name="genes", type="infile", format="small_rna.common"),
            dict(name="file_path", type="infile", format="small_rna.common"),
    ...
    def set_db(self):
        ...
        """
        geneset_self = self.api.api("small_rna.geneset_self")
