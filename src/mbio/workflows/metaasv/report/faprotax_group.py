    ...
    def set_db(self):
        ...
        if self.option("group_method") == "two":
            ...
            api_two_group.add_species_difference_check_detail(statfile=stat_path, cifiles=[ci_path],
                                                              ...
                                                              correlation_key="faprotax_id",bar_name = "faprotax_group_bar",
                                                              coll_name="faprotax_group_detail", main_coll="faprotax_group",task_type="two_group")
            api_two_group.add_species_difference_check_boxplot(boxfile_path, self.option('main_id'),
                                                               correlation_key="faprotax_id", coll_name="faprotax_group_box",
                                                               main_coll="faprotax_group",task_type="two_group")
            #api_two_group.add_species_difference_check_barplot(bar_path, self.option('main_id'),
            #                                                   correlation_key="faprotax_id", coll_name="faprotax_group_bar",
            #                                                   main_coll="faprotax_group",task_type="two_group")
            api_two_group.update_species_difference_check(self.option('main_id'), stat_path, ci_path, 'faprotax_group')
        else:
