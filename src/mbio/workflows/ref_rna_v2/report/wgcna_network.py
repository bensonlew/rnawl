...
class WgcnaNetworkWorkflow(Workflow):
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("ref_rna_v2", table="sg_wgcna_network", main_id=self.option('main_id'),
    ...
    def set_db(self):
        ...
        dump_tool.update_db_record('sg_wgcna_network', self.option('main_id'), output_dir=network,has_json ="yes", status="end")
        # add result info
        self.end()
