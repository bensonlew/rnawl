...
class StemWorkflow(Workflow):
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("ref_rna_v2", table="sg_stem", main_id=self.option('main_id'),
    ...
    @workfuncdeco
    def set_db(self):
        self.database = self.api.api('ref_rna_v2.stem')
    ...
    def chart(self):
        ...
        for p in pdf_file:
            linkfile(p, os.path.join(self.output_dir, os.path.basename(p)))
