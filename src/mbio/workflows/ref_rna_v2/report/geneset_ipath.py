...
class GenesetIpathWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self._sheet.output = self._sheet.output.replace('interaction_results', 'interaction_results/06 Advanced_Analysis/06 iPath_Analysis')
        self.inter_dirs = []
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("ref_rna_v2", table="sg_geneset_ipath", main_id=self.option('main_table_id'),
    ...
    def end(self):
        ...
        self.inter_dirs = [
            ...
            ["06 Advanced_Analysis/06 iPath_Analysis", "", "iPath代谢通路", 0]
        ]
