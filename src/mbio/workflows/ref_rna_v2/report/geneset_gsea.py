...
class GenesetGseaWorkflow(Workflow):
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("ref_rna_v2", table="sg_geneset_gsea", main_id=self.option('main_table_id'),
    ...
    def set_db(self):
        ...
        保存结果指数表到mongo数据库中
        """
        api_geneset = self.api.api('ref_rna_v2.gsea')
    ...
    def end(self):
        ...
        self.inter_dirs = [
            ...
            ["06 Advanced_Analysis/03 GSEA_Analysis", "", "GSEA分析", 0]
        ]
