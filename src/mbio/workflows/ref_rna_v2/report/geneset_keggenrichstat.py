...
class GenesetKeggenrichstatWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.tool = self.add_tool("ref_rna_v2.geneset.kegg_richstat")
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("ref_rna_v2", table="sg_geneset_kegg_enrich_stat", main_id=self.option('geneset_kegg_enrich_stat_id'),
