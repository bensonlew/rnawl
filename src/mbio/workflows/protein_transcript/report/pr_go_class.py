...
class PrGoClassWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self._sheet.output = self._sheet.output.replace('interaction_results', 'interaction_results/7_relate/03_relate_anno/01_relate_go')
        self.inter_dirs = []
    ...
    def set_db(self):
        go = self.api.api("protein_transcript.relaset")
        # add result info
