...
class ExpressionRsemWorkflow(Workflow):

    def __init__(self, wsheet_object):
        self._sheet = wsheet_object
        super(ExpressionRsemWorkflow, self).__init__(wsheet_object)
        options = [
    ...
    def run(self):
        self.run_tool()
        super(ExpressionRsemWorkflow, self).run()
    ...
    def end(self):
        ...
        super(ExpressionRsemWorkflow, self).end()
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        from mbio.workflows.tool_lab.expression_rsem import ExpressionRsemWorkflow
        from biocluster.wsheet import Sheet
        import random
        test_dir = "/mnt/ilustre/users/sanger-dev/app/database/Genome_DB_finish/fungi/Saccharomyces_cerevisiae/Ensemble_release_39/"
        data = {
            "id": "expression_rsem" + str(random.randint(1, 10000)),
            "type": "workflow",
            "name": "tool_lab.expression_rsem",
            "options":   {'fq_type': 'PE',
        ...
        wf =ExpressionRsemWorkflow(wsheet)
