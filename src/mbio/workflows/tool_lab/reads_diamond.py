...
class ReadsDiamondWorkflow(Workflow):
    """
    基于reads的humann2分析
    ...
    def __init__(self, wsheet_object):
        ...
        super(ReadsDiamondWorkflow, self).__init__(wsheet_object)
        options = [
    ...
    def run(self):
        self.run_main()
        super(ReadsDiamondWorkflow, self).run()

    def run_main(self):
        self.main = self.add_module("toolapps.diamond")
    ...
    def set_db(self):
        ...
        api_main.add_main_table("reads_diamond", main_id = self.option('main_id'))
    ...
    def end(self):
        ...
        super(ReadsDiamondWorkflow, self).end()