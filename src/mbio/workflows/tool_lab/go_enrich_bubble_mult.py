...
class GoEnrichBubbleMultWorkflow(Workflow):
    """
    富集气泡图小工具
    """
    def __init__(self, wsheet_object):
        self._sheet = wsheet_object
        super(GoEnrichBubbleMultWorkflow, self).__init__(wsheet_object)
        options = [
    ...
    def set_db(self):
        ...
        api_bubble.add_tooltip(self.option("main_id"),os.path.join(self.enrich_tool.output_dir,"term.txt"),"go")    
    ...
    def run(self):
        ...
        """
        self.run_tools()
        super(GoEnrichBubbleMultWorkflow, self).run()

    def end(self):
        super(GoEnrichBubbleMultWorkflow, self).end()
...
if __name__ == '__main__':
    ...
    data = {
        ...
        "result_num":20,
        "show_order":"table_file1",
        "ids":"GO:0008652;GO:0055114;GO:0046394;GO:0016053;GO:0019752;GO:0043436;GO:0044283;GO:0006740;GO:0006098;GO:0051156;GO:0006082;GO:0006629;",
        "main_id" : "5e9e6a6017b2bf2049a81be1"
        }
    }
    wsheet = Sheet(data=data)
    wf = GoEnrichBubbleMultWorkflow(wsheet)
    wf.run()
