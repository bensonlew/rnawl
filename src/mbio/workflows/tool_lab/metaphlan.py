...
class MetaphlanWorkflow(Workflow):
    """
    基于reads的Metaphlan分析
    ...
    def __init__(self, wsheet_object):
        ...
        super(MetaphlanWorkflow, self).__init__(wsheet_object)
        options = [
    ...
    def run(self):
        self.run_main()
        super(MetaphlanWorkflow, self).run()

    def run_main(self):
        self.main = self.add_module("toolapps.metaphlan")
        options = {
    ...
    def set_db(self):
        ...
        api_main.add_main_table("reads_metaphlan2", main_id = self.option('main_id'))
    ...
    def end(self):
        ...
        super(MetaphlanWorkflow, self).end()