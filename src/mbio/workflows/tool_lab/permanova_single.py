...
class PermanovaSingleWorkflow(Workflow):
    """
    PERMANOVA分析
    """
    def __init__(self, wsheet_object):
        self._sheet = wsheet_object
        super(PermanovaSingleWorkflow, self).__init__(wsheet_object)
        options = [
    ...
    def run(self):
        self.run_permanova()
        super(PermanovaSingleWorkflow, self).run()
    ...
    def set_output(self):
        ...
        os.link(os.path.join(self.permanova.output_dir,"One-factor_PERMANOVA.xls")
                ,os.path.join(self.output_dir,"One-factor_PERMANOVA.xls"))
        self.set_db()

    def set_db(self):
        self.logger.info("开始导表")
        api_permanmova = self.api.api("tool_lab.permanova_single")
        api_permanmova.add_detail(self.option("main_id"),os.path.join(self.output_dir,"One-factor_PERMANOVA.xls"))
    ...
    def end(self):
        ...
        super(PermanovaSingleWorkflow, self).end()
...
if __name__ == '__main__':
    ...
    data = {
        ...
        'type': 'workflow',
        'options': {
        "input_table":"/mnt/ilustre/users/sanger-dev/workspace/20210416/PermanovaSingle_8n93_sr4g21t4ghbtm2fq97d242_0416110336208677_2101/remote_input/input_table/input.txt",
        "env_table":"/mnt/ilustre/users/sanger-dev/workspace/20210416/PermanovaSingle_8n93_sr4g21t4ghbtm2fq97d242_0416110336208677_2101/remote_input/env_table/env.txt",
    ...
    wf = PermanovaSingleWorkflow(wsheet)
    wf.run()