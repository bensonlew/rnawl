...
class ReadsKrakenWorkflow(Workflow):
    """
    基于reads的humann2分析
    ...
    def __init__(self, wsheet_object):
        ...
        super(ReadsKrakenWorkflow, self).__init__(wsheet_object)
        options = [
            ...
            {"name": "reads_confidence", "type": "float", "default": 0.5},
        ...
        self.main = self.add_module("toolapps.kraken")

    def run(self):
        self.run_main()
        super(ReadsKrakenWorkflow, self).run()
    ...
    def run_main(self):
        opt = {
            ...
            "confidence": self.option('reads_confidence'),
            "readlen": self.option('readlen'),
            }
        self.main.set_options(opt)
    ...
    def set_db(self):
        ...
        api_main.add_main_table("reads_kraken2", main_id = self.option('main_id'))
    ...
    def end(self):
        ...
        super(ReadsKrakenWorkflow, self).end()