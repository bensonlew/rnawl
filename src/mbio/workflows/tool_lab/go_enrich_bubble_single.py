...
class GoEnrichBubbleSingleWorkflow(Workflow):
    """
    富集气泡图小工具
    """
    def __init__(self, wsheet_object):
        self._sheet = wsheet_object
        super(GoEnrichBubbleSingleWorkflow, self).__init__(wsheet_object)
        options = [
    ...
    def run(self):
        ...
        """
        self.run_tools()
        super(GoEnrichBubbleSingleWorkflow, self).run()

    def end(self):
        super(GoEnrichBubbleSingleWorkflow, self).end()
...
if __name__ == '__main__':
    ...
    wf = GoEnrichBubbleSingleWorkflow(wsheet)
    wf.run()
