...
class CompleteGcDepthWorkflow(Workflow):
    """
    用于扫描图的gc_depth分析
    """
    ...
    def __init__(self, wsheet_object):
        ...
        super(CompleteGcDepthWorkflow, self).__init__(wsheet_object)
        options = [
    ...
    def run(self):
        ...
        self.get_info()
        self.run_gcdepth()
        super(CompleteGcDepthWorkflow, self).run()
    ...
    def set_db(self):
        ...
        api_path.add_assess_gc("complete_gcdepth_detail", self.option("main_id"), self.option("samp"), gc_path, gc_remote)
        self.end()
    ...
    def end(self):
        ...
        super(CompleteGcDepthWorkflow, self).end()
