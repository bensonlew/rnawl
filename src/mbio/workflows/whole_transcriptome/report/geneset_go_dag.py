...
class GenesetGoDagWorkflow(Workflow):
    def __init__(self, wsheet_object):
        ...
        self.go_dag = self.add_tool("whole_transcriptome.geneset.go_dag")
        self.dump_tool = self.api.api("whole_transcriptome.api_base")
        self._sheet.output = self._sheet.output.replace('interaction_results',
                                                        'interaction_results/04 GeneSet/08 GO_Dag')
        self.inter_dirs = []
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("whole_transcriptome", table="geneset_go_dag", main_id=self.option('go_enrich_id'),
    ...
    def set_db(self):
        ...
        self.dump_tool.update_db_record('geneset_go_dag', self.option('go_enrich_id'), output_dir=workflow_output,
