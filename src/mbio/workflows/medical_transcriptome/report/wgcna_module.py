...
class WgcnaModuleWorkflow(Workflow):
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("medical_transcriptome", table="sg_wgcna_module", main_id=self.option('main_id'),
    ...
    def set_db(self):
        ...
        保存结果表到mongo数据库中
        """
        dump_tool = self.api.api("medical_transcriptome.wgcna")
    ...
    def end(self):
        ...
        result_dir.add_relpath_rules([
            [".", "", "模块识别文件",0,"211586"],
            ["./block_*_dendrogram.pdf", "", "模块分类树pdf图",0,"211587"],
            ["./block_*_dendrogram.png", "", "模块分类树png图",0,"211588"],
