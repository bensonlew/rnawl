...
class TfbsPredictWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.dump_tool = self.api.api("medical_transcriptome.tfbs_predict")
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("medical_transcriptome", table="sg_tfbs_predict", main_id=self.option('main_id'),
    ...
    def end(self):
        ...
        result_dir.add_relpath_rules([
            ...
            ["./tf_target_number.xls", "xls", "转录因子靶基因预测统计表", 0],
            ["./tfbs_predict.xls", "xls", "转录因子靶基因预测详情表", 0],
