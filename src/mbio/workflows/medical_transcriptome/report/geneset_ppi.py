...
class GenesetPpiWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self._sheet.output = self._sheet.output.replace('interaction_results', 'interaction_results/05 Advanced_Analysis/06 PPI_Analysis')
        self.inter_dirs = []
    ...
    def end(self):
        ...
        self.inter_dirs = [
            ...
            ["05 Advanced_Analysis/06 PPI_Analysis", "", "蛋白互作网络分析结果目录", 0]
        ]
        result_dir.add_relpath_rules([
            ...
            ["./ppinetwork_topology/ppi.centrality.line.pdf", "txt", "网络中心系统分布图", 0],
            ["./ppinetwork_topology/ppi.degree.line.pdf", "txt", "网络节点度分布图", 0],
            ...
            ["./ppinetwork_topology/PPI_centrality.txt", "txt", "网络中心系数表", 0],
            ["./ppinetwork_topology/PPI_degree_distribution.txt", "txt", "网络节点度统计表", 0],
            ["./ppinetwork_topology/PPI_node_degree.txt", "txt", "网络节点属性表", 0]
        ])
    ...
    def set_db(self):
        ...
        报存分析结果到mongo数据库中
        """
        api_ppinetwork = self.api.api('medical_transcriptome.geneset_ppi')
        ...
        with open(os.path.join(self.output_dir,"ppinetwork_predict/network.json"), "w") as f:
        ...
        api_ppinetwork.update_db_record('sg_geneset_ppi', self.option('ppi_id'), json_dir=network,
                                   status="end")
        print('end insert')
        self.end()
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("medical_transcriptome", table="sg_geneset_ppi", main_id=self.option('ppi_id'),
