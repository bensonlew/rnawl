...
class GenesetIpathWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self._sheet.output = self._sheet.output.replace('interaction_results', 'interaction_results/05 Advanced_Analysis/07 iPath_Analysis')
        self.inter_dirs = []
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("medical_transcriptome", table="sg_geneset_ipath", main_id=self.option('main_table_id'),
    ...
    def end(self):
        ...
        self.inter_dirs = [
            ...
            ["05 Advanced_Analysis/07 iPath_Analysis", "", "iPath代谢通路分析结果目录", 0]
        ]
