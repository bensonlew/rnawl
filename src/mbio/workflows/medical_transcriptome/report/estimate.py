...
class EstimateWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.estimate = self.add_tool("medical_transcriptome.tool.estimate")
        self.tool = self.add_tool("medical_transcriptome.geneset.exp_cluster2gsva")
    ...
    def set_db(self):
        ...
        保存结果表到mongo数据库中
        """
        tool_estimate = self.api.api("medical_transcriptome.tool_estimate")
        # add result info
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        from mbio.workflows.medical_transcriptome.report.estimate import EstimateWorkflow
