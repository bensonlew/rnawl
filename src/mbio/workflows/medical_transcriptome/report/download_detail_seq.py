...
class DownloadDetailSeqWorkflow(Workflow):
    def __init__(self, wsheet_object):
        ...
        self._sheet.output = self._sheet.output.replace('interaction_results',
                                                        'interaction_results/06 Seq_Download')
        self.download = self.add_tool("medical_transcriptome.extract_detail_seq")
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("medical_transcriptome", table="sg_seq_extract", main_id=self.option('main_id'),
