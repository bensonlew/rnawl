...
class StemWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            {'name': 'pheno', 'type': 'infile', 'format': 'medical_transcriptome.common'},
            ...
            {'name': 'detail', 'type': 'outfile', 'format': 'medical_transcriptome.common'},
            {'name': 'cluster', 'type': 'outfile', 'format': 'medical_transcriptome.common'},
            {'name': 'update_info', 'type': 'string', 'default': None},
            {'name': 'group_dict', 'type': 'string'}
        ]
        self.add_option(options)
        self._sheet.output = self._sheet.output.replace('interaction_results',
                                                        'interaction_results/05 Advanced_Analysis/02 Time_series_Analysis')
        self.inter_dirs = []
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("medical_transcriptome", table="sg_stem", main_id=self.option('main_id'),
    ...
    def run_prepare(self):
        ...
        self.prepare = self.add_tool('medical_transcriptome.timeseries.prepare')
        options = {
    ...
    def run_statistics(self):
        ...
        self.statistics = self.add_tool('medical_transcriptome.timeseries.statistics')
        options = {
            'method': self.option('method'),
    ...
    @workfuncdeco
    def set_db(self):
        self.database = self.api.api('medical_transcriptome.stem')
