...
class ExpPcaWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.tool = self.add_tool("medical_transcriptome.exp_pca")
        self.ellipse = None
        ...
        self._sheet.output = self._sheet.output.replace('interaction_results', 'interaction_results/02 Annotation_Express/02 Exp_PCA')
        self.inter_dirs = []
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("medical_transcriptome", table="sg_exp_pca", main_id=self.option('pca_main_id'),
    ...
    def end(self):
        ...
        self.inter_dirs = [
            ...
            ["02 Annotation_Express/02 Exp_PCA", "", "样本间PCA分析", 0]
        ]

        result_dir.add_relpath_rules([
            [".", "", "样本间PCA分析文件", 0, "211068"],
            ['./Explained_variance_ratio.xls', '', '主成分解释表',0,"211523"],
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        from mbio.workflows.medical_transcriptome.report.exp_pca import ExpPcaWorkflow
        from biocluster.wsheet import Sheet
        import random
        data = {
            'id': 'exp_pca_{}_{}'.format(random.randint(1000, 9999), random.randint(1000, 9999)),
            'type': 'workflow',
            'name': 'medical_transcriptome.report.exp_pca',
            'options': {
                'exp_matrix' : '/mnt/ilustre/users/sanger-dev/workspace/20200819/ExpDistribution_tsg_zjx_9406_6478/exp_matrix',
                'group_dict' : r'{"H1581":["H1581_1","H1581_2","H1581_3","H1581_4","H1581_5","H1581_6","H1581_7","H1581_8","H1581_9"],"SNU16":["SNU16_1","SNU16_2","SNU16_3","SNU16_4","SNU16_5","SNU16_6","SNU16_7","SNU16_8","SNU16_9"]}',
                'group_table': '/mnt/ilustre/users/sanger-dev/sg-users/xuxi/group_out.csv',
                'pca_main_id': '5afd30bba4e1af301da5f379',
            }
        }
        wsheet = Sheet(data=data)
        wf =ExpPcaWorkflow(wsheet)
        wf.sheet.id = 'exp_pca'
        wf.sheet.project_sn = 'exp_pca'
