...
class CoxWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            {'name': 'factor_list', 'type': 'infile', 'format': 'medical_transcriptome.common'},
        ...
        self.cox = self.add_tool("medical_transcriptome.tool.cox")
    ...
    def run_cox(self):
        factor_list = list()
        with open(self.option('factor_list').path, 'r') as f:
            for i in f.readlines():
                factor_list.append(i.strip())
        factor_str = ';'.join(factor_list)
        opts = {
            'meta_file': self.option('meta_file'),
    ...
    def set_db(self):
        ...
        tool_cox = self.api.api("medical_transcriptome.tool_cox")
        # # add result info
