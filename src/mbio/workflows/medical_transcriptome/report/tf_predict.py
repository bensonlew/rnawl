...
class TfPredictWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.dump_tool = self.api.api("medical_transcriptome.tf_predict")
    ...
    def get_run_log(self):
        get_run_log = GetRunLog("medical_transcriptome", table="sg_tf_predict", main_id=self.option('main_id'),
    ...
    def end(self):
        ...
        self.inter_dirs = [
            ...
            ["05 Advanced_Analysis/05 TF_Analysis", "", "转录因子分析结果目录", 0]
        ]
