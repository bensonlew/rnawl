...
class ProteinsetEnrichWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.enrich_tool = self.add_tool("itraq_and_tmt.proteinset.go_enrich") if self.option("anno_type") == "go" else self.add_tool("labelfree.proteinset.kegg_rich")
    ...
    def end(self):
        ...
        if self.option("anno_type") == "go":
            ...
            result_dir.add_relpath_rules([
                [".", "", "蛋白集GO富集分析结果文件"],
                ["enrichgo.bar.pdf", "", "kegg富集分析直方图", 0],
                ["enrichgo.bubble.pdf", "", "kegg富集分析气泡图", 0],
                ["enrichgo.bubble2.pdf", "", "kegg富集分析气泡图", 0],
            ])
            ...
            result_dir.add_relpath_rules([
                [".", "", "蛋白集KEGG富集分析结果文件"],
                ["enrichkegg.bar.pdf", "", "kegg富集分析直方图", 0],
                ["enrichkegg.bubble.pdf", "", "kegg富集分析气泡图", 0],
                ["enrichkegg.bubble2.pdf", "", "kegg富集分析气泡图", 0],
            ])
