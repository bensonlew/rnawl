...
class WgcnaModuleWorkflow(Workflow):
    ...
    def set_db(self):
        ...
        保存结果表到mongo数据库中
        """
        dump_tool = self.api.api("dia.wgcna")
    ...
    def chart(self):
        ...
        for ori_filename,filename in [["wgcna.module_stat.column.pdf","num.pdf"],
                                      ["wgcna.mofule_corr.heat_corr.pdf","relate.pdf"],
                                      ["wgcna.module_tree.heat_corr.pdf","modulecluster.pdf"]]:
