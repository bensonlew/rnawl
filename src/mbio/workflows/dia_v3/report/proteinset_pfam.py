...
class ProteinsetPfamWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            {"name": "pfam_info", "type": "infile", "format": "labelfree.common"},
        ...
        self.pfam_stat = self.add_tool("labelfree.export_pfam_stat")
        self._sheet.output = self._sheet.output.replace('interaction_results',
                                                        'interaction_results/5_Proteinset/03_Anno/04_Pfam')
        self.inter_dirs = []
