...
class ProteinsetKeggWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.kegg_class = self.add_tool("itraq_and_tmt.proteinset.kegg_class")
        self._sheet.output = self._sheet.output.replace('interaction_results', 'interaction_results/5_Proteinset/03_Anno/02_KEGG')
        self.inter_dirs = []
    ...
    def set_db(self):
        ...
        if isinstance(record_id, types.StringTypes):
            ...
            self.set_error("main_id参数必须为字符串或者ObjectId类型!", code = "12501401")
