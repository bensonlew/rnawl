...
class ProteinsetIpathWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.ipath = self.add_tool("itraq_and_tmt.proteinset.ipath")
        self._sheet.output = self._sheet.output.replace('interaction_results', 'interaction_results/5_Proteinset/07_Ipath')
        self.inter_dirs = []
    ...
    def set_db(self):
        ...
        if isinstance(record_id, types.StringTypes):
            ...
            self.set_error("main_id参数必须为字符串或者ObjectId类型!", code = "12501301")
