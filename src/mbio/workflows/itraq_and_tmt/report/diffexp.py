...
class DiffexpWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            dict(name="protein_sliced", type="infile", format="itraq_and_tmt.common"),
            # to update sg_status
            {"name": "update_info", "type": "string"},
        ]
        self.add_option(options)
        self.set_options(self._sheet.options())
        self.tool = self.add_tool("itraq_and_tmt.diff")
    ...
    def end(self):
        ...
        df_protein_sliced.drop(["Description", "AAs"], axis=1,inplace=True)
    ...
    def download_s3_file(self, path, to_path):
        ...
        if os.path.exists(to_path):
            ...
            self.set_error('file can not find %s', variables=(path), code = '12501701')
        return to_path
