...
class ProteinAnnotationWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            {"name": "origin_result", "type": "infile", "format": "itraq_and_tmt.common_dir"},
        ...
        self.nr_filter = self.add_tool("itraq_and_tmt.annotation.filter_annot")
        self.swissprot_filter = self.add_tool("itraq_and_tmt.annotation.filter_annot")
        self.cog_filter = self.add_tool("itraq_and_tmt.annotation.filter_annot")
        self.eggnog_filter = self.add_tool("itraq_and_tmt.annotation.filter_annot")
        self.kegg_filter = self.add_tool("itraq_and_tmt.annotation.filter_annot")
        self.pfam_filter = self.add_tool("itraq_and_tmt.annotation.filter_annot")
    ...
    def set_db(self):
        ...
        self.test_api = self.api.api("itraq_and_tmt.protein_annotation")
