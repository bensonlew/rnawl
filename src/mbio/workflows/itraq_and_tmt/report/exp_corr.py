...
class ExpCorrWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        self.tool = self.add_tool("itraq_and_tmt.exp_corr")
    ...
    def chart(self):
        ...
        os.link(pdf_file, self.tool.output_dir + "/SamCorr.pdf")
    ...
    def end(self):
        ...
        self.inter_dirs = [
            ...
            ["2_SampleComp/02_SamCorr", "", "样本相关性热图", 0],
        ]
        result_dir.add_relpath_rules([
            [".", "", "相关性分析结果目录", 0, "220061"],
            ['*.pdf', 'pdf', '相关性热图', 0],
            ['sample_correlation.xls', 'xls', '样本间相关性系数表',0],
            ['expression_matrix.xls', 'txt', '表达矩阵', 0],
        ])
