...
class WgcnaNetworkWorkflow(Workflow):
    ...
    def __init__(self, wsheet_object):
        ...
        options = [
            ...
            dict(name="step3output", type="infile", format='itraq_and_tmt.common_dir'),
            dict(name="step2output", type="infile", format='itraq_and_tmt.common_dir'),
            # to update sg_status
            {"name": "update_info", "type": "string"},
        ]
        self.add_option(options)
        self.set_options(self._sheet.options())
        self.tool = self.add_tool("itraq_and_tmt.wgcna.wgcna_network")
