...
class ReportImportWorkflow(Workflow):
    ...
    def run(self):
        ...
        self.api_pt.import_report_summary_result(self.option("dad_id"), self.option("mom_id"),
                                                 ...
                                                 self.option("report_id"), self.option("postype"))
        self.api_pt.update_report_done(self.option("dad_id"), self.option("father_err_id"), self.option("postype"))
        self.end()
