...
class ErrSiteFiterWorkflow(Workflow):
    def __init__(self, wsheet_object):
        ...
        self.family_analysis = self.add_module("medical.paternity_test_v3.family_analysis")
    ...
    def run(self):
        ...
        """
        self.set_type()
        max_err = self.api_pt.find_err_max(self.option('father_id'))
        if not self.api_pt.is_father(self.option('father_id'), max_err):
    ...
    def upload_target_path(self):
        ...
        if self.config.RGW_ENABLE:
            ...
            transfer.add_upload(self.output_dir + "/", "{}/pt_result_pic/{}/"
                                .format(self.bucket, self.father_err_id_new),
