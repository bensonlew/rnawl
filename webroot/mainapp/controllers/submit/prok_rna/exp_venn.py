...
class ExpVennAction(ProkRNAController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.prok_rna.insert_main_table('sg_exp_venn', main_info)
        ...
        task_name = 'prok_rna.report.exp_venn'
