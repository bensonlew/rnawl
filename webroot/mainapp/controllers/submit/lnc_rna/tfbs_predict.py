...
class TfbsPredictAction(LncRnaController):
    ...
    def __init__(self):
        ...
        self.task_name = 'lnc_rna.report.tfbs_predict'
    ...
    def prepare_workflow_options(self, main_id, collection_name, main_table_name, genome_id):
        ...
        # get motif species
        table_info = self.lnc_rna.get_main_info(self.input_data.tf_predict_id, 'sg_tf_predict', self.input_data.task_id)
        ...
        # prepare to file
        to_files = [
            "lnc_rna.export_geneid2tfid_file(tf_predict_id)",
            "lnc_rna.get_gene_detail(seq2name)",
        ]
        if 'all' not in self.input_data.geneset_id.lower():
            to_files.append("lnc_rna.export_gene_list(geneset_list)")
        if self.input_data.exp_id.lower() != "none":
            options['exp_matrix'] = self.input_data.exp_id+";all"
            to_files.append("lnc_rna.export_geneset_exp_matrix(exp_matrix)",)
        else:
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        args = dict(
            ...
            motifs_user="none",
            motifs_file_id="none",
            tf_selected="ENSG00000119725|ZNF410,ENSG00000141905|NFIC",
            geneset_id="refall",
            ...
            tf_predict_id="5c75fa1017b2bf03fc5c41cf",
            thresh="0.0001",
            qv_thresh="0",
            corr_cutoff="0.5",
            corr_pvalue="0.05",
