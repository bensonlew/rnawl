...
class ExpVennAction(LncRnaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        basic_args += ['type','rna_type'] #201903 rna_type
        # check arg
        ...
        name = "ExpVenn" + '_' + exp_level + '_' + quant_method + '_' + exp_type.upper() + '_'+data.rna_type+'_'
        ...
        main_id = self.lnc_rna.insert_main_table('sg_exp_venn', main_info)
        ...
        task_name = 'lnc_rna.report.exp_venn'
