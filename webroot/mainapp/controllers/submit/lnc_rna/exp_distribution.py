...
class ExpDistributionAction(LncRnaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        basic_args += ['type','rna_type']  # 新增ref, new, all,rna_type
        # check arg
        ...
        name = "ExpDistribution" + '_' + exp_level + '_' + quant_method + '_'+data.rna_type+"_"
        ...
        main_id = self.lnc_rna.insert_main_table('sg_exp_graph', main_info)
        ...
        task_name = 'lnc_rna.report.exp_distribution'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/lnc_rna/exp_distribution "
