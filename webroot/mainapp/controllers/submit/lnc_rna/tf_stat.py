...
class TfStatAction(LncRnaController):
    ...
    def __init__(self):
        ...
        self.expected_args += ['geneset_type']
    ...
    def check_params(self):
        ...
        # do some other check
        main_info = self.lnc_rna.get_main_info(self.input_data.tf_predict_id, 'sg_tf_predict', self.input_data.task_id)
    ...
    def prepare_workflow_options(self, main_id, collection_name, main_table_name):
        ...
        # prepare to file
        # to_files = ["lnc_rna.YOUR_tofile_Func(tofile_Param)", ]
