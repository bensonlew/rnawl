...
class FaprotaxAction(MetaasvController):
    ...
    def POST(self):
        ...
        task_name = 'metaasv.report.faprotax'
        task_type = 'workflow'
        ...
        main_table_id = self.metaasv.insert_main_table('faprotax', mongo_data)

        update_info = {str(main_table_id): 'faprotax'}
        options = {
        ...
        to_file = ["metaasv.export_asv_table_faprotax_by_detail(otu_table)","metaasv.export_group_table_by_detail(group_table)"]
