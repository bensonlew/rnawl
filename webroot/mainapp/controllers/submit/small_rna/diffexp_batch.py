...
class DiffexpBatchAction(SmallRnaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        # stat_cutoff ~ 0.05
        # float(fc) > 1.0
        basic_args.extend(['diff_method', 'fc', 'is_batch'])
        ...
        if data.is_batch == 'False':
            ...
            name = "Diff_batch" + '_' + data.diff_method + '_'
        ...
        task_name = 'small_rna_v2.report.diffexp_batch'
