...
class GenesetBatchAction(SmallRnaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        diff_info = self.small_rna.get_main_info(input_data.diff_id, "sg_diff", input_data.task_id)
        ...
        flag = int(self.small_rna.get_geneset_batch_flag(input_data.task_id))
        ...
        geneset_names = self.small_rna.get_genesets(input_data.task_id, geneset_type, is_use=1)
        ...
        main_id = self.small_rna.insert_main_table('sg_geneset_batch', main_info)
        new_task_id = self.small_rna.get_new_id(input_data.task_id)
        ...
        task_name = 'small_rna_v2.report.geneset_batch'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/small_rna/geneset_batch "
        cmd += "-b http://bcl.tsg.com "
        args = dict(
            task_id="tsg_248824",
            task_type="2",
            submit_location="geneset_batch",
            diff_id='5fb7c9c517b2bf375cb1ead0'
        )
