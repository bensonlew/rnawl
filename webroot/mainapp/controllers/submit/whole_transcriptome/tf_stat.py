...
class TfStatAction(WholeTranscriptomeController):
    ...
    def check_params(self):
        ...
        # do some other check
        main_info = self.whole_transcriptome.get_main_info(self.input_data.tf_predict_id, 'tf_predict',
        ...
        if float(pre_evalue) < float(self.input_data.e_value):
            ...
            info = {'success': False, 'info': "evalue阈值不能大于上次TF预测时使用的阈值%s" % pre_evalue, 'code': 'C2903102',
                    'variables': variables}
            return json.dumps(info)
        '''
    ...
    def pack_params(self):
        ...
        print "input_data_dict id {}".format(input_data_dict)
        params_dict = dict()
    ...
    def prepare_workflow_options(self, main_id, collection_name, main_table_name):
        ...
        # prepare to file
        # to_files = ["whole_transcriptome.YOUR_tofile_Func(tofile_Param)", ]
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/whole_transcriptome/tf_stat "
