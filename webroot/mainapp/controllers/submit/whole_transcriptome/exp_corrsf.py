...
class ExpCorrsfAction(WholeTranscriptomeController):
    ...
    def POST(self):
        ...
        # prepare to file
        to_files = ["whole_transcriptome.geneset.export_geneset_exp_matrix(exp_matrix)",
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        args = dict(
            ...
            group_dict=r'{"control":["C2","C3"],"Acute":["A1","A2"],"Stable":["S1","S3"]}'.replace('"', '\\"'),
            group_id="5dd5152817b2bf7328f25108",
            geneset_id="5da135c217b2bf14e012f744,5db0332a17b2bf3cdfb10639",
            # pvalue="0.05",
            qvalue="0.05",
            cor_cutoff="0.5",
            level="G",
