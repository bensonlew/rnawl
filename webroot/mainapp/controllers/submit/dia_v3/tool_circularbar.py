...
class ToolCircularbarAction(DiaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.dia.insert_main_table('sg_tool_lab_circularbar', main_info)
        ...
        to_files = ["dia_tool.export_circularbar(go_id_level)"]
        task_name = 'dia_v3.report.tool_circularbar'
