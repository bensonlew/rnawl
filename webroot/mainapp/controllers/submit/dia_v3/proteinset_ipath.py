...
class ProteinsetIpathAction(DiaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        task_name = 'dia_v3.report.proteinset_ipath'
        params_json = {
        ...
        main_table_name = 'Proteinset' + table_name + "Ipath_" + datetime.datetime.now().strftime("%Y%m%d_%H%M%S%f")[:-3]
