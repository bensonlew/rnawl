...
class ToolDiffMaAction(DiaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.dia.insert_main_table('sg_tool_lab_diff_ma', main_info)
        ...
        to_files = ["dia_tool.export_diff_ma_plot(diff_id)"]
        task_name = 'dia_v3.report.tool_diff_ma'
