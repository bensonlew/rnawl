...
class ProteinsetSublocAction(DiaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        task_name = 'dia_v3.report.proteinset_subloc'
        params_json = {
        ...
        to_file = [
            'dia.export_subloc_info(subloc_info)',
            'dia.export_protein_list_pfam(proteinset_files)'
        ]

        main_table_name = 'Proteinset_Subloc_' + datetime.datetime.now().strftime("%Y%m%d_%H%M%S%f")[:-3]
        mongo_data = [
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/dia_v3/proteinset_subloc "
