...
class ToolPathwayNetworkAction(DiaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.dia.insert_main_table('sg_tool_lab_pathway_network', main_info)
        ...
        if data.anno_type.lower() == "kegg":
            to_files = ["dia_tool.export_kegg_enrich_table(enrich_id)"]
            task_name = 'dia_v3.report.tool_pathway_network'
        else:
            to_files = ["dia_tool.export_go_enrich_table(enrich_id)"]
            task_name = 'dia_v3.report.tool_pathway_network'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/dia_v3/tool_pathway_network "
        cmd += "-b http://wpm2.sanger.com "
        args = dict(
            task_id="pkkc_iva3g4t9nilj5l4b3b7ans",
            task_type="2",
            submit_location="pathway_network",
            enrich_id="61164722f7689d654266e48b",
            anno_type="KEGG",
            # enrich_id="611b7ab55faea2d7ef205142",
            # anno_type="GO",
