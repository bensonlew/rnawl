...
class GenesetClusterAction(WholeTranscriptomeController):
    ...
    def POST(self):
        ...
        if hasattr(data, "category"):
            options.update({
                "exp_matrix": exp_id + ";" + data.geneset_id + ";" + data.level + ';' + is_rmbe + ";" + data.category
            })
        # if hasattr(data, "way"):
        #     options.update({
        ...
        #     })
        # prepare to file
        to_files = ["whole_transcriptome_v1_1.geneset_analysis.export_geneset_exp_matrix(exp_matrix)",
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/whole_transcriptome_v1_1/geneset_cluster "
