...
class ExpGraphAction(WholeTranscriptomeController):
    ...
    def POST(self):
        data = web.input()
        args = ['task_id', 'submit_location', 'task_type', 'category', 'level', 'kind', 'group_id', 'group_dict', 'exp_id']
        for arg in args:
        ...
        self.set_sheet_data(
            name='whole_transcriptome_v1_1.report.exp_graph',
            options=options,
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        cmd += ' s/whole_transcriptome_v1_1/exp_graph'
        args = {
