...
class CernaAction(WholeTranscriptomeController):
    ...
    def POST(self):
        ...
        basic_args = ["task_id", "miset_id", "target_id", "submit_location", 'task_type',
                      ...
                      'group_dict', 'group_id', 'retain_type', 'exp_id',
                      'mi_min_num'
                      ]
        ...
        exp_dict = self.whole_transcriptome.get_main_info_by_record("exp", level='T',
        ...
        for par in ["miset_id", "target_id", "targetset_id",
                    'micorr_cutoff', 'micorr_pvalue_type', 'micorr_pvalue_cutoff', 'micorr_pvalue_method',
                    'cecorr_cutoff', 'cecorr_pvalue_type', 'cecorr_pvalue_cutoff', 'cecorr_pvalue_method',
                    'group_dict', 'group_id', 'mi_min_num', 'retain_type', 'exp_id']:
            if par == 'group_dict':
        ...
        options = {
            ...
            "cerna_exp": exp_id + ";all" + ";lncRNA,mRNA,circRNA" + ";T" + ';' + is_rmbe,
            "mirna_exp": exp_id + ";" + data.miset_id + ";miRNA" + ";T" + ';' + is_rmbe,
        ...
        to_files = [
            ...
            "whole_transcriptome_v1_1.advance.export_geneset_exp_matrix(cerna_exp)",
            "whole_transcriptome_v1_1.advance.export_geneset_exp_matrix(mirna_exp)",
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/whole_transcriptome_v1_1/cerna "
        ...
        args = dict(
            ...
            exp_id="5f276f5917b2bf22947c588c",
