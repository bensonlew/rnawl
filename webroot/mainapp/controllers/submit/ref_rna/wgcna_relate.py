...
class WgcnaRelateAction(RefRnaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_info = self.ref_rna.get_main_info(data.wgcna_module_id, 'sg_wgcna_module')
        ...
        # prepare to file
        to_files = ["ref_rna.export_wgcna_relate_input(exp_eigengenes)"]

        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'ref_rna.report.wgcna_relate'
