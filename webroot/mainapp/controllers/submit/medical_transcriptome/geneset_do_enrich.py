...
class GenesetDoEnrichAction(MedicalTranscriptomeController):
    def __init__(self):
        super(GenesetDoEnrichAction, self).__init__(instant=False)
    ...
    def POST(self):
        ...
        # table_name = "Do"
        table_name = geneset_info.get('name', 'unknown')  + "_DO"
        collection_name = "sg_geneset_do_enrich"
        ...
        task_info = super(GenesetDoEnrichAction, self).POST()
        task_info['content'] = {
            'ids': {
...
if __name__ == '__main__':
    class TestFunction(unittest.TestCase):
        ...
        def test_this(self):
            ...
            cmd += "s/medical_transcriptome/geneset_do_enrich "
            cmd += "-b http://bcl.tsg.com "
            args = dict(
                submit_location="geneset_do_erich",
                geneset_id="5f45c5e117b2bf77c0eb2283",
