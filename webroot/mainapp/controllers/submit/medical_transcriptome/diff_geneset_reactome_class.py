...
class DiffGenesetReactomeClassAction(MedicalTranscriptomeController):
    def __init__(self):
        super(DiffGenesetReactomeClassAction, self).__init__(instant=False)
    ...
    def POST(self):
        ...
        collection_name = "sg_diff_geneset_reactome_class"
        to_file = [
        ...
        task_info = super(DiffGenesetReactomeClassAction, self).POST()
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/medical_transcriptome/diff_geneset_reactome_class "
        cmd += "-b http://bcl.tsg.com "
        args = dict(
            submit_location="diff_geneset_reactome_class",
            task_type="2",
