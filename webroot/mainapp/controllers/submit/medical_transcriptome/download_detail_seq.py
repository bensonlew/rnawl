...
class DownloadDetailSeqAction(MedicalTranscriptomeController):
    '''
    ...
    def POST(self):
        ...
        geneset_name =self.medical_transcriptome.get_genesetname(task_id=task_id,geneset_id = data.geneset_id)
        ...
        main_id = self.medical_transcriptome.insert_main_table('sg_seq_extract', main_info)
        ...
        to_files = [
            'medical_transcriptome_new.medical_transcriptome.export_gene_list(geneset_extract)'
        ]
        self.set_sheet_data(
            name='medical_transcriptome.report.download_detail_seq',
            options=options,
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        cmd += ' s/medical_transcriptome/download_detail_seq '
        args = {
            'task_id': 'gbnijnfcuslii6rieegpbdgpt5',
            'submit_location': 'extract_seq_detail',
            'task_type': '2',
            'level':'G',
            'geneset_id':"5f9a975817b2bf6c2d69ae31"  ,
