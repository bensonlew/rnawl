...
class GenesetDoClassAction(MedicalTranscriptomeController):
    def __init__(self):
        super(GenesetDoClassAction, self).__init__(instant=False)
    ...
    def POST(self):
        ...
        task_name = 'medical_transcriptome.report.geneset_do'
        params_json = {
        ...
        table_name = "_".join(gn)[:20] +  "_DO"
        collection_name = "sg_geneset_do_class"
        ...
        task_info = super(GenesetDoClassAction, self).POST()
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/medical_transcriptome/geneset_do_class "
