...
class RmatsDiffcompAction(MedicalTranscriptomeController):
    '''
    ...
    def POST(self):
        ...
        for splicing_id in data.main_id.split(','):
            rmats_info = self.medical_transcriptome.get_main_info(splicing_id, 'sg_splicing_rmats', task_id)
        ...
        main_id = self.medical_transcriptome.insert_main_table('sg_splicing_rmats_diffcomp', main_info)
        ...
        to_files = [
            'medical_transcriptome_new.medical_transcriptome.export_rmats_detail_path2base(s3_file_list)'
        ]
        self.set_sheet_data(
