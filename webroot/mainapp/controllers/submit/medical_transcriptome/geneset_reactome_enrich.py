...
class GenesetReactomeEnrichAction(MedicalTranscriptomeController):
    def __init__(self):
        super(GenesetReactomeEnrichAction, self).__init__(instant=False)
    ...
    def POST(self):
        ...
        table_name = geneset_info.get('name', 'unknown')  + "_Reactome"
        # table_name = "Reactome"
        collection_name = "sg_geneset_reactome_enrich"
        ...
        main_table_name = table_name + "_Enrich_" + datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
        ...
        task_info = super(GenesetReactomeEnrichAction, self).POST()
        task_info['content'] = {
            'ids': {
...
if __name__ == '__main__':
    class TestFunction(unittest.TestCase):
        ...
        def test_this(self):
            ...
            cmd += "s/medical_transcriptome/geneset_reactome_enrich "
            cmd += "-b http://bcl.tsg.com "
            args = dict(
                submit_location="geneset_reactome_erich",
