...
class QuantAction(MedicalTranscriptomeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        libtype = self.medical_transcriptome.get_libtype(data.task_id)  # 随机选择一张主表获得libtype
        read_len = self.medical_transcriptome.get_mean_read_len(data.task_id)
        ...
        transcript_main_id = self.medical_transcriptome.insert_main_table('sg_exp', main_info)
        ...
        gene_main_name = name
        gene_main_id = self.medical_transcriptome.insert_main_table('sg_exp', main_info)
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/medical_transcriptome/quant "
