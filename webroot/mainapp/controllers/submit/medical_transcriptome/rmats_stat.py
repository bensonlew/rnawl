...
class RmatsStatAction(MedicalTranscriptomeController):
    '''
    ...
    def POST(self):
        ...
        ctrl, test = self.medical_transcriptome.get_main_info(
        ...
        main_id = self.medical_transcriptome.insert_main_table('sg_splicing_rmats_stats', main_info)
        ...
        to_files = [
            'medical_transcriptome_new.medical_transcriptome.export_rmats_root(root)'
        ]
        self.set_sheet_data(
            name='medical_transcriptome.report.rmats_stat',
            options=options,
