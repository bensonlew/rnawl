...
class ExtractSeqAction(MedicalTranscriptomeController):
    '''
    ...
    def POST(self):
        ...
        main_id = self.medical_transcriptome.insert_main_table('sg_extract', main_info)
        ...
        to_files = [
            'medical_transcriptome_new.medical_transcriptome.export_bam_list(bam_file_list)'
        ]
        self.set_sheet_data(
            name='medical_transcriptome.report.extract_seq',
            options=options,
