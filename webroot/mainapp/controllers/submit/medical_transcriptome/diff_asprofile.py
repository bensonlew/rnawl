...
class DiffAsprofileAction(MedicalTranscriptomeController):
    ...
    def POST(self):
        ...
        main_id = self.medical_transcriptome.insert_main_table('sg_asprofile_diff', main_info)
        ...
        # prepare to file
        task_name = 'medical_transcriptome.report.diff_asprofile'
