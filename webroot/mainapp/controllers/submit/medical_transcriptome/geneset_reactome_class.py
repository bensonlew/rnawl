...
class GenesetReactomeClassAction(MedicalTranscriptomeController):
    def __init__(self):
        super(GenesetReactomeClassAction, self).__init__(instant=False)
    ...
    def POST(self):
        ...
        task_name = 'medical_transcriptome.report.geneset_reactome'
        params_json = {
        ...
        # table_name = "REACTOME_class"
        collection_name = "sg_geneset_reactome_class"
        to_file = [
            'medical_transcriptome_new.geneset_annot.export_reactome_annot(reactome_annot)',
            'medical_transcriptome_new.geneset_annot.export_multi_gene_list(geneset_id)'
        ]
        table_name = "_".join(gn)[:20] +  "_Reactome"
        ...
        task_info = super(GenesetReactomeClassAction, self).POST()
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/medical_transcriptome/geneset_reactome_class "
        cmd += "-b http://bcl.tsg.com "
        args = dict(
            submit_location="geneset_reactome_class",
            task_type="2",
            db_type="medical_transcriptome",
            geneset_id="5f45c5c817b2bf77c0eb227f,5f45c5e117b2bf77c0eb2283",
            geneset_type="G",
