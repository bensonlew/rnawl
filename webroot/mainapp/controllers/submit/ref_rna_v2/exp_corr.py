...
class ExpCorrAction(RefRnaV2Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        basic_args += ['group_id', 'group_dict', 'exp_id', 'exp_level',
                       'corr_method', 'scm', 'scd', 'type','Draw_in_groups']#20190521新增 Draw_in_gropus
        # check arg
        ...
        main_id = self.ref_rna_v2.insert_main_table('sg_exp_corr', main_info)
        ...
        task_name = 'ref_rna_v2.report.exp_corr'
