...
class TfStatAction(RefRnaV2Controller):
    ...
    def check_params(self):
        ...
        # do some other check
        main_info = self.ref_rna_v2.get_main_info(self.input_data.tf_predict_id, 'sg_tf_predict', self.input_data.task_id)
