...
class WgcnaPrepareAction(RefRnaV2Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        exp_info = self.ref_rna_v2.get_main_info(data.exp_id, 'sg_exp', data.task_id)
        ...
        main_id = self.ref_rna_v2.insert_main_table('sg_wgcna_prepare', main_info)
        if data.geneset_id.lower() not in ["all", "refall", "none"]:
            self.ref_rna_v2.insert_geneset_info(data.geneset_id, 'sg_wgcna_prepare', str(main_id))
        ...
        task_name = 'ref_rna_v2.report.wgcna_prepare'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/ref_rna_v2/wgcna_prepare "
