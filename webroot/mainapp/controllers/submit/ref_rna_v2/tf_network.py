...
class TfNetworkAction(RefRnaV2Controller):
    ...
    def __init__(self):
        ...
        self.task_name = 'ref_rna_v2.report.tf_network'
    ...
    def prepare_workflow_options(self, main_id, collection_name, main_table_name):
        ...
        # prepare to file
        to_files = ["ref_rna_v2.export_predict_result(tfbs_predict)"]
