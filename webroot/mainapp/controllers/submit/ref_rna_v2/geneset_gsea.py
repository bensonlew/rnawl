...
class GenesetGseaAction(RefRnaV2Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        to_file.append('ref_rna_v2_new.geneset.export_exp_matrix(matrix)')
        ...
        if data.geneset_source == 'user_defined':
            ...
            annot_info = self.ref_rna_v2.get_main_info_by_record("sg_annotation_stat", task_id=str(data.task_id),  type="origin")
            ...
            to_file.append('ref_rna_v2_new.geneset.export_msigdb_genesets(gmx)')
            ...
            if data.anno_type == "GO":
                ...
                to_file.append('ref_rna_v2_new.geneset.export_anno_genesets(go_list)')
            if data.anno_type == "KEGG":
                ...
                if hasattr(data, "kegg_genesets"):
                    ...
                    w_options['gmx'] += "all"
                to_file.append('ref_rna_v2_new.geneset.export_anno_genesets(gmx)')
        w_options['genes_detail'] = {'task_id': data.task_id, 'type': 'origin'}
        to_file.append('ref_rna_v2_new.geneset.export_genes_detail(genes_detail)')
        ...
        task_name = 'ref_rna_v2.report.geneset_gsea'
    ...
    class TestFunction(unittest.TestCase):
        ...
        def test_this(self):
            ...
            args = dict(
                ...
                exp_id="5cc6947517b2bf5da04ba71e",
                geneset_type="G",
                group_id="5cc6939b17b2bf5da0467bbe",
