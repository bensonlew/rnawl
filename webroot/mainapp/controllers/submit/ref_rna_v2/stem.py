...
class StemAction(RefRnaV2Controller):
    '''
    ...
    def POST(self):
        ...
        main_id = self.ref_rna_v2.insert_main_table('sg_stem', main_info)
        ...
        to_files = [
            'ref_rna_v2.export_stem_geneset(geneset)',
            'ref_rna_v2.export_stem_matrix(matrix)'
        ]
        self.set_sheet_data(
