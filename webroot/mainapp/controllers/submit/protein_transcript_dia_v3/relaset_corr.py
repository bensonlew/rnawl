...
class RelasetCorrAction(ProteinTranscriptDiaV3Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.dia.insert_main_table('sg_relaset_corr', main_info)
        ...
        task_name = 'protein_transcript_dia_v3.report.relaset_corr'
