...
class PrGoEnrichAction(ProteinTranscriptDiaV3Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.dia.insert_main_table('sg_pr_go_enrich', main_info)
        ...
        to_files = ["protein_transcript_dia_v3.export_proteinsets_list(protein_list)",
                    ...
                    "protein_transcript_dia_v3.export_go_list_rna(gene_go)",
                    "protein_transcript_dia_v3.export_go_list_protein(protein_go)",
                    ]
        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'protein_transcript_dia_v3.report.pr_go_enrich'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/protein_transcript_labelfree/pr_go_enrich "
        cmd += "-b http://bcl.tsg.com "
        args = dict(
            task_id="tsg_34739",
            task_type="2",
            submit_location="prgoenrich",
            protein_go_id="5d22a83417b2bf1c689df963",
            rna_go_id="5c218c63a4e1af619b4d43d1",
