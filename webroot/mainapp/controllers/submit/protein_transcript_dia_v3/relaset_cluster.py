...
class RelasetClusterAction(ProteinTranscriptDiaV3Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.dia.insert_main_table('sg_relaset_cluster', main_info)
        ...
        to_files = ["protein_transcript_dia_v3.export_exp_matrix_labelfree(protein_matrix)",
                    "protein_transcript_dia_v3.export_relaset_list(relaset_list)",
                    "protein_transcript_dia_v3.export_rna_protein_group(group)",
                    ]
        ...
        task_name = 'protein_transcript_dia_v3.report.relaset_cluster'
        ...
        # 更新基因集的使用信息
        self.dia.insert_relaset_info(data.relaset_id, name, str(main_id))
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/protein_transcript_labelfree/relaset_cluster "
        ...
        args = dict(
            ...
            protein_group_dict=r'{"F":["F_1","F_2","F_3"],"S":["S_1","S_2","S_3"]}'.replace(
                '"', '\\"'),
            rna_group_id='5c218d70a4e1af619b59ed03',
