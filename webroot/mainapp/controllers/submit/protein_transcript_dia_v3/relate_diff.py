...
class RelateDiffAction(ProteinTranscriptDiaV3Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.dia.insert_main_table('sg_p2g_diff', main_info)
        ...
        # prepare to file
        to_files = ["protein_transcript_dia_v3.export_diff_labelfree(diff_protein)",
                    "protein_transcript_dia_v3.export_diff_rna(diff_rna)",
                    "protein_transcript_dia_v3.export_relation_tab(relation_tab)",
                    "protein_transcript_dia_v3.export_fc_info(fc)"
                    ]

                # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'protein_transcript_dia_v3.report.relate_diff'
