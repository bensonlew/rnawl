...
class PrKeggEnrichClusterAction(ProteinTranscriptDiaV3Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.dia.insert_main_table('sg_pr_kegg_enrich_cluster', main_info)
        ...
        task_name = 'protein_transcript_dia_v3.report.pr_kegg_enrich_cluster'
