...
class PrGoEnrichClusterAction(ProteinTranscriptDiaV3Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.dia.insert_main_table('sg_pr_go_enrich_cluster', main_info)
        ...
        task_name = 'protein_transcript_dia_v3.report.pr_go_enrich_cluster'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/protein_transcript_labelfree/pr_go_enrich_cluster "
