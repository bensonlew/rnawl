...
class ToolCircularHeatmapAction(LabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_tool_lab_circular_heatmap', main_info)
        ...
        to_files = ["labelfree_tool.export_proteinset_exp(metab_table)"]
        task_name = 'labelfree.report.tool_circular_heatmap'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/labelfree/tool_circular_heatmap "
        cmd += "-b http://wpm2.sanger.com "
        args = dict(
            task_id="bjhm_o87j9vhcn9n273gl08apo3",
            task_type="2",
            submit_location="CircularHeatmap",
            group_dict=r'{"Z": ["Z2", "Z4", "Z6"], "M": ["M2", "M3", "M6"], "HG": ["HG2", "HG5", "HG6"]}'.replace('"', '\\"'),
            proteinset_id='61114eccbf2ed0d13057e562',
