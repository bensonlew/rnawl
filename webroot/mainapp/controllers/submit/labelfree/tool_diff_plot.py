...
class ToolDiffPlotAction(LabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_tool_lab_diff_plot', main_info)
        ...
        to_files = ["labelfree_tool.export_diff_plot(diff_id)"]
        task_name = 'labelfree.report.tool_diff_plot'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/labelfree/tool_diff_plot "
