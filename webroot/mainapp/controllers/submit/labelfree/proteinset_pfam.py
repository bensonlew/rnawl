...
class ProteinsetPfamAction(LabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        task_name = 'labelfree.report.proteinset_pfam'
        params_json = {
        ...
        to_file = [
            'labelfree.export_pfam_info(pfam_info)',
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/labelfree/proteinset_pfam "
