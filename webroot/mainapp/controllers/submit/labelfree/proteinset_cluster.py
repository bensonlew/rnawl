...
class ProteinsetClusterAction(LabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_proteinset_cluster', main_info)
        ...
        task_name = 'labelfree.report.proteinset_cluster'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/labelfree/proteinset_cluster "
