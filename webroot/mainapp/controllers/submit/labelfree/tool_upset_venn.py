...
class ToolUpsetVennAction(LabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_tool_lab_upset_venn', main_info)
        ...
        to_files = ["labelfree_tool.export_upset_venn(upset)"]
        task_name = 'labelfree.report.tool_upset_venn'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/labelfree/tool_upset_venn "
        cmd += "-b http://wpm2.sanger.com "
        args = dict(
            task_id="0rse_hcqqod8tbr2i0tqa596s0a",
            task_type="2",
            submit_location="GenesetVenn",
            proteinset_id="610ba8d70bf89ea8f90095c0,610ba8d70bf89ea8f90095be,610ba8d70bf89ea8f90095bc,610ba8d70bf89ea8f90095ba",
