...
class PrGoEnrichClusterAction(ProteinTranscriptLabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_pr_go_enrich_cluster', main_info)
        ...
        task_name = 'protein_transcript_labelfree.report.pr_go_enrich_cluster'
