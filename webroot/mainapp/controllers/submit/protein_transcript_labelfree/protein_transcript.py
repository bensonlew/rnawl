...
class ProteinTranscriptAction(ProteinTranscriptLabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        data = web.input()
        print("controller input web.input data: " + str(data))
        ...
        main_info = dict(
            ...
            desc='protein_transcript_labelfree_analyse',
            status="start",
        ...
        main_id = self.labelfree.insert_main_table('sg_p2g_relationship', main_info)
        ...
        if self.rna_type == 'whole_transcriptome':
            ...
            to_file_list.append("protein_transcript_labelfree.export_exp_matrix_whole_transcriptome(rna_matrix)")
        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'protein_transcript_labelfree.protein_transcript'
