...
class PrGoClassAction(ProteinTranscriptLabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_pr_go_class', main_info)
        ...
        # prepare to file
        to_files = ["protein_transcript_labelfree.export_go_protein(protein_go)",
                    "protein_transcript_labelfree.export_go_rna(gene_go)",
                    ]
        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'protein_transcript_labelfree.report.pr_go_class'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/protein_transcript_labelfree/pr_go_class "
