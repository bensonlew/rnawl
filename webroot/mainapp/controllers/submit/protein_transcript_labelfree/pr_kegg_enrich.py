...
class PrKeggEnrichAction(ProteinTranscriptLabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_pr_kegg_enrich', main_info)
        ...
        task_name = 'protein_transcript_labelfree.report.pr_kegg_enrich'
