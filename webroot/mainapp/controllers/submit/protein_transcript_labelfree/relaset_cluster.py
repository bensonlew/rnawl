...
class RelasetClusterAction(ProteinTranscriptLabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_relaset_cluster', main_info)
        ...
        task_name = 'protein_transcript_labelfree.report.relaset_cluster'
