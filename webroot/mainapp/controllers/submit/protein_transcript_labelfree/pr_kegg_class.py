...
class PrKeggClassAction(ProteinTranscriptLabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_pr_kegg_class', main_info)
        ...
        # prepare to file
        to_files = ["protein_transcript_labelfree.export_add_info_protein(add_info_protein)",
                    "protein_transcript_labelfree.export_add_info_rna(add_info_rna)",
                    "protein_transcript_labelfree.export_kegg_table_protein(protein_kegg_table)",
                    "protein_transcript_labelfree.export_kegg_table_rna(gene_kegg_table)",
                    "protein_transcript_labelfree.export_kegg_level_table_protein(protein_kegg_level_table)",
                    "protein_transcript_labelfree.export_kegg_level_table_rna(gene_kegg_level_table)",
                    "protein_transcript_labelfree.export_genepro_list(pr_list)",
                    ]
        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'protein_transcript_labelfree.report.pr_kegg_class'
