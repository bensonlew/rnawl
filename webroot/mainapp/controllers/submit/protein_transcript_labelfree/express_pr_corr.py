...
class ExpressPrCorrAction(ProteinTranscriptLabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_express_pr_corr', main_info)
        ...
        to_files = ["protein_transcript_labelfree.export_exp_matrix_labelfree(protein_matrix)",
                    "protein_transcript_labelfree.export_proteinset_list(proteinset_list)",
                    "protein_transcript_labelfree.export_geneset_list(geneset_list)",
                    "protein_transcript_labelfree.export_rna_group(group_rna)",
                    "protein_transcript_labelfree.export_protein_group(group_protein)",
                    ]
        ...
        task_name = 'protein_transcript_labelfree.report.express_pr_corr'
