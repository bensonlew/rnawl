...
class DiffexpBatchNewAction(DenovoRnaV2Controller):
    def __init__(self):
        super(DiffexpBatchNewAction, self).__init__(instant=False)
    ...
    def POST(self):
        ...
        task_name = 'denovo_rna_v3.report.diffexp_batch_new'
        ...
        # 运行workflow 并传回参数
        task_info = super(DiffexpBatchNewAction, self).POST()
        task_info['content'] = {
            'ids': {
                'id': str(main_id),
                'name': name
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/denovo_rna_v3/diffexp_batch_new "
