...
class ToolUpsetVennAction(DenovoRnaV2Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.denovo_rna_v2.insert_main_table('sg_tool_lab_upset_venn', main_info)
        ...
        to_files = ["denovo_rna_tool.export_upset_venn(upset)"]
        task_name = 'denovo_rna_v3.report.tool_upset_venn'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/denovo_rna_v3/tool_upset_venn "
        cmd += "-b http://wpm2.sanger.com "
        args = dict(
            task_id="rajc_c10bl8e4ckb09i7k62btsp",
            task_type="2",
            submit_location="GenesetVenn",
            geneset_id="60c2280c17b2bf336a8395b4,60c2280c17b2bf336a8395b2,60c2280c17b2bf336a8395b0,60c2278c17b2bf336a7a1cbc",
