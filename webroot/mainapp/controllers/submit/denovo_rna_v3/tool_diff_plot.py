...
class ToolDiffPlotAction(DenovoRnaV2Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.denovo_rna_v2.insert_main_table('sg_tool_lab_diff_plot', main_info)
        ...
        to_files = ["denovo_rna_tool.export_diff_plot(diff_id)"]
        task_name = 'denovo_rna_v3.report.tool_diff_plot'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/denovo_rna_v3/tool_diff_plot "
        cmd += "-b http://wpm2.sanger.com "
        args = dict(
            task_id="ra19_7o7s7oje3p4sjmmnpuphoi",
            task_type="2",
            submit_location="GenesetVenn",
            diff_id="6107e68d71f5244e16ae9e4b",
            compare="TTCB|TTJ",
            tool_type='diff_plot'
