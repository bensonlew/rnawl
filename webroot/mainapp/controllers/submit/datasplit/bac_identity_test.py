...
class BacIdentityTestAction(BacidentityController):
    """
    菌鉴流程接口,测试机投递任务接口，
    ...
    def POST(self):
        ...
        self.set_sheet_data(name="tool_lab.bac_identity_test", options=options, table_id=data.tid, seq_number="bac_identity", module_type="workflow")
        task_info = super(BacIdentityTestAction, self).POST()
