...
class ProteinTranscriptAction(ProteinTranscriptController):
    def __init__(self):
    ...
    def POST(self):
        data = web.input()
        print("protein_transcript controller input data:\n" + str(data))
...
# 根据前端传入的xml解析出rna项目调用的workflow脚本，进而确定出rna来源于那种类型的项目
        print "self.rna_type is :"+str(self.rna_type)
        ...
        main_info = dict(
            ...
            desc='protein_transcript_analyse',
            status="start",
        ...
        main_id = self.itraq_tmt.insert_main_table('sg_p2g_relationship', main_info)
        ...
        if self.rna_type == 'whole_transcriptome':
            ...
            to_file_list.append("protein_transcript.export_exp_matrix_whole_transcriptome(rna_matrix)")
        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件

        task_name = 'protein_transcript.protein_transcript'
...
"""<workflow><member_id>m_188</member_id><member_type>1</member_type><cmd_id>172</cmd_id><project_sn>188_5bc7e83458246</project_sn><task_id>tsg_32492</task_id><bucket>rerewrweset</bucket><version>2</version><stage><id>cmd_172_1539829436</id><name>itraq_and_tmt.itraqtmt</name><type>workflow</type><parameters><itraq_or_tmt>itraq</itraq_or_tmt><protein type='sanger' format='itraq_and_tmt.common' alias='protein.txt'>s3://commonbucket/files/m_188/188_5bc7e83458246/itraq_file_test/c7bb9121480dd04870f92283288a5428.txt</protein><psm type='sanger' format='itraq_and_tmt.common' alias='psm.txt'>s3://commonbucket/files/m_188/188_5bc7e83458246/itraq_file_test/db2cdfe209923650d8745b714c966749.txt</psm><peptide type='sanger' format='itraq_and_tmt.common' alias='peptide.txt'>s3://commonbucket/files/m_188/188_5bc7e83458246/itraq_file_test/8dc59255b3ddd8d96a2263938bbe6d31.txt</peptide><protein_information type='sanger' format='itraq_and_tmt.common' alias='Protein_information.xls'>s3://commonbucket/files/m_188/188_5bc7e83458246/itraq_file_test/23e105d3fc9582f8337392e701cf3662.xls</protein_information><ratio_exp type='sanger' format='itraq_and_tmt.ratio_exp' alias='exp.txt'>s3://commonbucket/files/m_188/188_5bc7e83458246/itraq_file_test/99065cf9f137f0dff598eb1059fac9d8.txt</ratio_exp><protein_fasta type='sanger' format='itraq_and_tmt.common' alias='DB.fasta'>s3://commonbucket/files/m_188/188_5bc7e83458246/itraq_file_test/6ccd75b599e6e51ee3f44afd69859e48.fasta</protein_fasta><protein_group type='sanger' format='itraq_and_tmt.group_table' alias='group.txt'>s3://commonbucket/files/m_188/188_5bc7e83458246/itraq_file_test/10b0a63fff691f7c05a74f2e27aa07f8.txt</protein_group><protein_control type='sanger' format='itraq_and_tmt.compare_table' alias='control.txt'>s3://commonbucket/files/m_188/188_5bc7e83458246/itraq_file_test/6c090453c1946032e55633f17e4336df.txt</protein_control><go_evalue>1e-5</go_evalue><go_identity>0.98</go_identity><kegg_class>All</kegg_class><kegg_org></kegg_org><kegg_evalue>1e-5</kegg_evalue><kegg_identity>0.98</kegg_identity><sub_loc>Animal</sub_loc><pfam_evalue>1e-5</pfam_evalue><method_type>t.test</method_type><correct_method></correct_method><pvalue>0.05</pvalue><fc_up>1.2</fc_up><fc_down>0.83</fc_down><sam_analysis>True</sam_analysis><ppi_category>All</ppi_category><ppi_species></ppi_species><data_source>Uniprot</data_source><ref_set>True</ref_set></parameters></stage></workflow>
"""
