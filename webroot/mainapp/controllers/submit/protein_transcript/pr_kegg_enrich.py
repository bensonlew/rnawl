...
class PrKeggEnrichAction(ProteinTranscriptController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.itraq_tmt.insert_main_table('sg_pr_kegg_enrich', main_info)
        ...
        to_files = ["protein_transcript.export_proteinsets_list(protein_list)",
                    ...
                    "protein_transcript.export_kegg_table_rna(gene_kegg)",
                    "protein_transcript.export_add_info_rna(gene_info)",
                    "protein_transcript.export_kegg_table_protein(protein_kegg)",
                    "protein_transcript.export_add_info_protein(protein_info)",
                    ]
        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'protein_transcript.report.pr_kegg_enrich'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/protein_transcript/pr_kegg_enrich "
