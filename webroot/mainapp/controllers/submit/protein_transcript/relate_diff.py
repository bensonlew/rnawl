...
class RelateDiffAction(ProteinTranscriptController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.itraq_tmt.insert_main_table('sg_p2g_diff', main_info)
        ...
        # prepare to file
        to_files = ["protein_transcript.export_diff_itraq(diff_protein)",
                    "protein_transcript.export_diff_rna(diff_rna)",
                    "protein_transcript.export_relation_tab(relation_tab)",
                    "protein_transcript.export_fc_info(fc)"
                    ]

                # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'protein_transcript.report.relate_diff'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/protein_transcript/relate_diff "
        ...
        args = dict(
            ...
            gene_compare_group="W|M",
            protein_compare_group="Mutant|Wild_type",
            gene_diff_id="5ff775e5ec02cc0b1b91e6ea",
            protein_diff_id="6010d2c6f6b9e46cb0842866",
            species="9606",
            combine_score = "50",
            taxon = "All"
        )
