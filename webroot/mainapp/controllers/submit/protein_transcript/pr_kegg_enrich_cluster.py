...
class PrKeggEnrichClusterAction(ProteinTranscriptController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.itraq_tmt.insert_main_table('sg_pr_kegg_enrich_cluster', main_info)
        ...
        task_name = 'protein_transcript.report.pr_kegg_enrich_cluster'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/protein_transcript/pr_kegg_enrich_cluster "
