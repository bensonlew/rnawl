...
from mainapp.models.mongo.denovo_rna_v2 import *
from mbio.api.to_file.denovo_rna_v2 import *
from bson.objectid import ObjectId

class BatchAction(DenovoRnaV2Controller):
    ...
    def POST(self):
        ...
        main_id_exp = self.denovo_rna_v2.insert_main_table('sg_exp', main_info_exp)

        name = 'exp_batch_{}'.format(time_now.strftime('%Y%m%d_%H%M%S'))
        task_info = self.denovo_rna_v2.get_task_info(task_id=data.task_id)
        main_info_batch = {
            'task_id': data.task_id,
        ...
        main_id_batch = self.denovo_rna_v2.insert_main_table('sg_exp_batch', main_info_batch)
        # new_task_id = self.denovo_rna_v2.get_new_id(data.task_id)
        ...
        #     })
        # prepare to file
        to_files = ["denovo_rna_v3.export_exp_batch_matrix(exp_matrix)",
                    "denovo_rna_v3.export_group_detail(group_table)",
                    "denovo_rna_v3.export_exp_other_matrix(exp_other)"
                    ]
        task_name = 'denovo_rna_v3.report.batch'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        args = dict(
            ...
            exp_level='T',
            exp_id="5f19499b17b2bf38c7384066",
            has_batch="True",
            batch_matrix='/mnt/ilustre/users/sanger-dev/sg-users/zoujiaxun/denovo_rna_v2/batch/batch.txt',
            batch_method='combat'
