...
class DownloadDetailSeqAction(DenovoRnaV2Controller):
    '''
    ...
    def POST(self):
        ...
        main_id = self.denovo_rna_v2.insert_main_table('sg_seq_extract', main_info)
        ...
        to_files = [
            'denovo_rna_v2_new.geneset.export_gene_list(geneset_extract)'
        ]
        self.set_sheet_data(
            name='denovo_rna_v2.report.download_detail_seq',
            options=options,
...
class TestFunction(unittest.TestCase):
    ...
    def test(self):
        ...
        cmd += ' s/denovo_rna_v2/download_detail_seq '
        args = {
            'task_id': 'riel_fsee07fh35n4i3d4gn1oqd',
            'submit_location': 'extract_seq_detail',
            'task_type': '2',
            'level':'G',
            'geneset_id':"60b8337417b2bf0e889c355a",
