...
class ToolDiffRadarAction(ItraqTmtController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.itraq_tmt.insert_main_table('sg_tool_lab_diff_radar', main_info)
        ...
        to_files = ["itraq_tmt_tool.export_diff_radar_plot(diff_id)"]
        task_name = 'itraq_and_tmt.report.tool_diff_radar'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/itraq_and_tmt/tool_diff_radar "
        ...
        args = dict(
            ...
            geneset_id = "60f4e7c044de8cc135d096dc"
