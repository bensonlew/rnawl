...
class WgcnaRelateAction(ItraqTmtController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_info = self.itraq_tmt.get_main_info(data.wgcna_module_id, 'sg_wgcna_module', data.task_id)
        ...
        module_info = self.itraq_tmt.get_main_info_by_record('sg_wgcna_module', main_id=wgcna_module_id, task_id=data.task_id)
        ...
        main_id = self.itraq_tmt.insert_main_table('sg_wgcna_relate', main_info)
        ...
        # prepare to file
        to_files = ["itraq_tmt.export_wgcna_relate_input(exp_eigengenes)"]

        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'itraq_and_tmt.report.wgcna_relate'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/itraq_and_tmt/wgcna_relate "
