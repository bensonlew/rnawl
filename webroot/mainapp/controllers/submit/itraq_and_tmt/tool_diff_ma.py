...
class ToolDiffMaAction(ItraqTmtController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.itraq_tmt.insert_main_table('sg_tool_lab_diff_ma', main_info)
        ...
        to_files = ["itraq_tmt_tool.export_diff_ma_plot(diff_id)"]
        task_name = 'itraq_and_tmt.report.tool_diff_ma'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/itraq_and_tmt/tool_diff_ma "
