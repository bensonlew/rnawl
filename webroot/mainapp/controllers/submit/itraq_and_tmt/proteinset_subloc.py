...
class ProteinsetSublocAction(ItraqTmtController):
    def __init__(self):
    ...
    def POST(self):
        ...
        task_name = 'itraq_and_tmt.report.proteinset_subloc'
        params_json = {
        ...
        to_file = [
            'itraq_tmt.export_subloc_info(subloc_info)',
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/itraq_and_tmt/proteinset_subloc "
