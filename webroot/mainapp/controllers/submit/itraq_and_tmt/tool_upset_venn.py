...
class ToolUpsetVennAction(ItraqTmtController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.itraq_tmt.insert_main_table('sg_tool_lab_upset_venn', main_info)
        ...
        to_files = ["itraq_tmt_tool.export_upset_venn(upset)"]
        task_name = 'itraq_and_tmt.report.tool_upset_venn'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/itraq_and_tmt/tool_upset_venn "
        cmd += "-b http://wpm2.sanger.com "
        args = dict(
            task_id="jssn_svfguokp3g35cbuue5v31s",
            task_type="2",
            submit_location="GenesetVenn",
            proteinset_id="60f52cc5a511db2424dda5e1,60f52cc5a511db2424dda5df,60f52cc5a511db2424dda5dd,60f52cc5a511db2424dda5db",
