...
class ToolCircularbarAction(ItraqTmtController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.itraq_tmt.insert_main_table('sg_tool_lab_circularbar', main_info)
        ...
        to_files = ["itraq_tmt_tool.export_circularbar(go_id_level)"]
        task_name = 'itraq_and_tmt.report.tool_circularbar'
