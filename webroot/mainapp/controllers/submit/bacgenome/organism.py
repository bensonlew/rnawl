...
class OrganismAction(BacgenomeController):
    def __init__(self):
        super(OrganismAction, self).__init__(instant=False)
    ...
    def POST(self):
        ...
        task_name = 'bacgenome.report.organism'
        ...
        main_table_name = data.sample + "_" + data.sof_type + '_' + 'Organism_' + datetime.datetime.now().strftime("%Y%m%d_%H%M%S%f")[:-3]
        update_info = {}
        mongo_data = [
        ...
        main_id = self.bacgenome.insert_main_table('organism', mongo_data)
        self.bacgenome.insert_main_table_new("organism", str(main_id), {"main_id": main_id})
        update_info[str(main_id)] = 'organism'
        options = {
            'samp': data.sample,
        ...
        self.set_sheet_data(name=task_name,
                            ...
                            params=params,
                            to_file=to_file)
        task_info = super(OrganismAction, self).POST()
