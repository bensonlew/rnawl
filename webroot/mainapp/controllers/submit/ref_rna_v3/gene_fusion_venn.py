...
class GeneFusionVennAction(RefRnaV2Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.ref_rna_v2.insert_main_table('sg_gene_fusion_venn', main_info)
        ...
        # prepare to file
        to_files = ["ref_rna_v3.export_fusion_matrix(fusion_matrix)",
                    'ref_rna_v2.export_group(group)']


        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'ref_rna_v3.report.fusion_venn'
