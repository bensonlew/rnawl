...
class RmatsModelAction(RefRnaV2Controller):
    ...
    def POST(self):
        ...
        self.ref_rna_v2.delete_main_table('sg_splicing_rmats_model', data.task_id)
        task_id = data.task_id
        task_info = self.ref_rna_v2.get_task_info(task_id=task_id)
        project_sn = task_info['project_sn']
        time_now = datetime.datetime.now()
        rmats_info = self.ref_rna_v2.get_main_info(data.splicing_id, 'sg_splicing_rmats', task_id)
        ...
        main_id = self.ref_rna_v2.insert_main_table('sg_splicing_rmats_model', main_info)
