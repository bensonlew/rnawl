...
class DiffexpBatchAction(RefRnaV2Controller):
    ...
    def POST(self):
        ...
        elif list(set(group_size))[0] == 1 and list(set(group_size))[1] >= 2:
            if data.diff_method == "DESeq2":
                success.append('If some groups have biological replicates and some groups no, please select edgeR or limma')
        # elif group_size[0] >= 2:
        ...
        task_name = 'ref_rna_v3.report.diffexp_batch'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "s/ref_rna_v3/diffexp_batch "
