...
class GeneFusionAction(RefRnaV2Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        raw_group_id =self.ref_rna_v2.get_rawgroup_id(task_id=data.task_id)
        ...
        main_id = self.ref_rna_v2.insert_main_table('sg_gene_fusion', main_info)
        ...
        task_name = 'ref_rna_v3.report.gene_fusion'
