...
class GenesetBatchAction(RefRnaV2Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        diff_info = self.ref_rna_v2.get_main_info(input_data.diff_id, "sg_diff", input_data.task_id)
        ...
        flag = int(self.ref_rna_v2.get_geneset_batch_flag(input_data.task_id))
        ...
        geneset_names = self.ref_rna_v2.get_genesets(input_data.task_id, geneset_type, is_use=1)
        ...
        main_id = self.ref_rna_v2.insert_main_table('sg_geneset_batch', main_info)
        new_task_id = self.ref_rna_v2.get_new_id(input_data.task_id)
        ...
        task_name = 'ref_rna_v3.report.geneset_batch'
