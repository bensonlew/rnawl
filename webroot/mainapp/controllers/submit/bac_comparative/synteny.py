...
class SyntenyAction(BacComparativeController):
    def __init__(self, bind_object=None, instant=False):
        super(SyntenyAction, self).__init__(bind_object, instant)
        self._data = None
        self.wf = 'bac_comp_genome.report.mummer'
        self.main_table = 'synteny'

    def check_opts(self):
        data = self._data
        opts = ['mummer', 'samples', 'ref', 'seq_dir']
        for opt in opts:
    ...
    def POST(self):
        ...
        task_info = super(SyntenyAction, self).POST()
...
if __name__ == '__main__':
    ...
    opt_dict = {
                    ...
                    'samples': 'GCF_000007685.1,GCF_000216235.1',
                    'task_id': 'tsg_36106',
                    'submit_location': 'synteny'
                    }
    n = []
    d = []
