...
class CazyDiffAction(CogDiffAction):
    def __init__(self, bind_object=None):
        super(CazyDiffAction, self).__init__(bind_object)
        self.main_table = 'cazy_diff'
        self.functiontype = 'CAZY'
...
if __name__ == '__main__':
    ...
    opt_dict = dict(
        ...
        groups='ALL',
        annotable="/mnt/ilustre/users/sanger-dev/sg-users/xieshichang/coding/cbac/test/a/cazy.annot.xls",
        test='anova',
        testtype='two.sided',
        level='Family',
        submit_location='cazy_diff',
        type='group',
        norm='T'
    )
    ...
    api = 's/bac_comparative/cazy_diff'
