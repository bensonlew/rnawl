...
class BugbaseAction(MetaController):
    ...
    def POST(self):
        ...
        main_table_id = self.meta.insert_main_table('sg_bugbase', mongo_data)

        update_info = {str(main_table_id): 'sg_bugbase'}
        options = {
        ...
        to_file = ["meta.export_otu_table(otu_table)","meta.export_group_table_by_detail(group_table)","meta.export_otu_seqs(otu_fasta)"]
