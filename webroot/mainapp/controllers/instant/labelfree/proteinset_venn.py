...
class ProteinsetVennAction(LabelfreeController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.labelfree.insert_main_table('sg_proteinset_venn', main_info)
        ...
        task_name = 'labelfree.report.proteinset_venn'
        to_file = ''
