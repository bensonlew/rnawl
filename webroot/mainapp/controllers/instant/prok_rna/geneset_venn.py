...
class GenesetVennAction(ProkRNAController):
    def __init__(self):
    ...
    def POST(self):
        ...
        main_id = self.prok_rna.insert_main_table('sg_geneset_venn', main_info)
        ...
        task_name = 'prok_rna.report.geneset_venn'
        ...
        # 更新基因集的使用信息
        self.prok_rna.insert_geneset_info(data.geneset_id, 'sg_geneset_venn', str(main_id))
