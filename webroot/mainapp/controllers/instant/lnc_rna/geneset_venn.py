...
class GenesetVennAction(LncRnaController):
    def __init__(self):
    ...
    def POST(self):
        ...
        # 参数检测
        basic_args = ["task_id", "submit_location", "task_type", "geneset_ids", "gene_type", "geneset_type"]
        ...
        desc = "geneset venn main table created at {}".format(str_time)
        name = "Geneset_venn_{}_{}".format(data.gene_type, str_time)

        # 通过主表sg_task获取项目等信息
        task_id = data.task_id
        project_sn = self.lnc_rna.get_task_info(task_id=task_id)["project_sn"]
        ...
        main_id = self.lnc_rna.insert_main_table("sg_geneset_venn", main_info)

        # work_flow import 路径
        workflow_module_path = "lnc_rna.report.geneset_venn"
        ...
        # 设置sheet参数对象
        self.set_sheet_data(name=workflow_module_path,
                            options=options,
        ...
        # geneset_id, col_name, col_id
        self.lnc_rna.insert_geneset_info(geneset_id=str(data.geneset_ids),
    ...
    class TestFunction(unittest.TestCase):
        ...
        def test_this(self):
            ...
            args = dict(
                ...
                gene_type="T",  # 转录本
                geneset_type="lncRNA",
                geneset_ids="5c73968317b2bf6ef67623e7,5c7c8b4217b2bf31caa1ac3c",
            )
