...
class CopyDemoAction(Base):
    ...
    def POST(self):
        ...
        if data.type == "ref_rna_v2":
            ...
            info = {"success": False, "info": "项目类型type：%s不合法!" % data.type, 'code': 'C2900102', 'variables': variables}
        ...
        try:
            ...
            return json.dumps({"success": False, "info": "运行出错: %s" % filter_error_info(str(e)), 'code': 'C2900103', 'variables': variables})
