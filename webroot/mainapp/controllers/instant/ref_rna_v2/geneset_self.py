...
class GenesetSelfAction(RefRnaV2Controller):
    def __init__(self):
    ...
    def POST(self):
        ...
        exp_info = self.ref_rna_v2.get_task_info(task_id=input_data.task_id)
        ...
        main_id = self.ref_rna_v2.insert_main_table('sg_geneset', main_info)
        ...
        # prepare to file
        to_files = ["ref_rna_v2.export_geneset_from_query(genes)"]

        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'ref_rna_v2.report.geneset_self'
