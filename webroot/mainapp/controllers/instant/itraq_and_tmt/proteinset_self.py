...
class ProteinsetSelfAction(ItraqTmtController):
    def __init__(self):
    ...
    def POST(self):
        ...
        task_info = self.itraq_tmt.get_task_info(task_id=input_data.task_id)
        ...
        main_id = self.itraq_tmt.insert_main_table('sg_proteinset', main_info)
        ...
        # prepare to file
        to_files = ["itraq_tmt.export_proteinset_from_query(proteins)"]

        # 把参数交给workflow运行相应的tool， 其中to_file用于准备tool的输入文件
        task_name = 'itraq_and_tmt.report.proteinset_self'
...
class TestFunction(unittest.TestCase):
    ...
    def test_this(self):
        ...
        cmd += "i/itraq_tmt/proteinset_self "
        ...
        args = dict(
            ...
            name="protein_ff",
            trait_path='/mnt/ilustre/users/sanger-dev/sg-users/fengyitong/itraq_tmt_dia/proteinset_up.list',
            file_id='123454'
        )
