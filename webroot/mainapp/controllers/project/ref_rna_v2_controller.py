...
class RefRnaV2Controller(Base):
    def __init__(self, bind_object=None, instant=False, ):
        super(RefRnaV2Controller, self).__init__(bind_object)
    ...
    def _update_status_api(self):
        ...
        if client == 'client01':
            return 'ref_rna_v2.update_status'
        else:
            return 'ref_rna_v2.tupdate_status'
    ...
    def set_sheet_data(self, name, options, main_table_name, task_id, project_sn,
        ...
        self._sheet_data = {
            ...
            'db_type': 'ref_rna_v2',  # 需要根据自己连接的哪个数据库来修改实际的名字
    ...
    def _create_output_dir(self, task_id, main_table_name):
        data = web.input()
        task_info = self.ref_rna_v2.get_task_info(task_id)
        config = Config()
