...
from mainapp.libs.mc import MemcacheStore
...
from mainapp.controllers.submit.paternity_test.pt_family_combine import PtFamilyCombine
...
urls = (
    ...
    "/paternity_test/pt_family_combine", "PtFamilyCombine"
)
...
if web.config.get('_session') is None:
    ...
    session = web.session.Session(app, MemcacheStore({"servers":("10.2.0.100:11211", ), "timeout": 1440}),
                                  initializer={'user': None, "is_login": False, "is_admin": False})
